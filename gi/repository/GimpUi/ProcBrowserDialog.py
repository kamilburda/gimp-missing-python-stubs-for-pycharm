...
class ProcBrowserDialog(Dialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7510e80>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProcBrowserDialog), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpProcBrowserDialog (3032017104)>, '__doc__': None, '__gsignals__': {}, 'get_selected': gi.FunctionInfo(get_selected, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpProcBrowserDialog (3032017104)>'
