...
class FontChooser(ResourceChooser):
    ...
    def new(self, title=None, label=None, font=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, font:Gimp.Font=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74fefe0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpFontChooser (3031962864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpFontChooser (3031962864)>'
