...
class Dialog(__gi_overrides_Gtk.Dialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70511b0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Dialog), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpDialog (3091213552)>, '__doc__': None, '__gsignals__': {}, 'add_button': gi.FunctionInfo(add_button, bound=None), 'get_native_handle': gi.FunctionInfo(get_native_handle, bound=None), 'run': gi.FunctionInfo(run, bound=None), 'set_alternative_button_order_from_array': gi.FunctionInfo(set_alternative_button_order_from_array, bound=None), 'parent_instance': <property object at 0x000001eeb74da250>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpDialog (3091213552)>'
