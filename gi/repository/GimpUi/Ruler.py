...
class Ruler(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74ffe20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Ruler), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpRuler (3032004912)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_track_widget': gi.FunctionInfo(add_track_widget, bound=None), 'get_position': gi.FunctionInfo(get_position, bound=None), 'get_range': gi.FunctionInfo(get_range, bound=None), 'get_unit': gi.FunctionInfo(get_unit, bound=None), 'remove_track_widget': gi.FunctionInfo(remove_track_widget, bound=None), 'set_position': gi.FunctionInfo(set_position, bound=None), 'set_range': gi.FunctionInfo(set_range, bound=None), 'set_unit': gi.FunctionInfo(set_unit, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpRuler (3032004912)>'
