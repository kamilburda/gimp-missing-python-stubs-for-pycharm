...
class Labeled(__gi_repository_Gtk.Grid):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70526e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Labeled), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpLabeled (3031961856)>, '__doc__': None, '__gsignals__': {}, 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_text': gi.FunctionInfo(get_text, bound=None), 'set_text': gi.FunctionInfo(set_text, bound=None), 'do_mnemonic_widget_changed': gi.VFuncInfo(mnemonic_widget_changed, bound=None), 'parent_instance': <property object at 0x000001eeb74d8040>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLabeled (3031961856)>'
