...
class AspectPreview(Preview):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb4941ba0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AspectPreview), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpAspectPreview (3034748912)>, '__doc__': None, '__gsignals__': {}, 'new_from_drawable': gi.FunctionInfo(new_from_drawable, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpAspectPreview (3034748912)>'
