...
class VectorLoadProcedureDialog(ProcedureDialog):
    ...
    def new(self, procedure, config, extracted_data=None, file=None): # real signature unknown; restored from __doc__
        """ new(procedure:Gimp.VectorLoadProcedure, config:Gimp.ProcedureConfig, extracted_data:Gimp.VectorLoadData=None, file:Gio.File=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7510490>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VectorLoadProcedureDialog), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpVectorLoadProcedureDialog (3034421584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpVectorLoadProcedureDialog (3034421584)>'
