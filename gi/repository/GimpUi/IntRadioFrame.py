...
class IntRadioFrame(Frame):
    ...
    def new_from_store(self, title, store): # real signature unknown; restored from __doc__
        """ new_from_store(title:str, store:GimpUi.IntStore) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7503310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IntRadioFrame), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpIntRadioFrame (3091214512)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_store': gi.FunctionInfo(new_from_store, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'get_active_user_data': gi.FunctionInfo(get_active_user_data, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'set_active_by_user_data': gi.FunctionInfo(set_active_by_user_data, bound=None), 'set_sensitivity': gi.FunctionInfo(set_sensitivity, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpIntRadioFrame (3091214512)>'
