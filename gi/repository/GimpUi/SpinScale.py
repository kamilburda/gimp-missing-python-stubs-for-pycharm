...
class SpinScale(SpinButton):
    ...
    def new(self, adjustment, label, digits): # real signature unknown; restored from __doc__
        """ new(adjustment:Gtk.Adjustment, label:str, digits:int) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7513820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinScale), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpSpinScale (3032039264)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_constrain_drag': gi.FunctionInfo(get_constrain_drag, bound=None), 'get_gamma': gi.FunctionInfo(get_gamma, bound=None), 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_mnemonic_keyval': gi.FunctionInfo(get_mnemonic_keyval, bound=None), 'get_scale_limits': gi.FunctionInfo(get_scale_limits, bound=None), 'set_constrain_drag': gi.FunctionInfo(set_constrain_drag, bound=None), 'set_gamma': gi.FunctionInfo(set_gamma, bound=None), 'set_label': gi.FunctionInfo(set_label, bound=None), 'set_scale_limits': gi.FunctionInfo(set_scale_limits, bound=None), 'unset_scale_limits': gi.FunctionInfo(unset_scale_limits, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpSpinScale (3032039264)>'
