...
class EnumComboBox(IntComboBox):
    ...
    def new(self, enum_type): # real signature unknown; restored from __doc__
        """ new(enum_type:GType) -> Gtk.Widget """
        pass
    ...
    def new_with_model(self, enum_store): # real signature unknown; restored from __doc__
        """ new_with_model(enum_store:GimpUi.EnumStore) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7052320>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EnumComboBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpEnumComboBox (3091214032)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_model': gi.FunctionInfo(new_with_model, bound=None), 'set_icon_prefix': gi.FunctionInfo(set_icon_prefix, bound=None), 'parent_instance': <property object at 0x000001eeb74db2e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpEnumComboBox (3091214032)>'
