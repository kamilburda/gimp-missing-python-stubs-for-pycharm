...
class OffsetArea(__gi_repository_Gtk.DrawingArea):
    ...
    def new(self, orig_width, orig_height): # real signature unknown; restored from __doc__
        """ new(orig_width:int, orig_height:int) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7050220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OffsetArea), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpOffsetArea (3031999408)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set_offsets': gi.FunctionInfo(set_offsets, bound=None), 'set_pixbuf': gi.FunctionInfo(set_pixbuf, bound=None), 'set_size': gi.FunctionInfo(set_size, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpOffsetArea (3031999408)>'
