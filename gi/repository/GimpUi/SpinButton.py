...
class SpinButton(__gi_repository_Gtk.SpinButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7510400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinButton), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpSpinButton (3032038976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_range': gi.FunctionInfo(new_with_range, bound=None), 'parent_instance': <property object at 0x000001eeb751bec0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpSpinButton (3032038976)>'
