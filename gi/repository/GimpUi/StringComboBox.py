...
class StringComboBox(__gi_overrides_Gtk.ComboBox):
    ...
    def new(self, model, id_column, label_column): # real signature unknown; restored from __doc__
        """ new(model:Gtk.TreeModel, id_column:int, label_column:int) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb702cb20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StringComboBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpStringComboBox (3032039696)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'set_sensitivity': gi.FunctionInfo(set_sensitivity, bound=None), 'parent_instance': <property object at 0x000001eeb7524c70>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpStringComboBox (3032039696)>'
