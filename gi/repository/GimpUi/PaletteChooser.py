...
class PaletteChooser(ResourceChooser):
    ...
    def new(self, title=None, label=None, palette=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, palette:Gimp.Palette=None) -> Gtk.Widget """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PaletteChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpPaletteChooser (3032040272)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPaletteChooser (3032040272)>'
