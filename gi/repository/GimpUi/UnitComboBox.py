...
class UnitComboBox(__gi_overrides_Gtk.ComboBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7513310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(UnitComboBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpUnitComboBox (3032039840)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_model': gi.FunctionInfo(new_with_model, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpUnitComboBox (3032039840)>'
