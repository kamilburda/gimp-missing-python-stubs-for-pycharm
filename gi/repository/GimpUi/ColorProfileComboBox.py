...
class ColorProfileComboBox(__gi_overrides_Gtk.ComboBox):
    ...
    def new(self, dialog, history): # real signature unknown; restored from __doc__
        """ new(dialog:Gtk.Widget, history:Gio.File) -> Gtk.Widget """
        pass
    ...
    def new_with_model(self, dialog, model): # real signature unknown; restored from __doc__
        """ new_with_model(dialog:Gtk.Widget, model:Gtk.TreeModel) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb75000a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorProfileComboBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorProfileComboBox (3031961424)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_model': gi.FunctionInfo(new_with_model, bound=None), 'add_file': gi.FunctionInfo(add_file, bound=None), 'get_active_file': gi.FunctionInfo(get_active_file, bound=None), 'set_active_file': gi.FunctionInfo(set_active_file, bound=None), 'set_active_profile': gi.FunctionInfo(set_active_profile, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorProfileComboBox (3031961424)>'
