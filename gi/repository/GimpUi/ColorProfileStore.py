...
class ColorProfileStore(__gi_overrides_Gtk.ListStore):
    ...
    def new(self, history): # real signature unknown; restored from __doc__
        """ new(history:Gio.File) -> Gtk.ListStore """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7502140>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorProfileStore), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorProfileStore (3033932496)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_file': gi.FunctionInfo(add_file, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorProfileStore (3033932496)>'
