...
class GradientChooser(ResourceChooser):
    ...
    def new(self, title=None, label=None, gradient=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, gradient:Gimp.Gradient=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7503dc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GradientChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpGradientChooser (3031963584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpGradientChooser (3031963584)>'
