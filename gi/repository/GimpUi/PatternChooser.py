...
class PatternChooser(ResourceChooser):
    ...
    def new(self, title=None, label=None, pattern=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, pattern:Gimp.Pattern=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7513f10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PatternChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpPatternChooser (3032038544)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPatternChooser (3032038544)>'
