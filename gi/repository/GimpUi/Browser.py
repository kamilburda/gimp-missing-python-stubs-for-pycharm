...
class Browser(__gi_overrides_Gtk.Paned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb532bc10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Browser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpBrowser (3034745744)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_left_vbox': gi.FunctionInfo(get_left_vbox, bound=None), 'get_right_vbox': gi.FunctionInfo(get_right_vbox, bound=None), 'set_search_summary': gi.FunctionInfo(set_search_summary, bound=None), 'set_widget': gi.FunctionInfo(set_widget, bound=None), 'show_message': gi.FunctionInfo(show_message, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpBrowser (3034745744)>'
