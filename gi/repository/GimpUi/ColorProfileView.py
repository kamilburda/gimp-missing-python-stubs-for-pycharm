...
class ColorProfileView(__gi_repository_Gtk.TextView):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74fd510>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorProfileView), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorProfileView (3031961568)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set_error': gi.FunctionInfo(set_error, bound=None), 'set_profile': gi.FunctionInfo(set_profile, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorProfileView (3031961568)>'
