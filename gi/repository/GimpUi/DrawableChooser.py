...
class DrawableChooser(__gi_overrides_Gtk.Box):
    ...
    def new(self, title=None, label=None, drawable_type, drawable=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, drawable_type:GType, drawable:Gimp.Drawable=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a64d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawableChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpDrawableChooser (3031962000)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_drawable': gi.FunctionInfo(get_drawable, bound=None), 'get_label': gi.FunctionInfo(get_label, bound=None), 'set_drawable': gi.FunctionInfo(set_drawable, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpDrawableChooser (3031962000)>'
