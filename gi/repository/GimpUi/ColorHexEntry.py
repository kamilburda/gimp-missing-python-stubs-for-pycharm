...
class ColorHexEntry(__gi_repository_Gtk.Entry):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7051d20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorHexEntry), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorHexEntry (3034729120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_color': gi.FunctionInfo(get_color, bound=None), 'set_color': gi.FunctionInfo(set_color, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorHexEntry (3034729120)>'
