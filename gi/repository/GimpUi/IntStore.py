...
class IntStore(__gi_overrides_Gtk.ListStore):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a7fd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IntStore), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpIntStore (3033930592)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'lookup_by_user_data': gi.FunctionInfo(lookup_by_user_data, bound=None), 'lookup_by_value': gi.FunctionInfo(lookup_by_value, bound=None), 'parent_instance': <property object at 0x000001eeb74e4090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpIntStore (3033930592)>'
