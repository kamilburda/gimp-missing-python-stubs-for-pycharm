...
class FileChooser(__gi_overrides_Gtk.Box):
    ...
    def new(self, action, label=None, title=None, file=None): # real signature unknown; restored from __doc__
        """ new(action:Gimp.FileChooserAction, label:str=None, title:str=None, file:Gio.File=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb75034f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpFileChooser (3031962720)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_action': gi.FunctionInfo(get_action, bound=None), 'get_file': gi.FunctionInfo(get_file, bound=None), 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_label_widget': gi.FunctionInfo(get_label_widget, bound=None), 'get_title': gi.FunctionInfo(get_title, bound=None), 'set_action': gi.FunctionInfo(set_action, bound=None), 'set_file': gi.FunctionInfo(set_file, bound=None), 'set_label': gi.FunctionInfo(set_label, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpFileChooser (3031962720)>'
