...
class HintBox(__gi_overrides_Gtk.Box):
    ...
    def new(self, hint): # real signature unknown; restored from __doc__
        """ new(hint:str) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7501030>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HintBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpHintBox (3031964016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpHintBox (3031964016)>'
