...
class DrawablePreview(ScrolledPreview):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a7670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawablePreview), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpDrawablePreview (3091213872)>, '__doc__': None, '__gsignals__': {}, 'new_from_drawable': gi.FunctionInfo(new_from_drawable, bound=None), 'get_drawable': gi.FunctionInfo(get_drawable, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpDrawablePreview (3091213872)>'
