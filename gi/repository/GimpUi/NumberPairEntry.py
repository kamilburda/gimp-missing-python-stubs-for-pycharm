...
class NumberPairEntry(__gi_repository_Gtk.Entry):
    ...
    def new(self, separators, allow_simplification, min_valid_value, max_valid_value): # real signature unknown; restored from __doc__
        """ new(separators:str, allow_simplification:bool, min_valid_value:float, max_valid_value:float) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb704ace0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NumberPairEntry), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpNumberPairEntry (3032006064)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_aspect': gi.FunctionInfo(get_aspect, bound=None), 'get_default_text': gi.FunctionInfo(get_default_text, bound=None), 'get_default_values': gi.FunctionInfo(get_default_values, bound=None), 'get_ratio': gi.FunctionInfo(get_ratio, bound=None), 'get_user_override': gi.FunctionInfo(get_user_override, bound=None), 'get_values': gi.FunctionInfo(get_values, bound=None), 'set_aspect': gi.FunctionInfo(set_aspect, bound=None), 'set_default_text': gi.FunctionInfo(set_default_text, bound=None), 'set_default_values': gi.FunctionInfo(set_default_values, bound=None), 'set_ratio': gi.FunctionInfo(set_ratio, bound=None), 'set_user_override': gi.FunctionInfo(set_user_override, bound=None), 'set_values': gi.FunctionInfo(set_values, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpNumberPairEntry (3032006064)>'
