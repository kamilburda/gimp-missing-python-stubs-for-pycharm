...
class ProgressBar(__gi_repository_Gtk.ProgressBar):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7503910>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProgressBar), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpProgressBar (3032001328)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpProgressBar (3032001328)>'
