...
class PageSelector(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a7010>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PageSelector), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpPageSelector (3031961280)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_n_pages': gi.FunctionInfo(get_n_pages, bound=None), 'get_page_label': gi.FunctionInfo(get_page_label, bound=None), 'get_page_thumbnail': gi.FunctionInfo(get_page_thumbnail, bound=None), 'get_selected_pages': gi.FunctionInfo(get_selected_pages, bound=None), 'get_selected_range': gi.FunctionInfo(get_selected_range, bound=None), 'get_target': gi.FunctionInfo(get_target, bound=None), 'page_is_selected': gi.FunctionInfo(page_is_selected, bound=None), 'select_all': gi.FunctionInfo(select_all, bound=None), 'select_page': gi.FunctionInfo(select_page, bound=None), 'select_range': gi.FunctionInfo(select_range, bound=None), 'set_n_pages': gi.FunctionInfo(set_n_pages, bound=None), 'set_page_label': gi.FunctionInfo(set_page_label, bound=None), 'set_page_thumbnail': gi.FunctionInfo(set_page_thumbnail, bound=None), 'set_target': gi.FunctionInfo(set_target, bound=None), 'unselect_all': gi.FunctionInfo(unselect_all, bound=None), 'unselect_page': gi.FunctionInfo(unselect_page, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPageSelector (3031961280)>'
