...
class LabelIntWidget(Labeled):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb75023e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LabelIntWidget), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpLabelIntWidget (3031962432)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_widget': gi.FunctionInfo(get_widget, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLabelIntWidget (3031962432)>'
