...
class EnumStore(IntStore):
    ...
    def new_with_range(self, enum_type, minimum, maximum): # real signature unknown; restored from __doc__
        """ new_with_range(enum_type:GType, minimum:int, maximum:int) -> Gtk.ListStore """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7500610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EnumStore), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpEnumStore (3032001712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_range': gi.FunctionInfo(new_with_range, bound=None), 'set_icon_prefix': gi.FunctionInfo(set_icon_prefix, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpEnumStore (3032001712)>'
