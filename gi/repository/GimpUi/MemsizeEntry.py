...
class MemsizeEntry(__gi_overrides_Gtk.Box):
    ...
    def new(self, value, lower, upper): # real signature unknown; restored from __doc__
        """ new(value:int, lower:int, upper:int) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb75007c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MemsizeEntry), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpMemsizeEntry (3031961136)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_spinbutton': gi.FunctionInfo(get_spinbutton, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpMemsizeEntry (3031961136)>'
