...
class PickButton(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7512a70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PickButton), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpPickButton (3032040128)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'do_color_picked': gi.VFuncInfo(color_picked, bound=None), 'parent_instance': <property object at 0x000001eeb74f2b60>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPickButton (3032040128)>'
