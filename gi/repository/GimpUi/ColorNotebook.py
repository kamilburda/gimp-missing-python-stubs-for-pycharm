...
class ColorNotebook(ColorSelector):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a4040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorNotebook), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorNotebook (3031961712)>, '__doc__': None, '__gsignals__': {}, 'enable_simulation': gi.FunctionInfo(enable_simulation, bound=None), 'get_current_selector': gi.FunctionInfo(get_current_selector, bound=None), 'get_notebook': gi.FunctionInfo(get_notebook, bound=None), 'get_selectors': gi.FunctionInfo(get_selectors, bound=None), 'set_format': gi.FunctionInfo(set_format, bound=None), 'set_has_page': gi.FunctionInfo(set_has_page, bound=None), 'set_simulation': gi.FunctionInfo(set_simulation, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorNotebook (3031961712)>'
