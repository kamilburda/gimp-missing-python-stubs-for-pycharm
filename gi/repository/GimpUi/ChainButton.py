...
class ChainButton(__gi_repository_Gtk.Grid):
    ...
    def new(self, position): # real signature unknown; restored from __doc__
        """ new(position:GimpUi.ChainPosition) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb532c9d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ChainButton), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpChainButton (3034746320)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'get_button': gi.FunctionInfo(get_button, bound=None), 'get_icon_size': gi.FunctionInfo(get_icon_size, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'set_icon_size': gi.FunctionInfo(set_icon_size, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpChainButton (3034746320)>'
