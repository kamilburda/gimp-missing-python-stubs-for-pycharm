...
class ColorSelection(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74fcc10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorSelection), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorSelection (3031963440)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'color_changed': gi.FunctionInfo(color_changed, bound=None), 'get_color': gi.FunctionInfo(get_color, bound=None), 'get_notebook': gi.FunctionInfo(get_notebook, bound=None), 'get_old_color': gi.FunctionInfo(get_old_color, bound=None), 'get_right_vbox': gi.FunctionInfo(get_right_vbox, bound=None), 'get_show_alpha': gi.FunctionInfo(get_show_alpha, bound=None), 'reset': gi.FunctionInfo(reset, bound=None), 'set_color': gi.FunctionInfo(set_color, bound=None), 'set_config': gi.FunctionInfo(set_config, bound=None), 'set_format': gi.FunctionInfo(set_format, bound=None), 'set_old_color': gi.FunctionInfo(set_old_color, bound=None), 'set_show_alpha': gi.FunctionInfo(set_show_alpha, bound=None), 'set_simulation': gi.FunctionInfo(set_simulation, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorSelection (3031963440)>'
