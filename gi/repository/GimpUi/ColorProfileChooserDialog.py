...
class ColorProfileChooserDialog(__gi_overrides_Gtk.FileChooserDialog):
    ...
    def new(self, title, parent, action): # real signature unknown; restored from __doc__
        """ new(title:str, parent:Gtk.Window, action:Gtk.FileChooserAction) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74fe2c0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorProfileChooserDialog), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorProfileChooserDialog (3091214672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorProfileChooserDialog (3091214672)>'
