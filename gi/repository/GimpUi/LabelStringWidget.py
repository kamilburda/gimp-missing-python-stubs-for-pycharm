...
class LabelStringWidget(Labeled):
    ...
    def new(self, text, widget): # real signature unknown; restored from __doc__
        """ new(text:str, widget:Gtk.Widget) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7501300>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LabelStringWidget), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpLabelStringWidget (3031964448)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_widget': gi.FunctionInfo(get_widget, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLabelStringWidget (3031964448)>'
