...
class LayerComboBox(IntComboBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a78b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LayerComboBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpLayerComboBox (3032016784)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLayerComboBox (3032016784)>'
