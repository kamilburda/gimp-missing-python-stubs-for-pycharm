...
class ColorScaleEntry(ScaleEntry):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74feb00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorScaleEntry), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorScaleEntry (3091213392)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorScaleEntry (3091213392)>'
