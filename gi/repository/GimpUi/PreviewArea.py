...
class PreviewArea(__gi_repository_Gtk.DrawingArea):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7510670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PreviewArea), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpPreviewArea (3032004144)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'blend': gi.FunctionInfo(blend, bound=None), 'draw': gi.FunctionInfo(draw, bound=None), 'fill': gi.FunctionInfo(fill, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'mask': gi.FunctionInfo(mask, bound=None), 'menu_popup': gi.FunctionInfo(menu_popup, bound=None), 'reset': gi.FunctionInfo(reset, bound=None), 'set_color_config': gi.FunctionInfo(set_color_config, bound=None), 'set_colormap': gi.FunctionInfo(set_colormap, bound=None), 'set_max_size': gi.FunctionInfo(set_max_size, bound=None), 'set_offsets': gi.FunctionInfo(set_offsets, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPreviewArea (3032004144)>'
