...
class Preview(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb532e350>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Preview), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpPreview (3034748768)>, '__doc__': None, '__gsignals__': {}, 'draw': gi.FunctionInfo(draw, bound=None), 'draw_buffer': gi.FunctionInfo(draw_buffer, bound=None), 'get_area': gi.FunctionInfo(get_area, bound=None), 'get_bounds': gi.FunctionInfo(get_bounds, bound=None), 'get_controls': gi.FunctionInfo(get_controls, bound=None), 'get_default_cursor': gi.FunctionInfo(get_default_cursor, bound=None), 'get_frame': gi.FunctionInfo(get_frame, bound=None), 'get_grid': gi.FunctionInfo(get_grid, bound=None), 'get_offsets': gi.FunctionInfo(get_offsets, bound=None), 'get_position': gi.FunctionInfo(get_position, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'get_update': gi.FunctionInfo(get_update, bound=None), 'invalidate': gi.FunctionInfo(invalidate, bound=None), 'set_bounds': gi.FunctionInfo(set_bounds, bound=None), 'set_default_cursor': gi.FunctionInfo(set_default_cursor, bound=None), 'set_offsets': gi.FunctionInfo(set_offsets, bound=None), 'set_size': gi.FunctionInfo(set_size, bound=None), 'set_update': gi.FunctionInfo(set_update, bound=None), 'transform': gi.FunctionInfo(transform, bound=None), 'untransform': gi.FunctionInfo(untransform, bound=None), 'do_draw': gi.VFuncInfo(draw, bound=None), 'do_draw_buffer': gi.VFuncInfo(draw_buffer, bound=None), 'do_draw_thumb': gi.VFuncInfo(draw_thumb, bound=None), 'do_invalidated': gi.VFuncInfo(invalidated, bound=None), 'do_set_cursor': gi.VFuncInfo(set_cursor, bound=None), 'do_transform': gi.VFuncInfo(transform, bound=None), 'do_untransform': gi.VFuncInfo(untransform, bound=None), 'parent_instance': <property object at 0x000001eeb754e110>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPreview (3034748768)>'
