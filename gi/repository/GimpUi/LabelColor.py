...
class LabelColor(Labeled):
    ...
    def new(self, label, color, editable): # real signature unknown; restored from __doc__
        """ new(label:str, color:Gegl.Color, editable:bool) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7501ff0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LabelColor), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpLabelColor (3031964160)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_color_widget': gi.FunctionInfo(get_color_widget, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'is_editable': gi.FunctionInfo(is_editable, bound=None), 'set_editable': gi.FunctionInfo(set_editable, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLabelColor (3031964160)>'
