...
class ColorScale(__gi_repository_Gtk.Scale):
    ...
    def new(self, orientation, channel): # real signature unknown; restored from __doc__
        """ new(orientation:Gtk.Orientation, channel:GimpUi.ColorSelectorChannel) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74ff8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorScale), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorScale (3031964592)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set_channel': gi.FunctionInfo(set_channel, bound=None), 'set_color': gi.FunctionInfo(set_color, bound=None), 'set_color_config': gi.FunctionInfo(set_color_config, bound=None), 'set_format': gi.FunctionInfo(set_format, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorScale (3031964592)>'
