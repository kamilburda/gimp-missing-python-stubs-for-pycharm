...
class Button(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb6c02ad0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Button), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpButton (3034746752)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'extended_clicked': gi.FunctionInfo(extended_clicked, bound=None), 'do_extended_clicked': gi.VFuncInfo(extended_clicked, bound=None), 'parent_instance': <property object at 0x000001eeb754ea20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpButton (3034746752)>'
