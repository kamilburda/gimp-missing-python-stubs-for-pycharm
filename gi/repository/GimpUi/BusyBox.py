...
class BusyBox(__gi_overrides_Gtk.Box):
    ...
    def new(self, message=None): # real signature unknown; restored from __doc__
        """ new(message:str=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a40a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BusyBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpBusyBox (3034747040)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_message': gi.FunctionInfo(get_message, bound=None), 'set_message': gi.FunctionInfo(set_message, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpBusyBox (3034747040)>'
