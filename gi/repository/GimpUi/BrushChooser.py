...
class BrushChooser(ResourceChooser):
    ...
    def new(self, title=None, label=None, brush=None): # real signature unknown; restored from __doc__
        """ new(title:str=None, label:str=None, brush:Gimp.Brush=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb531d3f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BrushChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpBrushChooser (3034745312)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpBrushChooser (3034745312)>'
