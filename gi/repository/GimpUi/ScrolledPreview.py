...
class ScrolledPreview(Preview):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a6560>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScrolledPreview), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpScrolledPreview (3031962144)>, '__doc__': None, '__gsignals__': {}, 'freeze': gi.FunctionInfo(freeze, bound=None), 'get_adjustments': gi.FunctionInfo(get_adjustments, bound=None), 'set_policy': gi.FunctionInfo(set_policy, bound=None), 'set_position': gi.FunctionInfo(set_position, bound=None), 'thaw': gi.FunctionInfo(thaw, bound=None), 'parent_instance': <property object at 0x000001eeb74db010>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpScrolledPreview (3031962144)>'
