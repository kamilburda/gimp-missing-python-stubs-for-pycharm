...
class LabelSpin(Labeled):
    ...
    def new(self, text, value, lower, upper, digits): # real signature unknown; restored from __doc__
        """ new(text:str, value:float, lower:float, upper:float, digits:int) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb531d630>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LabelSpin), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpLabelSpin (3031962576)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_spin_button': gi.FunctionInfo(get_spin_button, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'set_digits': gi.FunctionInfo(set_digits, bound=None), 'set_increments': gi.FunctionInfo(set_increments, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None), 'do_value_changed': gi.VFuncInfo(value_changed, bound=None), 'parent_instance': <property object at 0x000001eeb74d8180>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLabelSpin (3031962576)>'
