...
class Frame(__gi_repository_Gtk.Frame):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb75054e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Frame), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpFrame (3031963296)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x000001eeb74e4c20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpFrame (3031963296)>'
