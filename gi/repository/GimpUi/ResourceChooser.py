...
class ResourceChooser(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb6ff7ca0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ResourceChooser), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpResourceChooser (3034745168)>, '__doc__': None, '__gsignals__': {}, 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_resource': gi.FunctionInfo(get_resource, bound=None), 'set_resource': gi.FunctionInfo(set_resource, bound=None), 'do_draw_interior': gi.VFuncInfo(draw_interior, bound=None), 'do_resource_set': gi.VFuncInfo(resource_set, bound=None), 'parent_instance': <property object at 0x000001eeb754e5c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpResourceChooser (3034745168)>'
