...
class ProcedureDialog(Dialog):
    ...
    def new(self, procedure, config, title=None): # real signature unknown; restored from __doc__
        """ new(procedure:Gimp.Procedure, config:Gimp.ProcedureConfig, title:str=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a4190>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProcedureDialog), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpProcedureDialog (3091214192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'fill_box': gi.FunctionInfo(fill_box, bound=None), 'fill_expander': gi.FunctionInfo(fill_expander, bound=None), 'fill_flowbox': gi.FunctionInfo(fill_flowbox, bound=None), 'fill_frame': gi.FunctionInfo(fill_frame, bound=None), 'fill': gi.FunctionInfo(fill, bound=None), 'fill_notebook': gi.FunctionInfo(fill_notebook, bound=None), 'fill_paned': gi.FunctionInfo(fill_paned, bound=None), 'fill_scrolled_window': gi.FunctionInfo(fill_scrolled_window, bound=None), 'get_color_widget': gi.FunctionInfo(get_color_widget, bound=None), 'get_drawable_preview': gi.FunctionInfo(get_drawable_preview, bound=None), 'get_int_combo': gi.FunctionInfo(get_int_combo, bound=None), 'get_int_radio': gi.FunctionInfo(get_int_radio, bound=None), 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_scale_entry': gi.FunctionInfo(get_scale_entry, bound=None), 'get_size_entry': gi.FunctionInfo(get_size_entry, bound=None), 'get_spin_scale': gi.FunctionInfo(get_spin_scale, bound=None), 'get_widget': gi.FunctionInfo(get_widget, bound=None), 'run': gi.FunctionInfo(run, bound=None), 'set_ok_label': gi.FunctionInfo(set_ok_label, bound=None), 'set_sensitive': gi.FunctionInfo(set_sensitive, bound=None), 'set_sensitive_if_in': gi.FunctionInfo(set_sensitive_if_in, bound=None), 'do_fill_end': gi.VFuncInfo(fill_end, bound=None), 'do_fill_start': gi.VFuncInfo(fill_start, bound=None), 'parent_instance': <property object at 0x000001eeb74e4360>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpProcedureDialog (3091214192)>'
