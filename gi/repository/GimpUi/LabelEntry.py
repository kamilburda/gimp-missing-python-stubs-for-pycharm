...
class LabelEntry(Labeled):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7501150>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LabelEntry), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpLabelEntry (3031964304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_entry': gi.FunctionInfo(get_entry, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpLabelEntry (3031964304)>'
