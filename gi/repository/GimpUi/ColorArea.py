...
class ColorArea(__gi_repository_Gtk.DrawingArea):
    ...
    def new(self, color, type, drag_mask): # real signature unknown; restored from __doc__
        """ new(color:Gegl.Color, type:GimpUi.ColorAreaType, drag_mask:Gdk.ModifierType) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb70a7040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorArea), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorArea (3034733856)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'enable_drag': gi.FunctionInfo(enable_drag, bound=None), 'get_color': gi.FunctionInfo(get_color, bound=None), 'has_alpha': gi.FunctionInfo(has_alpha, bound=None), 'set_color': gi.FunctionInfo(set_color, bound=None), 'set_color_config': gi.FunctionInfo(set_color_config, bound=None), 'set_draw_border': gi.FunctionInfo(set_draw_border, bound=None), 'set_out_of_gamut': gi.FunctionInfo(set_out_of_gamut, bound=None), 'set_type': gi.FunctionInfo(set_type, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorArea (3034733856)>'
