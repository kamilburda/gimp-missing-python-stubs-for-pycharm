...
class PathEditor(__gi_overrides_Gtk.Box):
    ...
    def new(self, title, path=None): # real signature unknown; restored from __doc__
        """ new(title:str, path:str=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7511e10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PathEditor), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpPathEditor (3032039120)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_dir_writable': gi.FunctionInfo(get_dir_writable, bound=None), 'get_path': gi.FunctionInfo(get_path, bound=None), 'get_writable_path': gi.FunctionInfo(get_writable_path, bound=None), 'set_dir_writable': gi.FunctionInfo(set_dir_writable, bound=None), 'set_path': gi.FunctionInfo(set_path, bound=None), 'set_writable_path': gi.FunctionInfo(set_writable_path, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPathEditor (3032039120)>'
