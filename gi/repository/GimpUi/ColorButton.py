...
class ColorButton(Button):
    ...
    def new(self, title, width, height, color, type): # real signature unknown; restored from __doc__
        """ new(title:str, width:int, height:int, color:Gegl.Color, type:GimpUi.ColorAreaType) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb48676a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorButton), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpColorButton (3091215152)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_action_group': gi.FunctionInfo(get_action_group, bound=None), 'get_color': gi.FunctionInfo(get_color, bound=None), 'get_title': gi.FunctionInfo(get_title, bound=None), 'get_update': gi.FunctionInfo(get_update, bound=None), 'has_alpha': gi.FunctionInfo(has_alpha, bound=None), 'set_color': gi.FunctionInfo(set_color, bound=None), 'set_color_config': gi.FunctionInfo(set_color_config, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None), 'set_type': gi.FunctionInfo(set_type, bound=None), 'set_update': gi.FunctionInfo(set_update, bound=None), 'do_color_changed': gi.VFuncInfo(color_changed, bound=None), 'do_get_action_type': gi.VFuncInfo(get_action_type, bound=None), 'parent_instance': <property object at 0x000001eeb753c900>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpColorButton (3091215152)>'
