...
class DrawableComboBox(IntComboBox):
    ...
    def new(self, constraint=None): # real signature unknown; restored from __doc__
        """ new(constraint:GimpUi.ItemConstraintFunc=None) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb74ffd30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawableComboBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpDrawableComboBox (3091213712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpDrawableComboBox (3091213712)>'
