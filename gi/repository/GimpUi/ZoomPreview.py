...
class ZoomPreview(ScrolledPreview):
    ...
    def new_from_drawable(self, drawable): # real signature unknown; restored from __doc__
        """ new_from_drawable(drawable:Gimp.Drawable) -> Gtk.Widget """
        pass

    def new_with_model_from_drawable(self, drawable, model): # real signature unknown; restored from __doc__
        """ new_with_model_from_drawable(drawable:Gimp.Drawable, model:GimpUi.ZoomModel) -> Gtk.Widget """
        pass
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ZoomPreview), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpZoomPreview (3032016464)>, '__doc__': None, '__gsignals__': {}, 'new_from_drawable': gi.FunctionInfo(new_from_drawable, bound=None), 'new_with_model_from_drawable': gi.FunctionInfo(new_with_model_from_drawable, bound=None), 'get_drawable': gi.FunctionInfo(get_drawable, bound=None), 'get_factor': gi.FunctionInfo(get_factor, bound=None), 'get_model': gi.FunctionInfo(get_model, bound=None), 'get_source': gi.FunctionInfo(get_source, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpZoomPreview (3032016464)>'
