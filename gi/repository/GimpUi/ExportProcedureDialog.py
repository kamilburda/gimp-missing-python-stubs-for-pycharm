...
class ExportProcedureDialog(ProcedureDialog):
    ...
    def new(self, procedure, config, image): # real signature unknown; restored from __doc__
        """ new(procedure:Gimp.ExportProcedure, config:Gimp.ProcedureConfig, image:Gimp.Image) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb75035b0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ExportProcedureDialog), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpExportProcedureDialog (3034425984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_metadata': gi.FunctionInfo(add_metadata, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpExportProcedureDialog (3034425984)>'
