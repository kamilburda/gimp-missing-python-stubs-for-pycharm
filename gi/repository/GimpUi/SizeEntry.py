...
class SizeEntry(__gi_repository_Gtk.Grid):
    ...
    def new(self, number_of_fields, unit, unit_format, menu_show_pixels, menu_show_percent, show_refval, spinbutton_width, update_policy): # real signature unknown; restored from __doc__
        """ new(number_of_fields:int, unit:Gimp.Unit, unit_format:str, menu_show_pixels:bool, menu_show_percent:bool, show_refval:bool, spinbutton_width:int, update_policy:GimpUi.SizeEntryUpdatePolicy) -> Gtk.Widget """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb6ff76a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SizeEntry), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpSizeEntry (3032038688)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_field': gi.FunctionInfo(add_field, bound=None), 'attach_label': gi.FunctionInfo(attach_label, bound=None), 'get_help_widget': gi.FunctionInfo(get_help_widget, bound=None), 'get_n_fields': gi.FunctionInfo(get_n_fields, bound=None), 'get_refval': gi.FunctionInfo(get_refval, bound=None), 'get_unit': gi.FunctionInfo(get_unit, bound=None), 'get_unit_combo': gi.FunctionInfo(get_unit_combo, bound=None), 'get_update_policy': gi.FunctionInfo(get_update_policy, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'grab_focus': gi.FunctionInfo(grab_focus, bound=None), 'set_activates_default': gi.FunctionInfo(set_activates_default, bound=None), 'set_pixel_digits': gi.FunctionInfo(set_pixel_digits, bound=None), 'set_refval': gi.FunctionInfo(set_refval, bound=None), 'set_refval_boundaries': gi.FunctionInfo(set_refval_boundaries, bound=None), 'set_refval_digits': gi.FunctionInfo(set_refval_digits, bound=None), 'set_resolution': gi.FunctionInfo(set_resolution, bound=None), 'set_size': gi.FunctionInfo(set_size, bound=None), 'set_unit': gi.FunctionInfo(set_unit, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None), 'set_value_boundaries': gi.FunctionInfo(set_value_boundaries, bound=None), 'show_unit_menu': gi.FunctionInfo(show_unit_menu, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpSizeEntry (3032038688)>'
