...
class ScaleEntry(LabelSpin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb7096ad0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleEntry), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpScaleEntry (3091214832)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_logarithmic': gi.FunctionInfo(get_logarithmic, bound=None), 'get_range': gi.FunctionInfo(get_range, bound=None), 'set_bounds': gi.FunctionInfo(set_bounds, bound=None), 'set_logarithmic': gi.FunctionInfo(set_logarithmic, bound=None), 'parent_instance': <property object at 0x000001eeb74d82c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpScaleEntry (3091214832)>'
