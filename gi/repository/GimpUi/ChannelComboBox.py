...
class ChannelComboBox(IntComboBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001eeb6c3e500>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ChannelComboBox), '__module__': 'gi.repository.GimpUi', '__gtype__': <GType GimpChannelComboBox (3091214992)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpChannelComboBox (3091214992)>'
