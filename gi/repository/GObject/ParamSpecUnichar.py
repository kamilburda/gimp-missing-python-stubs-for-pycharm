...
class ParamSpecUnichar(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUnichar), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamUnichar (83211504)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a208b0>, 'default_value': <property object at 0x0000010b07a209a0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamUnichar (83211504)>'
