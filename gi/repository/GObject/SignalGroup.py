...
class SignalGroup(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000010b07a05b70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SignalGroup), '__module__': 'gi.repository.GObject', '__gtype__': <GType GSignalGroup (123597088)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'block': gi.FunctionInfo(block, bound=None), 'connect_closure': gi.FunctionInfo(connect_closure, bound=None), 'connect_data': gi.FunctionInfo(connect_data, bound=None), 'connect_swapped': gi.FunctionInfo(connect_swapped, bound=None), 'dup_target': gi.FunctionInfo(dup_target, bound=None), 'set_target': gi.FunctionInfo(set_target, bound=None), 'unblock': gi.FunctionInfo(unblock, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSignalGroup (123597088)>'
