...
class ParamSpecFloat(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecFloat), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamFloat (83212288)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2cb30>, 'minimum': <property object at 0x0000010b07a2cc20>, 'maximum': <property object at 0x0000010b07a2cd10>, 'default_value': <property object at 0x0000010b07a2ce00>, 'epsilon': <property object at 0x0000010b07a2cef0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamFloat (83212288)>'
