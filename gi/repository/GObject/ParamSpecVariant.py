...
class ParamSpecVariant(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecVariant), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamVariant (83214528)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a20ef0>, 'type': <property object at 0x0000010b07a20fe0>, 'default_value': <property object at 0x0000010b07a210d0>, 'padding': <property object at 0x0000010b07a211c0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamVariant (83214528)>'
