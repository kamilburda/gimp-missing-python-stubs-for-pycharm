...
class Idle(__gi_overrides_GLib.Source):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.GLib', '__new__': <staticmethod(<function Idle.__new__ at 0x0000010b078e65c0>)>, '__init__': <function Idle.__init__ at 0x0000010b078e6660>, '__doc__': None})"
