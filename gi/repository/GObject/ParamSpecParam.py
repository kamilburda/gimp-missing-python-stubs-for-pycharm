...
class ParamSpecParam(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecParam), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamParam (83213968)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2e430>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamParam (83213968)>'
