...
class TypeFundamentalInfo(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TypeFundamentalInfo), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TypeFundamentalInfo' objects>, '__weakref__': <attribute '__weakref__' of 'TypeFundamentalInfo' objects>, '__doc__': None, 'type_flags': <property object at 0x0000010b07a23c90>})"
