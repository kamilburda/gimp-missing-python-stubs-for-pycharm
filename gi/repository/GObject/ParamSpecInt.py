...
class ParamSpecInt(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecInt), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamInt (83214752)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2d300>, 'minimum': <property object at 0x0000010b07a2d3f0>, 'maximum': <property object at 0x0000010b07a2d4e0>, 'default_value': <property object at 0x0000010b07a2d5d0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamInt (83214752)>'
