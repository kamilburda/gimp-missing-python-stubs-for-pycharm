...
class BindingGroup(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000010b079f37c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BindingGroup), '__module__': 'gi.repository.GObject', '__gtype__': <GType GBindingGroup (83283072)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'bind': gi.FunctionInfo(bind, bound=None), 'bind_full': gi.FunctionInfo(bind_full, bound=None), 'dup_source': gi.FunctionInfo(dup_source, bound=None), 'set_source': gi.FunctionInfo(set_source, bound=None)})"
    __gdoc__ = 'Object GBindingGroup\n\nProperties from GBindingGroup:\n  source -> GObject: source\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBindingGroup (83283072)>'
