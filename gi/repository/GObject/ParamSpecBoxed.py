...
class ParamSpecBoxed(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecBoxed), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamBoxed (83211840)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a5b100>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamBoxed (83211840)>'
