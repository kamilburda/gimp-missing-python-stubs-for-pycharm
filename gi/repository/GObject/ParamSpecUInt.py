...
class ParamSpecUInt(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUInt), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamUInt (83213408)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2fb50>, 'minimum': <property object at 0x0000010b07a2fc40>, 'maximum': <property object at 0x0000010b07a2fd30>, 'default_value': <property object at 0x0000010b07a2fe20>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamUInt (83213408)>'
