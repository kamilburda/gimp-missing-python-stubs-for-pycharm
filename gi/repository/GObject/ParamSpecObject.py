...
class ParamSpecObject(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecObject), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamObject (83213744)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2e020>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamObject (83213744)>'
