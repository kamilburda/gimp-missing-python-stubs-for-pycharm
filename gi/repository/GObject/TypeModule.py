...
class TypeModule(__gi_overrides_GObject.Object, TypePlugin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000010b07a64be0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TypeModule), '__module__': 'gi.repository.GObject', '__gtype__': <GType GTypeModule (123599440)>, '__doc__': None, '__gsignals__': {}, 'add_interface': gi.FunctionInfo(add_interface, bound=None), 'register_enum': gi.FunctionInfo(register_enum, bound=None), 'register_flags': gi.FunctionInfo(register_flags, bound=None), 'register_type': gi.FunctionInfo(register_type, bound=None), 'set_name': gi.FunctionInfo(set_name, bound=None), 'unuse': gi.FunctionInfo(unuse, bound=None), 'use': gi.FunctionInfo(use, bound=None), 'do_load': gi.VFuncInfo(load, bound=None), 'do_unload': gi.VFuncInfo(unload, bound=None), 'parent_instance': <property object at 0x0000010b07a88e00>, 'use_count': <property object at 0x0000010b07a88ef0>, 'type_infos': <property object at 0x0000010b07a88fe0>, 'interface_infos': <property object at 0x0000010b07a890d0>, 'name': <property object at 0x0000010b07a891c0>})"
    __gdoc__ = 'Object GTypeModule\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GTypeModule (123599440)>'
