...
class SignalInvocationHint(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SignalInvocationHint), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SignalInvocationHint' objects>, '__weakref__': <attribute '__weakref__' of 'SignalInvocationHint' objects>, '__doc__': None, 'signal_id': <property object at 0x0000010b07a218a0>, 'detail': <property object at 0x0000010b07a21990>, 'run_type': <property object at 0x0000010b07a21a80>})"
