...
class ParamSpecULong(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecULong), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamULong (83212176)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a20450>, 'minimum': <property object at 0x0000010b07a20540>, 'maximum': <property object at 0x0000010b07a20630>, 'default_value': <property object at 0x0000010b07a20720>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamULong (83212176)>'
