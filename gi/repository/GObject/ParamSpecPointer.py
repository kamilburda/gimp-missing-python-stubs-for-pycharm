...
class ParamSpecPointer(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecPointer), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamPointer (83213632)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2e5c0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamPointer (83213632)>'
