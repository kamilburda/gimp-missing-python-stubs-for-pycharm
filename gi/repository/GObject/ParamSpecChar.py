...
class ParamSpecChar(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecChar), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamChar (83210832)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a5b290>, 'minimum': <property object at 0x0000010b07a5b380>, 'maximum': <property object at 0x0000010b07a5b470>, 'default_value': <property object at 0x0000010b07a5b560>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamChar (83210832)>'
