...
class InitiallyUnowned(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000010b079f3b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InitiallyUnowned), '__module__': 'gi.repository.GObject', '__gtype__': <GType GInitiallyUnowned (123598320)>, '__doc__': None, '__gsignals__': {}, 'g_type_instance': <property object at 0x0000010b07a584a0>, 'ref_count': <property object at 0x0000010b07a58590>, 'qdata': <property object at 0x0000010b07a58680>})"
    __gdoc__ = 'Object GInitiallyUnowned\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GInitiallyUnowned (123598320)>'
