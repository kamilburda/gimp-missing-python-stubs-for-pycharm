...
class ParamSpecPool(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(ParamSpecPool), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'ParamSpecPool' objects>, '__weakref__': <attribute '__weakref__' of 'ParamSpecPool' objects>, '__doc__': None, 'free': gi.FunctionInfo(free, bound=None), 'insert': gi.FunctionInfo(insert, bound=None), 'list': gi.FunctionInfo(list, bound=None), 'list_owned': gi.FunctionInfo(list_owned, bound=None), 'lookup': gi.FunctionInfo(lookup, bound=None), 'remove': gi.FunctionInfo(remove, bound=None)})"
