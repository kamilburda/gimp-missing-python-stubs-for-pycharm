...
class ParamSpecLong(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecLong), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamLong (83210272)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2dbc0>, 'minimum': <property object at 0x0000010b07a2dcb0>, 'maximum': <property object at 0x0000010b07a2dda0>, 'default_value': <property object at 0x0000010b07a2de90>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamLong (83210272)>'
