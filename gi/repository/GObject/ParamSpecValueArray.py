...
class ParamSpecValueArray(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecValueArray), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamValueArray (83212400)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a20b30>, 'element_spec': <property object at 0x0000010b07a20c20>, 'fixed_n_elements': <property object at 0x0000010b07a20d60>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamValueArray (83212400)>'
