...
class ParamSpecBoolean(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecBoolean), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamBoolean (83210384)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a5aed0>, 'default_value': <property object at 0x0000010b07a5afc0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamBoolean (83210384)>'
