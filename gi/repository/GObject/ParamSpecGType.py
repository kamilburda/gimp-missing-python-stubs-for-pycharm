...
class ParamSpecGType(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecGType), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamGType (83214416)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2d080>, 'is_a_type': <property object at 0x0000010b07a2d170>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamGType (83214416)>'
