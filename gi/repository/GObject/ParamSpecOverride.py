...
class ParamSpecOverride(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecOverride), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamOverride (83214080)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2e1b0>, 'overridden': <property object at 0x0000010b07a2e2a0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamOverride (83214080)>'
