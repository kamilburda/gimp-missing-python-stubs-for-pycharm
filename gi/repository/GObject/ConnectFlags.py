...
class ConnectFlags(__gobject.GFlags):
    ...
    SWAPPED = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GObject', '__dict__': <attribute '__dict__' of 'ConnectFlags' objects>, '__doc__': None, '__gtype__': <GType PyGObjectConnectFlags (123594736)>, '__flags_values__': {0: <flags 0 of type GObject.ConnectFlags>, 1: <flags G_CONNECT_AFTER of type GObject.ConnectFlags>, 2: <flags G_CONNECT_SWAPPED of type GObject.ConnectFlags>}, '__info__': gi.EnumInfo(ConnectFlags), 'DEFAULT': <flags 0 of type GObject.ConnectFlags>, 'AFTER': <flags G_CONNECT_AFTER of type GObject.ConnectFlags>, 'SWAPPED': <flags G_CONNECT_SWAPPED of type GObject.ConnectFlags>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType PyGObjectConnectFlags (123594736)>'
