...
class ParamSpecUInt64(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUInt64), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamUInt64 (83211392)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2ffb0>, 'minimum': <property object at 0x0000010b07a200e0>, 'maximum': <property object at 0x0000010b07a201d0>, 'default_value': <property object at 0x0000010b07a202c0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamUInt64 (83211392)>'
