...
class ParamSpecUChar(__gi_overrides_GObject.ParamSpec):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamSpecUChar), '__module__': 'gi.repository.GObject', '__gtype__': <GType GParamUChar (83213072)>, '__doc__': None, '__gsignals__': {}, 'parent_instance': <property object at 0x0000010b07a2f6f0>, 'minimum': <property object at 0x0000010b07a2f7e0>, 'maximum': <property object at 0x0000010b07a2f8d0>, 'default_value': <property object at 0x0000010b07a2f9c0>})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GParamUChar (83213072)>'
