...
class SignalFlags(__gobject.GFlags):
    ...
    RUN_LAST = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GObject', '__dict__': <attribute '__dict__' of 'SignalFlags' objects>, '__doc__': None, '__gtype__': <GType PyGObjectSignalFlags (83282064)>, '__flags_values__': {1: <flags G_SIGNAL_RUN_FIRST of type GObject.SignalFlags>, 2: <flags G_SIGNAL_RUN_LAST of type GObject.SignalFlags>, 4: <flags G_SIGNAL_RUN_CLEANUP of type GObject.SignalFlags>, 8: <flags G_SIGNAL_NO_RECURSE of type GObject.SignalFlags>, 16: <flags G_SIGNAL_DETAILED of type GObject.SignalFlags>, 32: <flags G_SIGNAL_ACTION of type GObject.SignalFlags>, 64: <flags G_SIGNAL_NO_HOOKS of type GObject.SignalFlags>, 128: <flags G_SIGNAL_MUST_COLLECT of type GObject.SignalFlags>, 256: <flags G_SIGNAL_DEPRECATED of type GObject.SignalFlags>, 131072: <flags G_SIGNAL_ACCUMULATOR_FIRST_RUN of type GObject.SignalFlags>}, '__info__': gi.EnumInfo(SignalFlags), 'RUN_FIRST': <flags G_SIGNAL_RUN_FIRST of type GObject.SignalFlags>, 'RUN_LAST': <flags G_SIGNAL_RUN_LAST of type GObject.SignalFlags>, 'RUN_CLEANUP': <flags G_SIGNAL_RUN_CLEANUP of type GObject.SignalFlags>, 'NO_RECURSE': <flags G_SIGNAL_NO_RECURSE of type GObject.SignalFlags>, 'DETAILED': <flags G_SIGNAL_DETAILED of type GObject.SignalFlags>, 'ACTION': <flags G_SIGNAL_ACTION of type GObject.SignalFlags>, 'NO_HOOKS': <flags G_SIGNAL_NO_HOOKS of type GObject.SignalFlags>, 'MUST_COLLECT': <flags G_SIGNAL_MUST_COLLECT of type GObject.SignalFlags>, 'DEPRECATED': <flags G_SIGNAL_DEPRECATED of type GObject.SignalFlags>, 'ACCUMULATOR_FIRST_RUN': <flags G_SIGNAL_ACCUMULATOR_FIRST_RUN of type GObject.SignalFlags>})"
    __flags_values__ = {
        1: 1,
        2: 2,
        4: 4,
    ...
    __gtype__ = None # (!) real value is '<GType PyGObjectSignalFlags (83282064)>'
