...
class TypeInstance(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(TypeInstance), '__module__': 'gi.repository.GObject', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'TypeInstance' objects>, '__weakref__': <attribute '__weakref__' of 'TypeInstance' objects>, '__doc__': None, 'g_class': <property object at 0x0000010b07a88810>, 'get_private': gi.FunctionInfo(get_private, bound=None)})"
