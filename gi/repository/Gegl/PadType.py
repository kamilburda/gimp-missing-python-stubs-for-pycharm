...
class PadType(__gobject.GFlags):
    ...
    OUTPUT = 256
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gegl', '__dict__': <attribute '__dict__' of 'PadType' objects>, '__doc__': None, '__gtype__': <GType PyGeglPadType (426592784)>, '__flags_values__': {256: <flags GEGL_PARAM_PAD_OUTPUT of type Gegl.PadType>, 512: <flags GEGL_PARAM_PAD_INPUT of type Gegl.PadType>}, '__info__': gi.EnumInfo(PadType), 'OUTPUT': <flags GEGL_PARAM_PAD_OUTPUT of type Gegl.PadType>, 'INPUT': <flags GEGL_PARAM_PAD_INPUT of type Gegl.PadType>})"
    __flags_values__ = {
        256: 256,
        512: 512,
    }
    __gtype__ = None # (!) real value is '<GType PyGeglPadType (426592784)>'
