...
class DisplayManager(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002459bfc7130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DisplayManager), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkDisplayManager (2575325376)>, '__doc__': None, '__gsignals__': {}, 'get': gi.FunctionInfo(get, bound=None), 'get_default_display': gi.FunctionInfo(get_default_display, bound=None), 'list_displays': gi.FunctionInfo(list_displays, bound=None), 'open_display': gi.FunctionInfo(open_display, bound=None), 'set_default_display': gi.FunctionInfo(set_default_display, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDisplayManager (2575325376)>'
