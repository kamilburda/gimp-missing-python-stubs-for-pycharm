...
class DeviceType(__gobject.GEnum):
    ...
    SLAVE = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gdk', '__dict__': <attribute '__dict__' of 'DeviceType' objects>, '__doc__': None, '__gtype__': <GType GdkDeviceType (2569374128)>, '__enum_values__': {0: <enum GDK_DEVICE_TYPE_MASTER of type Gdk.DeviceType>, 1: <enum GDK_DEVICE_TYPE_SLAVE of type Gdk.DeviceType>, 2: <enum GDK_DEVICE_TYPE_FLOATING of type Gdk.DeviceType>}, '__info__': gi.EnumInfo(DeviceType), 'MASTER': <enum GDK_DEVICE_TYPE_MASTER of type Gdk.DeviceType>, 'SLAVE': <enum GDK_DEVICE_TYPE_SLAVE of type Gdk.DeviceType>, 'FLOATING': <enum GDK_DEVICE_TYPE_FLOATING of type Gdk.DeviceType>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType GdkDeviceType (2569374128)>'
