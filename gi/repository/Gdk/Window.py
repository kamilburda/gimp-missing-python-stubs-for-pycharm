...
class Window(Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002459a3d4640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gdk', '__new__': <staticmethod(<function Window.__new__ at 0x000002459bda5f80>)>, '__init__': <function Window.__init__ at 0x000002459bda6020>, 'cairo_create': <function Window.cairo_create at 0x000002459bda60c0>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkWindow (2575321344)>'
