...
class WMDecoration(__gobject.GFlags):
    ...
    TITLE = 8
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gdk', '__dict__': <attribute '__dict__' of 'WMDecoration' objects>, '__doc__': None, '__gtype__': <GType GdkWMDecoration (2579731648)>, '__flags_values__': {1: <flags GDK_DECOR_ALL of type Gdk.WMDecoration>, 2: <flags GDK_DECOR_BORDER of type Gdk.WMDecoration>, 4: <flags GDK_DECOR_RESIZEH of type Gdk.WMDecoration>, 8: <flags GDK_DECOR_TITLE of type Gdk.WMDecoration>, 16: <flags GDK_DECOR_MENU of type Gdk.WMDecoration>, 32: <flags GDK_DECOR_MINIMIZE of type Gdk.WMDecoration>, 64: <flags GDK_DECOR_MAXIMIZE of type Gdk.WMDecoration>}, '__info__': gi.EnumInfo(WMDecoration), 'ALL': <flags GDK_DECOR_ALL of type Gdk.WMDecoration>, 'BORDER': <flags GDK_DECOR_BORDER of type Gdk.WMDecoration>, 'RESIZEH': <flags GDK_DECOR_RESIZEH of type Gdk.WMDecoration>, 'TITLE': <flags GDK_DECOR_TITLE of type Gdk.WMDecoration>, 'MENU': <flags GDK_DECOR_MENU of type Gdk.WMDecoration>, 'MINIMIZE': <flags GDK_DECOR_MINIMIZE of type Gdk.WMDecoration>, 'MAXIMIZE': <flags GDK_DECOR_MAXIMIZE of type Gdk.WMDecoration>})"
    __flags_values__ = {
        1: 1,
        2: 2,
        4: 4,
    ...
    __gtype__ = None # (!) real value is '<GType GdkWMDecoration (2579731648)>'
