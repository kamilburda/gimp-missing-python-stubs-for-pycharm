...
class PropMode(__gobject.GEnum):
    ...
    REPLACE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gdk', '__dict__': <attribute '__dict__' of 'PropMode' objects>, '__doc__': None, '__gtype__': <GType GdkPropMode (2579729408)>, '__enum_values__': {0: <enum GDK_PROP_MODE_REPLACE of type Gdk.PropMode>, 1: <enum GDK_PROP_MODE_PREPEND of type Gdk.PropMode>, 2: <enum GDK_PROP_MODE_APPEND of type Gdk.PropMode>}, '__info__': gi.EnumInfo(PropMode), 'REPLACE': <enum GDK_PROP_MODE_REPLACE of type Gdk.PropMode>, 'PREPEND': <enum GDK_PROP_MODE_PREPEND of type Gdk.PropMode>, 'APPEND': <enum GDK_PROP_MODE_APPEND of type Gdk.PropMode>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType GdkPropMode (2579729408)>'
