...
class DeviceTool(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002459bdd39d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceTool), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkDeviceTool (2569376592)>, '__doc__': None, '__gsignals__': {}, 'get_hardware_id': gi.FunctionInfo(get_hardware_id, bound=None), 'get_serial': gi.FunctionInfo(get_serial, bound=None), 'get_tool_type': gi.FunctionInfo(get_tool_type, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDeviceTool (2569376592)>'
