...
class TouchpadGesturePhase(__gobject.GEnum):
    ...
    UPDATE = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gdk', '__dict__': <attribute '__dict__' of 'TouchpadGesturePhase' objects>, '__doc__': None, '__gtype__': <GType GdkTouchpadGesturePhase (2579731536)>, '__enum_values__': {0: <enum GDK_TOUCHPAD_GESTURE_PHASE_BEGIN of type Gdk.TouchpadGesturePhase>, 1: <enum GDK_TOUCHPAD_GESTURE_PHASE_UPDATE of type Gdk.TouchpadGesturePhase>, 2: <enum GDK_TOUCHPAD_GESTURE_PHASE_END of type Gdk.TouchpadGesturePhase>, 3: <enum GDK_TOUCHPAD_GESTURE_PHASE_CANCEL of type Gdk.TouchpadGesturePhase>}, '__info__': gi.EnumInfo(TouchpadGesturePhase), 'BEGIN': <enum GDK_TOUCHPAD_GESTURE_PHASE_BEGIN of type Gdk.TouchpadGesturePhase>, 'UPDATE': <enum GDK_TOUCHPAD_GESTURE_PHASE_UPDATE of type Gdk.TouchpadGesturePhase>, 'END': <enum GDK_TOUCHPAD_GESTURE_PHASE_END of type Gdk.TouchpadGesturePhase>, 'CANCEL': <enum GDK_TOUCHPAD_GESTURE_PHASE_CANCEL of type Gdk.TouchpadGesturePhase>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType GdkTouchpadGesturePhase (2579731536)>'
