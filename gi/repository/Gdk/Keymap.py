...
class Keymap(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002459c414be0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Keymap), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkKeymap (2579384928)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default, bound=None), 'get_for_display': gi.FunctionInfo(get_for_display, bound=None), 'add_virtual_modifiers': gi.FunctionInfo(add_virtual_modifiers, bound=None), 'get_caps_lock_state': gi.FunctionInfo(get_caps_lock_state, bound=None), 'get_direction': gi.FunctionInfo(get_direction, bound=None), 'get_entries_for_keycode': gi.FunctionInfo(get_entries_for_keycode, bound=None), 'get_entries_for_keyval': gi.FunctionInfo(get_entries_for_keyval, bound=None), 'get_modifier_mask': gi.FunctionInfo(get_modifier_mask, bound=None), 'get_modifier_state': gi.FunctionInfo(get_modifier_state, bound=None), 'get_num_lock_state': gi.FunctionInfo(get_num_lock_state, bound=None), 'get_scroll_lock_state': gi.FunctionInfo(get_scroll_lock_state, bound=None), 'have_bidi_layouts': gi.FunctionInfo(have_bidi_layouts, bound=None), 'lookup_key': gi.FunctionInfo(lookup_key, bound=None), 'map_virtual_modifiers': gi.FunctionInfo(map_virtual_modifiers, bound=None), 'translate_keyboard_state': gi.FunctionInfo(translate_keyboard_state, bound=None)})"
    __gdoc__ = 'Object GdkKeymap\n\nSignals from GdkKeymap:\n  direction-changed ()\n  keys-changed ()\n  state-changed ()\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkKeymap (2579384928)>'
