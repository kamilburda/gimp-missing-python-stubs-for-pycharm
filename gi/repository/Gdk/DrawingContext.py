...
class DrawingContext(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002459bf6afe0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawingContext), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkDrawingContext (2579726608)>, '__doc__': None, '__gsignals__': {}, 'get_cairo_context': gi.FunctionInfo(get_cairo_context, bound=None), 'get_clip': gi.FunctionInfo(get_clip, bound=None), 'get_window': gi.FunctionInfo(get_window, bound=None), 'is_valid': gi.FunctionInfo(is_valid, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDrawingContext (2579726608)>'
