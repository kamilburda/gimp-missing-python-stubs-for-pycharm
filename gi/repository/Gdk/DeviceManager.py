...
class DeviceManager(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002459bfc2470>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DeviceManager), '__module__': 'gi.repository.Gdk', '__gtype__': <GType GdkDeviceManager (2569375696)>, '__doc__': None, '__gsignals__': {}, 'get_client_pointer': gi.FunctionInfo(get_client_pointer, bound=None), 'get_display': gi.FunctionInfo(get_display, bound=None), 'list_devices': gi.FunctionInfo(list_devices, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GdkDeviceManager (2569375696)>'
