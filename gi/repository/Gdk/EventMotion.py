...
class EventMotion(EventMotion):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gdk', '__doc__': None, 'type': <property object at 0x000002459bd6c630>, 'window': <property object at 0x000002459bd6c720>, 'send_event': <property object at 0x000002459bd6c810>, 'time': <property object at 0x000002459bd6c900>, 'x': <property object at 0x000002459bd6c9f0>, 'y': <property object at 0x000002459bd6cae0>, 'axes': <property object at 0x000002459bd6cbd0>, 'state': <property object at 0x000002459bd6ccc0>, 'is_hint': <property object at 0x000002459bd6cdb0>, 'device': <property object at 0x000002459bd6cea0>, 'x_root': <property object at 0x000002459bd6cf90>, 'y_root': <property object at 0x000002459bd6d080>, 'new': gi.FunctionInfo(new, bound=<class 'gi.repository.Gdk.Event'>), '_get_angle': gi.FunctionInfo(_get_angle, bound=None), '_get_center': gi.FunctionInfo(_get_center, bound=None), '_get_distance': gi.FunctionInfo(_get_distance, bound=None), 'copy': gi.FunctionInfo(copy, bound=None), 'free': gi.FunctionInfo(free, bound=None), 'get_axis': <function strip_boolean_result.<locals>.wrapped at 0x000002459bda6b60>, 'get_button': gi.FunctionInfo(get_button, bound=None), 'get_click_count': gi.FunctionInfo(get_click_count, bound=None), 'get_coords': <function strip_boolean_result.<locals>.wrapped at 0x000002459bda6c00>, 'get_device': gi.FunctionInfo(get_device, bound=None), 'get_device_tool': gi.FunctionInfo(get_device_tool, bound=None), 'get_event_sequence': gi.FunctionInfo(get_event_sequence, bound=None), 'get_event_type': gi.FunctionInfo(get_event_type, bound=None), 'get_keycode': gi.FunctionInfo(get_keycode, bound=None), 'get_keyval': gi.FunctionInfo(get_keyval, bound=None), 'get_pointer_emulated': gi.FunctionInfo(get_pointer_emulated, bound=None), 'get_root_coords': <function strip_boolean_result.<locals>.wrapped at 0x000002459bda6ca0>, 'get_scancode': gi.FunctionInfo(get_scancode, bound=None), 'get_screen': gi.FunctionInfo(get_screen, bound=None), 'get_scroll_deltas': gi.FunctionInfo(get_scroll_deltas, bound=None), 'get_scroll_direction': gi.FunctionInfo(get_scroll_direction, bound=None), 'get_seat': gi.FunctionInfo(get_seat, bound=None), 'get_source_device': gi.FunctionInfo(get_source_device, bound=None), 'get_state': <function strip_boolean_result.<locals>.wrapped at 0x000002459bda6d40>, 'get_time': gi.FunctionInfo(get_time, bound=None), 'get_window': gi.FunctionInfo(get_window, bound=None), 'is_scroll_stop_event': gi.FunctionInfo(is_scroll_stop_event, bound=None), 'put': gi.FunctionInfo(put, bound=None), 'set_device': gi.FunctionInfo(set_device, bound=None), 'set_device_tool': gi.FunctionInfo(set_device_tool, bound=None), 'set_screen': gi.FunctionInfo(set_screen, bound=None), 'set_source_device': gi.FunctionInfo(set_source_device, bound=None), 'triggers_context_menu': gi.FunctionInfo(triggers_context_menu, bound=None), 'get': gi.FunctionInfo(get, bound=None), 'handler_set': gi.FunctionInfo(handler_set, bound=None), 'peek': gi.FunctionInfo(peek, bound=None), 'request_motions': gi.FunctionInfo(request_motions, bound=None)})"
