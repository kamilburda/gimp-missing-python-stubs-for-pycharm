...
# from C:/Program Files/GIMP 3/lib/girepository-1.0\PangoFT2-1.0.typelib
# by generator 1.147
"""
...
class FontMap(__gi_repository_PangoFc.FontMap):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a29ac4cd00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontMap), '__module__': 'gi.repository.PangoFT2', '__gtype__': <GType PangoFT2FontMap (2558099312)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set_default_substitute': gi.FunctionInfo(set_default_substitute, bound=None), 'set_resolution': gi.FunctionInfo(set_resolution, bound=None), 'substitute_changed': gi.FunctionInfo(substitute_changed, bound=None)})"
    __gdoc__ = 'Object PangoFT2FontMap\n\nSignals from GListModel:\n  items-changed (guint, guint, guint)\n\nSignals from GListModel:\n  items-changed (guint, guint, guint)\n\nProperties from PangoFontMap:\n  item-type -> GType: \n    \n  n-items -> guint: \n    \n\nSignals from GListModel:\n  items-changed (guint, guint, guint)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType PangoFT2FontMap (2558099312)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x000001a29ab78720>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x000001a29ab78900>, '__repr__': <function IntrospectionModule.__repr__ at 0x000001a29ab789a0>, '__dir__': <function IntrospectionModule.__dir__ at 0x000001a29ab78a40>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x000001a29a2a2090>'

__path__ = []

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.PangoFT2', loader=<gi.importer.DynamicImporter object at 0x000001a29a2a2090>)"
