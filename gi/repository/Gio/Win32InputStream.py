...
class Win32InputStream(InputStream):
    """
    :Constructors:
    
    ::
    
        Win32InputStream(**properties)
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792e28640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Win32InputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GWin32InputStream (2466623040)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_close_handle': gi.FunctionInfo(get_close_handle, bound=None), 'get_handle': gi.FunctionInfo(get_handle, bound=None), 'set_close_handle': gi.FunctionInfo(set_close_handle, bound=None), 'parent_instance': <property object at 0x000001a793e729d0>, 'priv': <property object at 0x000001a793e72ac0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GWin32InputStream (2466623040)>'
    __info__ = ObjectInfo(Win32InputStream)
