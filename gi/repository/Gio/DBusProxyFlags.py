...
class DBusProxyFlags(__gobject.GFlags):
    ...
    __gtype__ = None # (!) real value is '<GType GDBusProxyFlags (2472620112)>'
    __info__ = gi.EnumInfo(DBusProxyFlags)
