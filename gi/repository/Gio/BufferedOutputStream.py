...
class BufferedOutputStream(FilterOutputStream, Seekable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792ecf6a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BufferedOutputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GBufferedOutputStream (2470713760)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_sized': gi.FunctionInfo(new_sized, bound=None), 'get_auto_grow': gi.FunctionInfo(get_auto_grow, bound=None), 'get_buffer_size': gi.FunctionInfo(get_buffer_size, bound=None), 'set_auto_grow': gi.FunctionInfo(set_auto_grow, bound=None), 'set_buffer_size': gi.FunctionInfo(set_buffer_size, bound=None), 'parent_instance': <property object at 0x000001a793d8da80>, 'priv': <property object at 0x000001a793d8db70>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBufferedOutputStream (2470713760)>'
