...
class DBusObjectProxy(__gi_overrides_GObject.Object, DBusObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DBusObjectProxy), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDBusObjectProxy (2472617200)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_connection': gi.FunctionInfo(get_connection, bound=None), 'parent_instance': <property object at 0x000001a793e3d080>, 'priv': <property object at 0x000001a793e3d170>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusObjectProxy (2472617200)>'
