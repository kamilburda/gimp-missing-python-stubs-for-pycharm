...
class TlsClientConnection(__gobject.GInterface):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': InterfaceInfo(TlsClientConnection), '__module__': 'gi.repository.Gio', '__gtype__': <GType GTlsClientConnection (2466627296)>, '__dict__': <attribute '__dict__' of 'TlsClientConnection' objects>, '__weakref__': <attribute '__weakref__' of 'TlsClientConnection' objects>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'copy_session_state': gi.FunctionInfo(copy_session_state, bound=None), 'get_accepted_cas': gi.FunctionInfo(get_accepted_cas, bound=None), 'get_server_identity': gi.FunctionInfo(get_server_identity, bound=None), 'get_use_ssl3': gi.FunctionInfo(get_use_ssl3, bound=None), 'get_validation_flags': gi.FunctionInfo(get_validation_flags, bound=None), 'set_server_identity': gi.FunctionInfo(set_server_identity, bound=None), 'set_use_ssl3': gi.FunctionInfo(set_use_ssl3, bound=None), 'set_validation_flags': gi.FunctionInfo(set_validation_flags, bound=None)})"
    __gdoc__ = 'Interface GTlsClientConnection\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GTlsClientConnection (2466627296)>'
