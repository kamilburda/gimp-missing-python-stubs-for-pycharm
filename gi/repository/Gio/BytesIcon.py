...
class BytesIcon(__gi_overrides_GObject.Object, Icon, LoadableIcon):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792ecf0d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BytesIcon), '__module__': 'gi.repository.Gio', '__gtype__': <GType GBytesIcon (2472609136)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_bytes': gi.FunctionInfo(get_bytes, bound=None)})"
    __gdoc__ = 'Object GBytesIcon\n\nProperties from GBytesIcon:\n  bytes -> GBytes: bytes\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBytesIcon (2472609136)>'
