...
class SimpleProxyResolver(__gi_overrides_GObject.Object, ProxyResolver):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792eb5e40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SimpleProxyResolver), '__module__': 'gi.repository.Gio', '__gtype__': <GType GSimpleProxyResolver (2466390624)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set_default_proxy': gi.FunctionInfo(set_default_proxy, bound=None), 'set_ignore_hosts': gi.FunctionInfo(set_ignore_hosts, bound=None), 'set_uri_proxy': gi.FunctionInfo(set_uri_proxy, bound=None), 'parent_instance': <property object at 0x000001a793dc8f40>, 'priv': <property object at 0x000001a793dc9030>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSimpleProxyResolver (2466390624)>'
