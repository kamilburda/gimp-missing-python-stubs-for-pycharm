...
class IOModule(__gi_repository_GObject.TypeModule):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793751660>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IOModule), '__module__': 'gi.repository.Gio', '__gtype__': <GType GIOModule (2466388832)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'query': gi.FunctionInfo(query, bound=None)})"
    __gdoc__ = 'Object GIOModule\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GIOModule (2466388832)>'
