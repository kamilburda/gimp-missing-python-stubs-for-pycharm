...
class BufferedInputStream(FilterInputStream, Seekable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792ecefe0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BufferedInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GBufferedInputStream (2421253056)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_sized': gi.FunctionInfo(new_sized, bound=None), 'fill': gi.FunctionInfo(fill, bound=None), 'fill_async': gi.FunctionInfo(fill_async, bound=None), 'fill_finish': gi.FunctionInfo(fill_finish, bound=None), 'get_available': gi.FunctionInfo(get_available, bound=None), 'get_buffer_size': gi.FunctionInfo(get_buffer_size, bound=None), 'peek': gi.FunctionInfo(peek, bound=None), 'peek_buffer': gi.FunctionInfo(peek_buffer, bound=None), 'read_byte': gi.FunctionInfo(read_byte, bound=None), 'set_buffer_size': gi.FunctionInfo(set_buffer_size, bound=None), 'do_fill': gi.VFuncInfo(fill, bound=None), 'do_fill_async': gi.VFuncInfo(fill_async, bound=None), 'do_fill_finish': gi.VFuncInfo(fill_finish, bound=None), 'parent_instance': <property object at 0x000001a79393b830>, 'priv': <property object at 0x000001a79393b920>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GBufferedInputStream (2421253056)>'
