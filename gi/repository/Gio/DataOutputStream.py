...
class DataOutputStream(FilterOutputStream, Seekable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793750ee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DataOutputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDataOutputStream (2470711584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_byte_order': gi.FunctionInfo(get_byte_order, bound=None), 'put_byte': gi.FunctionInfo(put_byte, bound=None), 'put_int16': gi.FunctionInfo(put_int16, bound=None), 'put_int32': gi.FunctionInfo(put_int32, bound=None), 'put_int64': gi.FunctionInfo(put_int64, bound=None), 'put_string': gi.FunctionInfo(put_string, bound=None), 'put_uint16': gi.FunctionInfo(put_uint16, bound=None), 'put_uint32': gi.FunctionInfo(put_uint32, bound=None), 'put_uint64': gi.FunctionInfo(put_uint64, bound=None), 'set_byte_order': gi.FunctionInfo(set_byte_order, bound=None), 'parent_instance': <property object at 0x000001a793e287c0>, 'priv': <property object at 0x000001a793e288b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataOutputStream (2470711584)>'
