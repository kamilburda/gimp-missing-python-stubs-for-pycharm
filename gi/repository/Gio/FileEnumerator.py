...
class FileEnumerator(FileEnumerator):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793750b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gio', '__iter__': <function FileEnumerator.__iter__ at 0x000001a7938bb6a0>, '__next__': <function FileEnumerator.__next__ at 0x000001a7938bb740>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object GFileEnumerator\n\nProperties from GFileEnumerator:\n  container -> GFile: container\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GFileEnumerator (2430930336)>'
