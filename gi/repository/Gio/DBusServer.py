...
class DBusServer(__gi_overrides_GObject.Object, Initable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793750d90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DBusServer), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDBusServer (2472621232)>, '__doc__': None, '__gsignals__': {}, 'new_sync': gi.FunctionInfo(new_sync, bound=None), 'get_client_address': gi.FunctionInfo(get_client_address, bound=None), 'get_flags': gi.FunctionInfo(get_flags, bound=None), 'get_guid': gi.FunctionInfo(get_guid, bound=None), 'is_active': gi.FunctionInfo(is_active, bound=None), 'start': gi.FunctionInfo(start, bound=None), 'stop': gi.FunctionInfo(stop, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusServer (2472621232)>'
