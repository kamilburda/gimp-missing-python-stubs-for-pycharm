...
class SocketMsgFlags(__gobject.GFlags):
    ...
    PEEK = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gio', '__dict__': <attribute '__dict__' of 'SocketMsgFlags' objects>, '__doc__': None, '__gtype__': <GType GSocketMsgFlags (2466396672)>, '__flags_values__': {0: <flags 0 of type Gio.SocketMsgFlags>, 1: <flags G_SOCKET_MSG_OOB of type Gio.SocketMsgFlags>, 2: <flags G_SOCKET_MSG_PEEK of type Gio.SocketMsgFlags>, 4: <flags G_SOCKET_MSG_DONTROUTE of type Gio.SocketMsgFlags>}, '__info__': gi.EnumInfo(SocketMsgFlags), 'NONE': <flags 0 of type Gio.SocketMsgFlags>, 'OOB': <flags G_SOCKET_MSG_OOB of type Gio.SocketMsgFlags>, 'PEEK': <flags G_SOCKET_MSG_PEEK of type Gio.SocketMsgFlags>, 'DONTROUTE': <flags G_SOCKET_MSG_DONTROUTE of type Gio.SocketMsgFlags>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType GSocketMsgFlags (2466396672)>'
