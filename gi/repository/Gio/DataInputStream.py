...
class DataInputStream(DataInputStream):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793751180>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gio', '__iter__': <function DataInputStream.__iter__ at 0x000001a793940d60>, '__next__': <function DataInputStream.__next__ at 0x000001a793940e00>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDataInputStream (2421251776)>'
