...
class MemoryOutputStream(OutputStream, PollableOutputStream, Seekable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792eb7850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MemoryOutputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GMemoryOutputStream (2466383680)>, '__doc__': None, '__gsignals__': {}, 'new_resizable': gi.FunctionInfo(new_resizable, bound=None), 'get_data': gi.FunctionInfo(get_data, bound=None), 'get_data_size': gi.FunctionInfo(get_data_size, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'steal_as_bytes': gi.FunctionInfo(steal_as_bytes, bound=None), 'steal_data': gi.FunctionInfo(steal_data, bound=None), 'parent_instance': <property object at 0x000001a793df0fe0>, 'priv': <property object at 0x000001a793df10d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMemoryOutputStream (2466383680)>'
