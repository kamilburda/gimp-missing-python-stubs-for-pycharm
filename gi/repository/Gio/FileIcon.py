...
class FileIcon(__gi_overrides_GObject.Object, Icon, LoadableIcon):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793751870>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileIcon), '__module__': 'gi.repository.Gio', '__gtype__': <GType GFileIcon (2466384464)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_file': gi.FunctionInfo(get_file, bound=None)})"
    __gdoc__ = 'Object GFileIcon\n\nProperties from GFileIcon:\n  file -> GFile: file\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GFileIcon (2466384464)>'
