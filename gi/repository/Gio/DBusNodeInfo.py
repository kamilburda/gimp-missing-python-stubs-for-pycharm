...
class DBusNodeInfo(DBusNodeInfo):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gio', '__init__': <function _warn_init.<locals>.new_init at 0x000001a7938bb4c0>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GDBusNodeInfo (2430929888)>'
