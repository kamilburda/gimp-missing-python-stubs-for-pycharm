...
class TcpConnection(SocketConnection):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TcpConnection), '__module__': 'gi.repository.Gio', '__gtype__': <GType GTcpConnection (2466403920)>, '__doc__': None, '__gsignals__': {}, 'get_graceful_disconnect': gi.FunctionInfo(get_graceful_disconnect, bound=None), 'set_graceful_disconnect': gi.FunctionInfo(set_graceful_disconnect, bound=None), 'parent_instance': <property object at 0x000001a793db6250>, 'priv': <property object at 0x000001a793db6340>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GTcpConnection (2466403920)>'
