...
class DBusActionGroup(__gi_overrides_GObject.Object, ActionGroup, RemoteActionGroup):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a7937509d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DBusActionGroup), '__module__': 'gi.repository.Gio', '__gtype__': <GType GDBusActionGroup (2472612608)>, '__doc__': None, '__gsignals__': {}, 'get': gi.FunctionInfo(get, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GDBusActionGroup (2472612608)>'
