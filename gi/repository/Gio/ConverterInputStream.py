...
class ConverterInputStream(FilterInputStream, PollableInputStream):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ConverterInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GConverterInputStream (2470712864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_converter': gi.FunctionInfo(get_converter, bound=None), 'parent_instance': <property object at 0x000001a793d8ff10>, 'priv': <property object at 0x000001a793d98040>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GConverterInputStream (2470712864)>'
