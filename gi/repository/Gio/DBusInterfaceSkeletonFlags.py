...
class DBusInterfaceSkeletonFlags(__gobject.GFlags):
    ...
    NONE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gio', '__dict__': <attribute '__dict__' of 'DBusInterfaceSkeletonFlags' objects>, '__doc__': None, '__gtype__': <GType GDBusInterfaceSkeletonFlags (2472608016)>, '__flags_values__': {0: <flags 0 of type Gio.DBusInterfaceSkeletonFlags>, 1: <flags G_DBUS_INTERFACE_SKELETON_FLAGS_HANDLE_METHOD_INVOCATIONS_IN_THREAD of type Gio.DBusInterfaceSkeletonFlags>}, '__info__': gi.EnumInfo(DBusInterfaceSkeletonFlags), 'NONE': <flags 0 of type Gio.DBusInterfaceSkeletonFlags>, 'HANDLE_METHOD_INVOCATIONS_IN_THREAD': <flags G_DBUS_INTERFACE_SKELETON_FLAGS_HANDLE_METHOD_INVOCATIONS_IN_THREAD of type Gio.DBusInterfaceSkeletonFlags>})"
    __flags_values__ = {
        0: 0,
        1: 1,
    }
    __gtype__ = None # (!) real value is '<GType GDBusInterfaceSkeletonFlags (2472608016)>'
