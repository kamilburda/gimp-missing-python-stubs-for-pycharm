...
class TlsDatabaseVerifyFlags(__gobject.GFlags):
    ...
    NONE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gio', '__dict__': <attribute '__dict__' of 'TlsDatabaseVerifyFlags' objects>, '__doc__': None, '__gtype__': <GType GTlsDatabaseVerifyFlags (2466629536)>, '__flags_values__': {0: <flags 0 of type Gio.TlsDatabaseVerifyFlags>}, '__info__': gi.EnumInfo(TlsDatabaseVerifyFlags), 'NONE': <flags 0 of type Gio.TlsDatabaseVerifyFlags>})"
    __flags_values__ = {
        0: 0,
    }
    __gtype__ = None # (!) real value is '<GType GTlsDatabaseVerifyFlags (2466629536)>'
