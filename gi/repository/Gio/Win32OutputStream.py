...
class Win32OutputStream(OutputStream):
    """
    :Constructors:
    
    ::
    
        Win32OutputStream(**properties)
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Win32OutputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GWin32OutputStream (2466629760)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_close_handle': gi.FunctionInfo(get_close_handle, bound=None), 'get_handle': gi.FunctionInfo(get_handle, bound=None), 'set_close_handle': gi.FunctionInfo(set_close_handle, bound=None), 'parent_instance': <property object at 0x000001a793e73970>, 'priv': <property object at 0x000001a793e73a60>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GWin32OutputStream (2466629760)>'
    __info__ = ObjectInfo(Win32OutputStream)
