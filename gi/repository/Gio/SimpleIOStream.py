...
class SimpleIOStream(IOStream):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792eb5e10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SimpleIOStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GSimpleIOStream (2466391856)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GSimpleIOStream (2466391856)>'
