...
class EmblemOrigin(__gobject.GEnum):
    ...
    __gtype__ = None # (!) real value is '<GType GEmblemOrigin (2472623248)>'
    __info__ = gi.EnumInfo(EmblemOrigin)
