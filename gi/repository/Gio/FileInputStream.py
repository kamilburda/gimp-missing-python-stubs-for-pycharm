...
class FileInputStream(InputStream, Seekable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793752320>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GFileInputStream (2466383344)>, '__doc__': None, '__gsignals__': {}, 'query_info': gi.FunctionInfo(query_info, bound=None), 'query_info_async': gi.FunctionInfo(query_info_async, bound=None), 'query_info_finish': gi.FunctionInfo(query_info_finish, bound=None), 'do_can_seek': gi.VFuncInfo(can_seek, bound=None), 'do_query_info': gi.VFuncInfo(query_info, bound=None), 'do_query_info_async': gi.VFuncInfo(query_info_async, bound=None), 'do_query_info_finish': gi.VFuncInfo(query_info_finish, bound=None), 'do_seek': gi.VFuncInfo(seek, bound=None), 'do_tell': gi.VFuncInfo(tell, bound=None), 'parent_instance': <property object at 0x000001a793e0ec50>, 'priv': <property object at 0x000001a793e0ede0>})"
    __gdoc__ = 'Object GFileInputStream\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GFileInputStream (2466383344)>'
