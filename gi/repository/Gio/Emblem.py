...
class Emblem(__gi_overrides_GObject.Object, Icon):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a7937502b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Emblem), '__module__': 'gi.repository.Gio', '__gtype__': <GType GEmblem (2472624032)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_origin': gi.FunctionInfo(new_with_origin, bound=None), 'get_icon': gi.FunctionInfo(get_icon, bound=None), 'get_origin': gi.FunctionInfo(get_origin, bound=None)})"
    __gdoc__ = 'Object GEmblem\n\nProperties from GEmblem:\n  icon -> GObject: icon\n  origin -> GEmblemOrigin: origin\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GEmblem (2472624032)>'
