...
class MemoryInputStream(InputStream, PollableInputStream, Seekable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a792eb5090>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MemoryInputStream), '__module__': 'gi.repository.Gio', '__gtype__': <GType GMemoryInputStream (2466386704)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_bytes': gi.FunctionInfo(new_from_bytes, bound=None), 'new_from_data': gi.FunctionInfo(new_from_data, bound=None), 'add_bytes': gi.FunctionInfo(add_bytes, bound=None), 'add_data': gi.FunctionInfo(add_data, bound=None), 'parent_instance': <property object at 0x000001a793dfbfb0>, 'priv': <property object at 0x000001a793df00e0>})"
    __gdoc__ = 'Object GMemoryInputStream\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GMemoryInputStream (2466386704)>'
