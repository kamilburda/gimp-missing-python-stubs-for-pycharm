...
class DBusConnectionFlags(__gobject.GFlags):
    ...
    NONE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gio', '__dict__': <attribute '__dict__' of 'DBusConnectionFlags' objects>, '__doc__': None, '__gtype__': <GType GDBusConnectionFlags (2472614064)>, '__flags_values__': {0: <flags 0 of type Gio.DBusConnectionFlags>, 1: <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_CLIENT of type Gio.DBusConnectionFlags>, 2: <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_SERVER of type Gio.DBusConnectionFlags>, 4: <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_ALLOW_ANONYMOUS of type Gio.DBusConnectionFlags>, 8: <flags G_DBUS_CONNECTION_FLAGS_MESSAGE_BUS_CONNECTION of type Gio.DBusConnectionFlags>, 16: <flags G_DBUS_CONNECTION_FLAGS_DELAY_MESSAGE_PROCESSING of type Gio.DBusConnectionFlags>, 32: <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_REQUIRE_SAME_USER of type Gio.DBusConnectionFlags>, 64: <flags G_DBUS_CONNECTION_FLAGS_CROSS_NAMESPACE of type Gio.DBusConnectionFlags>}, '__info__': gi.EnumInfo(DBusConnectionFlags), 'NONE': <flags 0 of type Gio.DBusConnectionFlags>, 'AUTHENTICATION_CLIENT': <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_CLIENT of type Gio.DBusConnectionFlags>, 'AUTHENTICATION_SERVER': <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_SERVER of type Gio.DBusConnectionFlags>, 'AUTHENTICATION_ALLOW_ANONYMOUS': <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_ALLOW_ANONYMOUS of type Gio.DBusConnectionFlags>, 'MESSAGE_BUS_CONNECTION': <flags G_DBUS_CONNECTION_FLAGS_MESSAGE_BUS_CONNECTION of type Gio.DBusConnectionFlags>, 'DELAY_MESSAGE_PROCESSING': <flags G_DBUS_CONNECTION_FLAGS_DELAY_MESSAGE_PROCESSING of type Gio.DBusConnectionFlags>, 'AUTHENTICATION_REQUIRE_SAME_USER': <flags G_DBUS_CONNECTION_FLAGS_AUTHENTICATION_REQUIRE_SAME_USER of type Gio.DBusConnectionFlags>, 'CROSS_NAMESPACE': <flags G_DBUS_CONNECTION_FLAGS_CROSS_NAMESPACE of type Gio.DBusConnectionFlags>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType GDBusConnectionFlags (2472614064)>'
