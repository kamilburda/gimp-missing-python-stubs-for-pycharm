...
class EmblemedIcon(__gi_overrides_GObject.Object, Icon):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001a793753dc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EmblemedIcon), '__module__': 'gi.repository.Gio', '__gtype__': <GType GEmblemedIcon (2472623472)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_emblem': gi.FunctionInfo(add_emblem, bound=None), 'clear_emblems': gi.FunctionInfo(clear_emblems, bound=None), 'get_emblems': gi.FunctionInfo(get_emblems, bound=None), 'get_icon': gi.FunctionInfo(get_icon, bound=None), 'parent_instance': <property object at 0x000001a793e22340>, 'priv': <property object at 0x000001a793e22430>})"
    __gdoc__ = 'Object GEmblemedIcon\n\nProperties from GEmblemedIcon:\n  gicon -> GIcon: gicon\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GEmblemedIcon (2472623472)>'
