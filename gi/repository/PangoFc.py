...
# from C:/Program Files/GIMP 3/lib/girepository-1.0\PangoFc-1.0.typelib
# by generator 1.147
"""
...
class Decoder(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001575db2e2f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Decoder), '__module__': 'gi.repository.PangoFc', '__gtype__': <GType PangoFcDecoder (1569550688)>, '__doc__': None, '__gsignals__': {}, 'get_charset': gi.FunctionInfo(get_charset, bound=None), 'get_glyph': gi.FunctionInfo(get_glyph, bound=None), 'do_get_charset': gi.VFuncInfo(get_charset, bound=None), 'do_get_glyph': gi.VFuncInfo(get_glyph, bound=None), 'parent_instance': <property object at 0x000001575ff0f650>})"
    __gdoc__ = 'Object PangoFcDecoder\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType PangoFcDecoder (1569550688)>'
...
class DecoderClass(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(DecoderClass), '__module__': 'gi.repository.PangoFc', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'DecoderClass' objects>, '__weakref__': <attribute '__weakref__' of 'DecoderClass' objects>, '__doc__': None, 'parent_class': <property object at 0x000001575ff0f7e0>, 'get_charset': <property object at 0x00000157600c2840>, 'get_glyph': <property object at 0x00000157600c27f0>, '_pango_reserved1': <property object at 0x00000157600c2700>, '_pango_reserved2': <property object at 0x00000157600c26b0>, '_pango_reserved3': <property object at 0x00000157600c24d0>, '_pango_reserved4': <property object at 0x00000157600c2480>})"
...
class Font(__gi_repository_Pango.Font):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001575e51dc90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Font), '__module__': 'gi.repository.PangoFc', '__gtype__': <GType PangoFcFont (1569551024)>, '__doc__': None, '__gsignals__': {}, 'description_from_pattern': gi.FunctionInfo(description_from_pattern, bound=None), 'get_glyph': gi.FunctionInfo(get_glyph, bound=None), 'get_languages': gi.FunctionInfo(get_languages, bound=None), 'get_unknown_glyph': gi.FunctionInfo(get_unknown_glyph, bound=None), 'has_char': gi.FunctionInfo(has_char, bound=None), 'kern_glyphs': gi.FunctionInfo(kern_glyphs, bound=None), 'unlock_face': gi.FunctionInfo(unlock_face, bound=None), 'parent_instance': <property object at 0x00000157600c30b0>, 'font_pattern': <property object at 0x00000157600c31a0>, 'fontmap': <property object at 0x00000157600c3290>, 'priv': <property object at 0x00000157600c3380>, 'matrix': <property object at 0x00000157600c3470>, 'description': <property object at 0x00000157600c3560>, 'metrics_by_lang': <property object at 0x00000157600c3650>, 'is_hinted': <property object at 0x00000157600c3740>, 'is_transformed': <property object at 0x00000157600c3830>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType PangoFcFont (1569551024)>'
...
class FontMap(__gi_repository_Pango.FontMap):
    ...
    def set_default_substitute(self, func, data=None): # real signature unknown; restored from __doc__
        """ set_default_substitute(self, func:PangoFc.SubstituteFunc, data=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001575db323b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontMap), '__module__': 'gi.repository.PangoFc', '__gtype__': <GType PangoFcFontMap (1564809536)>, '__doc__': None, '__gsignals__': {}, 'cache_clear': gi.FunctionInfo(cache_clear, bound=None), 'config_changed': gi.FunctionInfo(config_changed, bound=None), 'create_context': gi.FunctionInfo(create_context, bound=None), 'find_decoder': gi.FunctionInfo(find_decoder, bound=None), 'set_default_substitute': gi.FunctionInfo(set_default_substitute, bound=None), 'shutdown': gi.FunctionInfo(shutdown, bound=None), 'substitute_changed': gi.FunctionInfo(substitute_changed, bound=None)})"
    __gdoc__ = 'Object PangoFcFontMap\n\nSignals from GListModel:\n  items-changed (guint, guint, guint)\n\nProperties from PangoFontMap:\n  item-type -> GType: \n    \n  n-items -> guint: \n    \n\nSignals from GListModel:\n  items-changed (guint, guint, guint)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType PangoFcFontMap (1564809536)>'
...
class __class__(object):
    ...
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.module', '__doc__': 'An object which wraps an introspection typelib.\\n\\n    This wrapping creates a python module like representation of the typelib\\n    using gi repository as a foundation. Accessing attributes of the module\\n    will dynamically pull them in and create wrappers for the members.\\n    These members are then cached on this introspection module.\\n    ', '__init__': <function IntrospectionModule.__init__ at 0x000001575ff97b00>, '__getattr__': <function IntrospectionModule.__getattr__ at 0x000001575ff97ba0>, '__repr__': <function IntrospectionModule.__repr__ at 0x000001575ff97c40>, '__dir__': <function IntrospectionModule.__dir__ at 0x000001575ff97ce0>, '__dict__': <attribute '__dict__' of 'IntrospectionModule' objects>, '__weakref__': <attribute '__weakref__' of 'IntrospectionModule' objects>})"


# variables with complex values

__loader__ = None # (!) real value is '<gi.importer.DynamicImporter object at 0x000001575db2e990>'

__path__ = []

__spec__ = None # (!) real value is "ModuleSpec(name='gi.repository.PangoFc', loader=<gi.importer.DynamicImporter object at 0x000001575db2e990>)"
