...
class FormField(__gi_overrides_GObject.Object):
    ...
    def get_alternate_ui_name(self): # real signature unknown; restored from __doc__
        """ get_alternate_ui_name(self) -> str """
        return ""
    ...
    def signature_validate_async(self, flags, cancellable=None, callback=None, user_data=None): # real signature unknown; restored from __doc__
        """ signature_validate_async(self, flags:Poppler.SignatureValidationFlags, cancellable:Gio.Cancellable=None, callback:Gio.AsyncReadyCallback=None, user_data=None) """
        pass

    def signature_validate_finish(self, result): # real signature unknown; restored from __doc__
        """ signature_validate_finish(self, result:Gio.AsyncResult) -> Poppler.SignatureInfo """
        pass

    def signature_validate_sync(self, flags, cancellable=None): # real signature unknown; restored from __doc__
        """ signature_validate_sync(self, flags:Poppler.SignatureValidationFlags, cancellable:Gio.Cancellable=None) -> Poppler.SignatureInfo """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001deefec5db0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FormField), '__module__': 'gi.repository.Poppler', '__gtype__': <GType PopplerFormField (3987784592)>, '__doc__': None, '__gsignals__': {}, 'button_get_button_type': gi.FunctionInfo(button_get_button_type, bound=None), 'button_get_state': gi.FunctionInfo(button_get_state, bound=None), 'button_set_state': gi.FunctionInfo(button_set_state, bound=None), 'choice_can_select_multiple': gi.FunctionInfo(choice_can_select_multiple, bound=None), 'choice_commit_on_change': gi.FunctionInfo(choice_commit_on_change, bound=None), 'choice_do_spell_check': gi.FunctionInfo(choice_do_spell_check, bound=None), 'choice_get_choice_type': gi.FunctionInfo(choice_get_choice_type, bound=None), 'choice_get_item': gi.FunctionInfo(choice_get_item, bound=None), 'choice_get_n_items': gi.FunctionInfo(choice_get_n_items, bound=None), 'choice_get_text': gi.FunctionInfo(choice_get_text, bound=None), 'choice_is_editable': gi.FunctionInfo(choice_is_editable, bound=None), 'choice_is_item_selected': gi.FunctionInfo(choice_is_item_selected, bound=None), 'choice_select_item': gi.FunctionInfo(choice_select_item, bound=None), 'choice_set_text': gi.FunctionInfo(choice_set_text, bound=None), 'choice_toggle_item': gi.FunctionInfo(choice_toggle_item, bound=None), 'choice_unselect_all': gi.FunctionInfo(choice_unselect_all, bound=None), 'get_action': gi.FunctionInfo(get_action, bound=None), 'get_additional_action': gi.FunctionInfo(get_additional_action, bound=None), 'get_alternate_ui_name': gi.FunctionInfo(get_alternate_ui_name, bound=None), 'get_field_type': gi.FunctionInfo(get_field_type, bound=None), 'get_font_size': gi.FunctionInfo(get_font_size, bound=None), 'get_id': gi.FunctionInfo(get_id, bound=None), 'get_mapping_name': gi.FunctionInfo(get_mapping_name, bound=None), 'get_name': gi.FunctionInfo(get_name, bound=None), 'get_partial_name': gi.FunctionInfo(get_partial_name, bound=None), 'is_read_only': gi.FunctionInfo(is_read_only, bound=None), 'signature_validate_async': gi.FunctionInfo(signature_validate_async, bound=None), 'signature_validate_finish': gi.FunctionInfo(signature_validate_finish, bound=None), 'signature_validate_sync': gi.FunctionInfo(signature_validate_sync, bound=None), 'text_do_scroll': gi.FunctionInfo(text_do_scroll, bound=None), 'text_do_spell_check': gi.FunctionInfo(text_do_spell_check, bound=None), 'text_get_max_len': gi.FunctionInfo(text_get_max_len, bound=None), 'text_get_text': gi.FunctionInfo(text_get_text, bound=None), 'text_get_text_type': gi.FunctionInfo(text_get_text_type, bound=None), 'text_is_password': gi.FunctionInfo(text_is_password, bound=None), 'text_is_rich_text': gi.FunctionInfo(text_is_rich_text, bound=None), 'text_set_text': gi.FunctionInfo(text_set_text, bound=None)})"
    __gdoc__ = 'Object PopplerFormField\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType PopplerFormField (3987784592)>'
