...
class GravityHint(__gobject.GEnum):
    ...
    STRONG = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Pango', '__dict__': <attribute '__dict__' of 'GravityHint' objects>, '__doc__': None, '__gtype__': <GType PangoGravityHint (4081760384)>, '__enum_values__': {0: <enum PANGO_GRAVITY_HINT_NATURAL of type Pango.GravityHint>, 1: <enum PANGO_GRAVITY_HINT_STRONG of type Pango.GravityHint>, 2: <enum PANGO_GRAVITY_HINT_LINE of type Pango.GravityHint>}, '__info__': gi.EnumInfo(GravityHint), 'NATURAL': <enum PANGO_GRAVITY_HINT_NATURAL of type Pango.GravityHint>, 'STRONG': <enum PANGO_GRAVITY_HINT_STRONG of type Pango.GravityHint>, 'LINE': <enum PANGO_GRAVITY_HINT_LINE of type Pango.GravityHint>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType PangoGravityHint (4081760384)>'
