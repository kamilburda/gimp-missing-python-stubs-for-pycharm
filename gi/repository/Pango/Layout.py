...
class Layout(Layout):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x00000213f60ab400>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Pango', '__new__': <staticmethod(<function Layout.__new__ at 0x00000213f5f64cc0>)>, 'set_markup': <function Layout.set_markup at 0x00000213f5f64d60>, 'set_text': <function Layout.set_text at 0x00000213f5f64e00>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Object PangoLayout\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType PangoLayout (4081790656)>'
