...
class GObjectAccessible(Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000017336649db0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GObjectAccessible), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkGObjectAccessible (892048016)>, '__doc__': None, '__gsignals__': {}, 'for_object': gi.FunctionInfo(for_object, bound=None), 'get_object': gi.FunctionInfo(get_object, bound=None), 'parent': <property object at 0x000001733817fd30>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkGObjectAccessible (892048016)>'
