...
class Plug(Object, Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000017335c625f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Plug), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkPlug (892679968)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_id': gi.FunctionInfo(get_id, bound=None), 'set_child': gi.FunctionInfo(set_child, bound=None), 'do_get_object_id': gi.VFuncInfo(get_object_id, bound=None), 'parent': <property object at 0x000001733813d3a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkPlug (892679968)>'
