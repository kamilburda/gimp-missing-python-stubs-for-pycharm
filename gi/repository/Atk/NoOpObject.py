...
class NoOpObject(Object, Action, Component, Document, EditableText, Hypertext, Image, Selection, Table, TableCell, Text, Value, Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x0000017335b876a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NoOpObject), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkNoOpObject (892676048)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent': <property object at 0x0000017338142c00>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkNoOpObject (892676048)>'
