...
class Socket(Object, Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x00000173380b1a20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Socket), '__module__': 'gi.repository.Atk', '__gtype__': <GType AtkSocket (892680080)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'embed': gi.FunctionInfo(embed, bound=None), 'is_occupied': gi.FunctionInfo(is_occupied, bound=None), 'do_embed': gi.VFuncInfo(embed, bound=None), 'parent': <property object at 0x000001733813f650>, 'embedded_plug_id': <property object at 0x000001733813f740>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AtkSocket (892680080)>'
