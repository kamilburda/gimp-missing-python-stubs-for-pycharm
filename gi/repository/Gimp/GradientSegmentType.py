...
class GradientSegmentType(__gobject.GEnum):
    ...
    STEP = 5
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gimp', '__dict__': <attribute '__dict__' of 'GradientSegmentType' objects>, '__doc__': None, '__gtype__': <GType GimpGradientSegmentType (3595402528)>, '__enum_values__': {0: <enum GIMP_GRADIENT_SEGMENT_LINEAR of type Gimp.GradientSegmentType>, 1: <enum GIMP_GRADIENT_SEGMENT_CURVED of type Gimp.GradientSegmentType>, 2: <enum GIMP_GRADIENT_SEGMENT_SINE of type Gimp.GradientSegmentType>, 3: <enum GIMP_GRADIENT_SEGMENT_SPHERE_INCREASING of type Gimp.GradientSegmentType>, 4: <enum GIMP_GRADIENT_SEGMENT_SPHERE_DECREASING of type Gimp.GradientSegmentType>, 5: <enum GIMP_GRADIENT_SEGMENT_STEP of type Gimp.GradientSegmentType>}, '__info__': gi.EnumInfo(GradientSegmentType), 'LINEAR': <enum GIMP_GRADIENT_SEGMENT_LINEAR of type Gimp.GradientSegmentType>, 'CURVED': <enum GIMP_GRADIENT_SEGMENT_CURVED of type Gimp.GradientSegmentType>, 'SINE': <enum GIMP_GRADIENT_SEGMENT_SINE of type Gimp.GradientSegmentType>, 'SPHERE_INCREASING': <enum GIMP_GRADIENT_SEGMENT_SPHERE_INCREASING of type Gimp.GradientSegmentType>, 'SPHERE_DECREASING': <enum GIMP_GRADIENT_SEGMENT_SPHERE_DECREASING of type Gimp.GradientSegmentType>, 'STEP': <enum GIMP_GRADIENT_SEGMENT_STEP of type Gimp.GradientSegmentType>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    ...
    __gtype__ = None # (!) real value is '<GType GimpGradientSegmentType (3595402528)>'
