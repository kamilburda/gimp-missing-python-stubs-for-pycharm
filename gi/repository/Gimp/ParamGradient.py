...
class ParamGradient(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamGradient), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamGradient (3596581040)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamGradient (3596581040)>'
