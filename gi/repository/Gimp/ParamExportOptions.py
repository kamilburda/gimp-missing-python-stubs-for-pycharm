...
class ParamExportOptions(__gi_repository_GObject.ParamSpecObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamExportOptions), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamExportOptions (3595416976)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamExportOptions (3595416976)>'
