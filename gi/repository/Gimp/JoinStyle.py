...
class JoinStyle(__gobject.GEnum):
    ...
    ROUND = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gimp', '__dict__': <attribute '__dict__' of 'JoinStyle' objects>, '__doc__': None, '__gtype__': <GType GimpJoinStyle (3595406672)>, '__enum_values__': {0: <enum GIMP_JOIN_MITER of type Gimp.JoinStyle>, 1: <enum GIMP_JOIN_ROUND of type Gimp.JoinStyle>, 2: <enum GIMP_JOIN_BEVEL of type Gimp.JoinStyle>}, '__info__': gi.EnumInfo(JoinStyle), 'MITER': <enum GIMP_JOIN_MITER of type Gimp.JoinStyle>, 'ROUND': <enum GIMP_JOIN_ROUND of type Gimp.JoinStyle>, 'BEVEL': <enum GIMP_JOIN_BEVEL of type Gimp.JoinStyle>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType GimpJoinStyle (3595406672)>'
