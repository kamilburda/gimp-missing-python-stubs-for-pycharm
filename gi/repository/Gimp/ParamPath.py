...
class ParamPath(ParamItem):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPath), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamPath (3644681360)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamPath (3644681360)>'
