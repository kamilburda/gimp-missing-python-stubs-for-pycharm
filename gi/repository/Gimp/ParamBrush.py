...
class ParamBrush(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamBrush), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamBrush (3599939760)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamBrush (3599939760)>'
