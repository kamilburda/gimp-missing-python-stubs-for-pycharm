...
class NodeExportFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <NodeExportFlags.NONE: 0>, 'ADD_HEADER': <NodeExportFlags.ADD_HEADER: 1>, 'FORMAT_MULTILINE': <NodeExportFlags.FORMAT_MULTILINE: 2>, 'FORMAT_INDENT': <NodeExportFlags.FORMAT_INDENT: 4>, 'INCLUDE_SIBLINGS': <NodeExportFlags.INCLUDE_SIBLINGS: 8>, 'ONLY_CHILDREN': <NodeExportFlags.ONLY_CHILDREN: 16>, 'COLLAPSE_EMPTY': <NodeExportFlags.COLLAPSE_EMPTY: 32>})"
    __name__ = 'NodeExportFlags'
    __qualname__ = 'NodeExportFlags'
