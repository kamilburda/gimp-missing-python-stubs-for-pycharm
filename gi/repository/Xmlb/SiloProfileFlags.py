...
class SiloProfileFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <SiloProfileFlags.NONE: 0>, 'DEBUG': <SiloProfileFlags.DEBUG: 1>, 'APPEND': <SiloProfileFlags.APPEND: 2>, 'XPATH': <SiloProfileFlags.XPATH: 4>, 'OPTIMIZER': <SiloProfileFlags.OPTIMIZER: 8>})"
    __name__ = 'SiloProfileFlags'
    __qualname__ = 'SiloProfileFlags'
