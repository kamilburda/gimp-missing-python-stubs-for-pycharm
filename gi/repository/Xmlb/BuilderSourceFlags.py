...
class BuilderSourceFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <BuilderSourceFlags.NONE: 0>, 'LITERAL_TEXT': <BuilderSourceFlags.LITERAL_TEXT: 1>, 'WATCH_FILE': <BuilderSourceFlags.WATCH_FILE: 2>, 'WATCH_DIRECTORY': <BuilderSourceFlags.WATCH_DIRECTORY: 4>})"
    __name__ = 'BuilderSourceFlags'
    __qualname__ = 'BuilderSourceFlags'
