...
class SiloLoadFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <SiloLoadFlags.NONE: 0>, 'NO_MAGIC': <SiloLoadFlags.NO_MAGIC: 1>, 'WATCH_BLOB': <SiloLoadFlags.WATCH_BLOB: 2>})"
    __name__ = 'SiloLoadFlags'
    __qualname__ = 'SiloLoadFlags'
