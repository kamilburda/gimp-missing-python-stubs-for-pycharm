...
class BuilderNodeFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <BuilderNodeFlags.NONE: 0>, 'IGNORE': <BuilderNodeFlags.IGNORE: 1>, 'LITERAL_TEXT': <BuilderNodeFlags.LITERAL_TEXT: 2>, 'HAS_TEXT': <BuilderNodeFlags.HAS_TEXT: 4>, 'HAS_TAIL': <BuilderNodeFlags.HAS_TAIL: 8>, 'TOKENIZE_TEXT': <BuilderNodeFlags.TOKENIZE_TEXT: 16>, 'STRIP_TEXT': <BuilderNodeFlags.STRIP_TEXT: 32>})"
    __name__ = 'BuilderNodeFlags'
    __qualname__ = 'BuilderNodeFlags'
