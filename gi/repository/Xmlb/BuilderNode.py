...
class BuilderNode(__gi_overrides_GObject.Object):
    ...
    def add_token(self, token): # real signature unknown; restored from __doc__
    ...
    def get_tokens(self): # real signature unknown; restored from __doc__
        """ get_tokens(self) -> list or None """
        return []
    ...
    @classmethod
    def new(cls, element): # real signature unknown; restored from __doc__
        """ new(element:str) -> Xmlb.BuilderNode """
        pass
    ...
    def set_tail(self, tail=None, tail_len): # real signature unknown; restored from __doc__
        """ set_tail(self, tail:str=None, tail_len:int) """
        pass

    def set_text(self, text=None, text_len): # real signature unknown; restored from __doc__
        """ set_text(self, text:str=None, text_len:int) """
        pass
    ...
    def tokenize_text(self): # real signature unknown; restored from __doc__
        """ tokenize_text(self) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x00000154346736d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BuilderNode), '__module__': 'gi.repository.Xmlb', '__gtype__': <GType XbBuilderNode (844629040)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'add_child': gi.FunctionInfo(add_child), 'add_flag': gi.FunctionInfo(add_flag), 'add_token': gi.FunctionInfo(add_token), 'depth': gi.FunctionInfo(depth), 'export': gi.FunctionInfo(export), 'get_attr': gi.FunctionInfo(get_attr), 'get_attr_as_uint': gi.FunctionInfo(get_attr_as_uint), 'get_child': gi.FunctionInfo(get_child), 'get_children': gi.FunctionInfo(get_children), 'get_element': gi.FunctionInfo(get_element), 'get_first_child': gi.FunctionInfo(get_first_child), 'get_last_child': gi.FunctionInfo(get_last_child), 'get_parent': gi.FunctionInfo(get_parent), 'get_tail': gi.FunctionInfo(get_tail), 'get_text': gi.FunctionInfo(get_text), 'get_text_as_uint': gi.FunctionInfo(get_text_as_uint), 'get_tokens': gi.FunctionInfo(get_tokens), 'has_flag': gi.FunctionInfo(has_flag), 'remove_attr': gi.FunctionInfo(remove_attr), 'remove_child': gi.FunctionInfo(remove_child), 'set_attr': gi.FunctionInfo(set_attr), 'set_element': gi.FunctionInfo(set_element), 'set_tail': gi.FunctionInfo(set_tail), 'set_text': gi.FunctionInfo(set_text), 'sort_children': gi.FunctionInfo(sort_children), 'tokenize_text': gi.FunctionInfo(tokenize_text), 'traverse': gi.FunctionInfo(traverse), 'unlink': gi.FunctionInfo(unlink), 'parent_instance': <property object at 0x00000154347280e0>})"
    __gdoc__ = 'Object XbBuilderNode\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType XbBuilderNode (844629040)>'
