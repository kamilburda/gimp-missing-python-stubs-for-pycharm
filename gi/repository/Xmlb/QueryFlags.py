...
class QueryFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <QueryFlags.NONE: 0>, 'OPTIMIZE': <QueryFlags.OPTIMIZE: 1>, 'USE_INDEXES': <QueryFlags.USE_INDEXES: 2>, 'REVERSE': <QueryFlags.REVERSE: 4>, 'FORCE_NODE_CACHE': <QueryFlags.FORCE_NODE_CACHE: 8>})"
    __name__ = 'QueryFlags'
    __qualname__ = 'QueryFlags'
