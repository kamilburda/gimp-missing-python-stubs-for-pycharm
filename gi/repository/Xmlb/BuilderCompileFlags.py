...
class BuilderCompileFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <BuilderCompileFlags.NONE: 0>, 'NATIVE_LANGS': <BuilderCompileFlags.NATIVE_LANGS: 2>, 'IGNORE_INVALID': <BuilderCompileFlags.IGNORE_INVALID: 4>, 'SINGLE_LANG': <BuilderCompileFlags.SINGLE_LANG: 8>, 'WATCH_BLOB': <BuilderCompileFlags.WATCH_BLOB: 16>, 'IGNORE_GUID': <BuilderCompileFlags.IGNORE_GUID: 32>, 'SINGLE_ROOT': <BuilderCompileFlags.SINGLE_ROOT: 64>})"
    __name__ = 'BuilderCompileFlags'
    __qualname__ = 'BuilderCompileFlags'
