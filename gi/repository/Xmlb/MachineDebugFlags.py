...
class MachineDebugFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <MachineDebugFlags.NONE: 0>, 'SHOW_STACK': <MachineDebugFlags.SHOW_STACK: 1>, 'SHOW_PARSING': <MachineDebugFlags.SHOW_PARSING: 2>, 'SHOW_OPTIMIZER': <MachineDebugFlags.SHOW_OPTIMIZER: 4>, 'SHOW_SLOW_PATH': <MachineDebugFlags.SHOW_SLOW_PATH: 8>})"
    __name__ = 'MachineDebugFlags'
    __qualname__ = 'MachineDebugFlags'
