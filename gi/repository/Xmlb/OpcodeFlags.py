...
class OpcodeFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <OpcodeFlags.UNKNOWN: 0>, 'INTEGER': <OpcodeFlags.INTEGER: 1>, 'TEXT': <OpcodeFlags.TEXT: 2>, 'FUNCTION': <OpcodeFlags.FUNCTION: 4>, 'BOUND': <OpcodeFlags.BOUND: 8>, 'BOOLEAN': <OpcodeFlags.BOOLEAN: 16>, 'TOKENIZED': <OpcodeFlags.TOKENIZED: 32>})"
    __name__ = 'OpcodeFlags'
    __qualname__ = 'OpcodeFlags'
