...
class MachineParseFlags(__enum.IntFlag):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <MachineParseFlags.NONE: 0>, 'OPTIMIZE': <MachineParseFlags.OPTIMIZE: 1>})"
    __name__ = 'MachineParseFlags'
    __qualname__ = 'MachineParseFlags'
