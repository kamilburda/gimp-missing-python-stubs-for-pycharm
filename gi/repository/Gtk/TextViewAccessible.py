...
class TextViewAccessible(ContainerAccessible, __gi_repository_Atk.EditableText, __gi_repository_Atk.StreamableContent, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecedf82da0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextViewAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextViewAccessible (3922117088)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece9b657b0>, 'priv': <property object at 0x000002ece9b658a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextViewAccessible (3922117088)>'
