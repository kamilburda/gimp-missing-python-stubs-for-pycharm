...
class HandleBox(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9f640>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HandleBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHandleBox (3922094336)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_child_detached': gi.FunctionInfo(get_child_detached, bound=None), 'get_handle_position': gi.FunctionInfo(get_handle_position, bound=None), 'get_shadow_type': gi.FunctionInfo(get_shadow_type, bound=None), 'get_snap_edge': gi.FunctionInfo(get_snap_edge, bound=None), 'set_handle_position': gi.FunctionInfo(set_handle_position, bound=None), 'set_shadow_type': gi.FunctionInfo(set_shadow_type, bound=None), 'set_snap_edge': gi.FunctionInfo(set_snap_edge, bound=None), 'do_child_attached': gi.VFuncInfo(child_attached, bound=None), 'do_child_detached': gi.VFuncInfo(child_detached, bound=None), 'bin': <property object at 0x000002eceabe8d60>, 'priv': <property object at 0x000002eceabe8e50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHandleBox (3922094336)>'
