...
class MenuShellAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceababe20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuShellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuShellAccessible (3860386704)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac10680>, 'priv': <property object at 0x000002eceac10770>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuShellAccessible (3860386704)>'
