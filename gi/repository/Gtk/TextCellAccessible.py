...
class TextCellAccessible(RendererCellAccessible, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1d810>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextCellAccessible (3922118240)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece9b6eac0>, 'priv': <property object at 0x000002ece9b6ebb0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextCellAccessible (3922118240)>'
