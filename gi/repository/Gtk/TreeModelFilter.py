...
class TreeModelFilter(TreeModelFilter):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecedf82a70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'set_visible_func': <function TreeModelFilter.set_visible_func at 0x000002ece8a79620>, 'set_value': <function TreeModelFilter.set_value at 0x000002ece8a6e020>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeModelFilter (3867806928)>'
