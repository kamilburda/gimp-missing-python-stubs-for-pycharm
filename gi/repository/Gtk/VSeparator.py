...
class VSeparator(Separator):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba9660>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VSeparator), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVSeparator (3871465472)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'separator': <property object at 0x000002ece9b4e610>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVSeparator (3871465472)>'
