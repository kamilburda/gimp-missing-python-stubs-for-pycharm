...
class EventControllerKey(EventController):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab98580>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventControllerKey), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventControllerKey (3923970736)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'forward': gi.FunctionInfo(forward, bound=None), 'get_group': gi.FunctionInfo(get_group, bound=None), 'get_im_context': gi.FunctionInfo(get_im_context, bound=None), 'set_im_context': gi.FunctionInfo(set_im_context, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventControllerKey (3923970736)>'
