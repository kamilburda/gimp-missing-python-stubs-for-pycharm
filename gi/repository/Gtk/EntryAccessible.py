...
class EntryAccessible(WidgetAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.EditableText, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab99090>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EntryAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEntryAccessible (3855514592)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceab7ade0>, 'priv': <property object at 0x000002eceab7aed0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEntryAccessible (3855514592)>'
