...
class RadioToolButton(ToggleToolButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabbb9a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioToolButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioToolButton (3867893104)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_stock': gi.FunctionInfo(new_from_stock, bound=None), 'new_from_widget': gi.FunctionInfo(new_from_widget, bound=None), 'new_with_stock_from_widget': gi.FunctionInfo(new_with_stock_from_widget, bound=None), 'get_group': gi.FunctionInfo(get_group, bound=None), 'set_group': gi.FunctionInfo(set_group, bound=None), 'parent': <property object at 0x000002eceac49170>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioToolButton (3867893104)>'
