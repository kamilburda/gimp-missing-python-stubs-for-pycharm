...
class ListBoxAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba51e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ListBoxAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkListBoxAccessible (3922092752)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac09760>, 'priv': <property object at 0x000002eceac09850>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkListBoxAccessible (3922092752)>'
