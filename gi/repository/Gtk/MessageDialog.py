...
class MessageDialog(MessageDialog, __gi_overrides_Gtk.Dialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ac03a0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__init__': <function deprecated_init.<locals>.new_init at 0x000002ece8a92840>, 'format_secondary_text': <function MessageDialog.format_secondary_text at 0x000002ece8a928e0>, 'format_secondary_markup': <function MessageDialog.format_secondary_markup at 0x000002ece8a92980>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMessageDialog (3860982528)>'
