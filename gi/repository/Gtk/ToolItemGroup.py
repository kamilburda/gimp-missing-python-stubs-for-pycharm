...
class ToolItemGroup(__gi_overrides_Gtk.Container, ToolShell):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1d690>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToolItemGroup), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToolItemGroup (3871464704)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_collapsed': gi.FunctionInfo(get_collapsed, bound=None), 'get_drop_item': gi.FunctionInfo(get_drop_item, bound=None), 'get_ellipsize': gi.FunctionInfo(get_ellipsize, bound=None), 'get_header_relief': gi.FunctionInfo(get_header_relief, bound=None), 'get_item_position': gi.FunctionInfo(get_item_position, bound=None), 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_label_widget': gi.FunctionInfo(get_label_widget, bound=None), 'get_n_items': gi.FunctionInfo(get_n_items, bound=None), 'get_nth_item': gi.FunctionInfo(get_nth_item, bound=None), 'insert': gi.FunctionInfo(insert, bound=None), 'set_collapsed': gi.FunctionInfo(set_collapsed, bound=None), 'set_ellipsize': gi.FunctionInfo(set_ellipsize, bound=None), 'set_header_relief': gi.FunctionInfo(set_header_relief, bound=None), 'set_item_position': gi.FunctionInfo(set_item_position, bound=None), 'set_label': gi.FunctionInfo(set_label, bound=None), 'set_label_widget': gi.FunctionInfo(set_label_widget, bound=None), 'parent_instance': <property object at 0x000002ece9b5f3d0>, 'priv': <property object at 0x000002ece9b5f4c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToolItemGroup (3871464704)>'
