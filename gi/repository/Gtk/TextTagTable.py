...
class TextTagTable(__gi_overrides_GObject.Object, Buildable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecee308220>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TextTagTable), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTextTagTable (3923980144)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add': gi.FunctionInfo(add, bound=None), 'foreach': gi.FunctionInfo(foreach, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'lookup': gi.FunctionInfo(lookup, bound=None), 'remove': gi.FunctionInfo(remove, bound=None), 'do_tag_added': gi.VFuncInfo(tag_added, bound=None), 'do_tag_changed': gi.VFuncInfo(tag_changed, bound=None), 'do_tag_removed': gi.VFuncInfo(tag_removed, bound=None), 'parent_instance': <property object at 0x000002ece9b64950>, 'priv': <property object at 0x000002ece9b64a40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTextTagTable (3923980144)>'
