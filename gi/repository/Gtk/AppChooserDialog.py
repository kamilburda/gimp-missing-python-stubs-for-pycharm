...
class AppChooserDialog(__gi_overrides_Gtk.Dialog, AppChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab3d30>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AppChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAppChooserDialog (3855854816)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_for_content_type': gi.FunctionInfo(new_for_content_type, bound=None), 'get_heading': gi.FunctionInfo(get_heading, bound=None), 'get_widget': gi.FunctionInfo(get_widget, bound=None), 'set_heading': gi.FunctionInfo(set_heading, bound=None), 'parent': <property object at 0x000002ece8fb6e30>, 'priv': <property object at 0x000002ece8fb6f20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserDialog (3855854816)>'
