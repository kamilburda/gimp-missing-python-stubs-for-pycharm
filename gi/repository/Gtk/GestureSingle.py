...
class GestureSingle(Gesture):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9cd90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureSingle), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureSingle (3871459712)>, '__doc__': None, '__gsignals__': {}, 'get_button': gi.FunctionInfo(get_button, bound=None), 'get_current_button': gi.FunctionInfo(get_current_button, bound=None), 'get_current_sequence': gi.FunctionInfo(get_current_sequence, bound=None), 'get_exclusive': gi.FunctionInfo(get_exclusive, bound=None), 'get_touch_only': gi.FunctionInfo(get_touch_only, bound=None), 'set_button': gi.FunctionInfo(set_button, bound=None), 'set_exclusive': gi.FunctionInfo(set_exclusive, bound=None), 'set_touch_only': gi.FunctionInfo(set_touch_only, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureSingle (3871459712)>'
