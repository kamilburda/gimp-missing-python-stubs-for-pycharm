...
class AboutDialog(__gi_overrides_Gtk.Dialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece909fdc0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AboutDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAboutDialog (3855854656)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_credit_section': gi.FunctionInfo(add_credit_section, bound=None), 'get_artists': gi.FunctionInfo(get_artists, bound=None), 'get_authors': gi.FunctionInfo(get_authors, bound=None), 'get_comments': gi.FunctionInfo(get_comments, bound=None), 'get_copyright': gi.FunctionInfo(get_copyright, bound=None), 'get_documenters': gi.FunctionInfo(get_documenters, bound=None), 'get_license': gi.FunctionInfo(get_license, bound=None), 'get_license_type': gi.FunctionInfo(get_license_type, bound=None), 'get_logo': gi.FunctionInfo(get_logo, bound=None), 'get_logo_icon_name': gi.FunctionInfo(get_logo_icon_name, bound=None), 'get_program_name': gi.FunctionInfo(get_program_name, bound=None), 'get_translator_credits': gi.FunctionInfo(get_translator_credits, bound=None), 'get_version': gi.FunctionInfo(get_version, bound=None), 'get_website': gi.FunctionInfo(get_website, bound=None), 'get_website_label': gi.FunctionInfo(get_website_label, bound=None), 'get_wrap_license': gi.FunctionInfo(get_wrap_license, bound=None), 'set_artists': gi.FunctionInfo(set_artists, bound=None), 'set_authors': gi.FunctionInfo(set_authors, bound=None), 'set_comments': gi.FunctionInfo(set_comments, bound=None), 'set_copyright': gi.FunctionInfo(set_copyright, bound=None), 'set_documenters': gi.FunctionInfo(set_documenters, bound=None), 'set_license': gi.FunctionInfo(set_license, bound=None), 'set_license_type': gi.FunctionInfo(set_license_type, bound=None), 'set_logo': gi.FunctionInfo(set_logo, bound=None), 'set_logo_icon_name': gi.FunctionInfo(set_logo_icon_name, bound=None), 'set_program_name': gi.FunctionInfo(set_program_name, bound=None), 'set_translator_credits': gi.FunctionInfo(set_translator_credits, bound=None), 'set_version': gi.FunctionInfo(set_version, bound=None), 'set_website': gi.FunctionInfo(set_website, bound=None), 'set_website_label': gi.FunctionInfo(set_website_label, bound=None), 'set_wrap_license': gi.FunctionInfo(set_wrap_license, bound=None), 'do_activate_link': gi.VFuncInfo(activate_link, bound=None), 'parent_instance': <property object at 0x000002ece902fa60>, 'priv': <property object at 0x000002ece902fb50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAboutDialog (3855854656)>'
