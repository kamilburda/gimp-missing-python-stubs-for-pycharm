...
class TreeSortable(TreeSortable):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'get_sort_column_id': <function strip_boolean_result.<locals>.wrapped at 0x000002ece8a79300>, 'set_sort_func': <function TreeSortable.set_sort_func at 0x000002ece8a793a0>, 'set_default_sort_func': <function TreeSortable.set_default_sort_func at 0x000002ece8a79440>, '__doc__': None, '__gsignals__': {}})"
    __gdoc__ = 'Interface GtkTreeSortable\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeSortable (3867805696)>'
