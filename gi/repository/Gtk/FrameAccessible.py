...
class FrameAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abae00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FrameAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFrameAccessible (3922094768)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabdc680>, 'priv': <property object at 0x000002eceabdc770>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFrameAccessible (3922094768)>'
