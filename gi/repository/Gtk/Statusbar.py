...
class Statusbar(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9f490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Statusbar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStatusbar (3922106864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_context_id': gi.FunctionInfo(get_context_id, bound=None), 'get_message_area': gi.FunctionInfo(get_message_area, bound=None), 'pop': gi.FunctionInfo(pop, bound=None), 'push': gi.FunctionInfo(push, bound=None), 'remove': gi.FunctionInfo(remove, bound=None), 'remove_all': gi.FunctionInfo(remove_all, bound=None), 'do_text_popped': gi.VFuncInfo(text_popped, bound=None), 'do_text_pushed': gi.VFuncInfo(text_pushed, bound=None), 'parent_widget': <property object at 0x000002ece9b91850>, 'priv': <property object at 0x000002ece9b91940>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStatusbar (3922106864)>'
