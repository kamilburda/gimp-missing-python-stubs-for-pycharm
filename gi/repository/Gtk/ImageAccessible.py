...
class ImageAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba13c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageAccessible (3871454976)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabf36a0>, 'priv': <property object at 0x000002eceabf3790>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageAccessible (3871454976)>'
