...
class FlowBoxChildAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab4130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBoxChildAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBoxChildAccessible (3922098944)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabcbba0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBoxChildAccessible (3922098944)>'
