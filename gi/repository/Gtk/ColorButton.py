...
class ColorButton(__gi_overrides_Gtk.Button, ColorChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab7670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorButton (3922096064)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_color': gi.FunctionInfo(new_with_color, bound=None), 'new_with_rgba': gi.FunctionInfo(new_with_rgba, bound=None), 'get_alpha': gi.FunctionInfo(get_alpha, bound=None), 'get_color': gi.FunctionInfo(get_color, bound=None), 'get_title': gi.FunctionInfo(get_title, bound=None), 'get_use_alpha': gi.FunctionInfo(get_use_alpha, bound=None), 'set_alpha': gi.FunctionInfo(set_alpha, bound=None), 'set_color': gi.FunctionInfo(set_color, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None), 'set_use_alpha': gi.FunctionInfo(set_use_alpha, bound=None), 'do_color_set': gi.VFuncInfo(color_set, bound=None), 'button': <property object at 0x000002eceab8a020>, 'priv': <property object at 0x000002eceab8a110>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorButton (3922096064)>'
