...
class ToolItem(Bin, Activatable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba5810>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToolItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToolItem (3855874016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_ellipsize_mode': gi.FunctionInfo(get_ellipsize_mode, bound=None), 'get_expand': gi.FunctionInfo(get_expand, bound=None), 'get_homogeneous': gi.FunctionInfo(get_homogeneous, bound=None), 'get_icon_size': gi.FunctionInfo(get_icon_size, bound=None), 'get_is_important': gi.FunctionInfo(get_is_important, bound=None), 'get_orientation': gi.FunctionInfo(get_orientation, bound=None), 'get_proxy_menu_item': gi.FunctionInfo(get_proxy_menu_item, bound=None), 'get_relief_style': gi.FunctionInfo(get_relief_style, bound=None), 'get_text_alignment': gi.FunctionInfo(get_text_alignment, bound=None), 'get_text_orientation': gi.FunctionInfo(get_text_orientation, bound=None), 'get_text_size_group': gi.FunctionInfo(get_text_size_group, bound=None), 'get_toolbar_style': gi.FunctionInfo(get_toolbar_style, bound=None), 'get_use_drag_window': gi.FunctionInfo(get_use_drag_window, bound=None), 'get_visible_horizontal': gi.FunctionInfo(get_visible_horizontal, bound=None), 'get_visible_vertical': gi.FunctionInfo(get_visible_vertical, bound=None), 'rebuild_menu': gi.FunctionInfo(rebuild_menu, bound=None), 'retrieve_proxy_menu_item': gi.FunctionInfo(retrieve_proxy_menu_item, bound=None), 'set_expand': gi.FunctionInfo(set_expand, bound=None), 'set_homogeneous': gi.FunctionInfo(set_homogeneous, bound=None), 'set_is_important': gi.FunctionInfo(set_is_important, bound=None), 'set_proxy_menu_item': gi.FunctionInfo(set_proxy_menu_item, bound=None), 'set_tooltip_markup': gi.FunctionInfo(set_tooltip_markup, bound=None), 'set_tooltip_text': gi.FunctionInfo(set_tooltip_text, bound=None), 'set_use_drag_window': gi.FunctionInfo(set_use_drag_window, bound=None), 'set_visible_horizontal': gi.FunctionInfo(set_visible_horizontal, bound=None), 'set_visible_vertical': gi.FunctionInfo(set_visible_vertical, bound=None), 'toolbar_reconfigured': gi.FunctionInfo(toolbar_reconfigured, bound=None), 'do_create_menu_proxy': gi.VFuncInfo(create_menu_proxy, bound=None), 'do_toolbar_reconfigured': gi.VFuncInfo(toolbar_reconfigured, bound=None), 'parent': <property object at 0x000002ece8a9bf60>, 'priv': <property object at 0x000002ece8ac0090>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToolItem (3855874016)>'
