...
class CellView(__gi_overrides_Gtk.Widget, CellLayout, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab5bd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellView), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellView (3855518304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_context': gi.FunctionInfo(new_with_context, bound=None), 'new_with_markup': gi.FunctionInfo(new_with_markup, bound=None), 'new_with_pixbuf': gi.FunctionInfo(new_with_pixbuf, bound=None), 'new_with_text': gi.FunctionInfo(new_with_text, bound=None), 'get_displayed_row': gi.FunctionInfo(get_displayed_row, bound=None), 'get_draw_sensitive': gi.FunctionInfo(get_draw_sensitive, bound=None), 'get_fit_model': gi.FunctionInfo(get_fit_model, bound=None), 'get_model': gi.FunctionInfo(get_model, bound=None), 'get_size_of_row': gi.FunctionInfo(get_size_of_row, bound=None), 'set_background_color': gi.FunctionInfo(set_background_color, bound=None), 'set_background_rgba': gi.FunctionInfo(set_background_rgba, bound=None), 'set_displayed_row': gi.FunctionInfo(set_displayed_row, bound=None), 'set_draw_sensitive': gi.FunctionInfo(set_draw_sensitive, bound=None), 'set_fit_model': gi.FunctionInfo(set_fit_model, bound=None), 'set_model': gi.FunctionInfo(set_model, bound=None), 'parent_instance': <property object at 0x000002eceabb7bf0>, 'priv': <property object at 0x000002eceabb7ce0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellView (3855518304)>'
