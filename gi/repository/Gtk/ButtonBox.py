...
class ButtonBox(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece8a38ac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkButtonBox (3922098368)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_child_non_homogeneous': gi.FunctionInfo(get_child_non_homogeneous, bound=None), 'get_child_secondary': gi.FunctionInfo(get_child_secondary, bound=None), 'get_layout': gi.FunctionInfo(get_layout, bound=None), 'set_child_non_homogeneous': gi.FunctionInfo(set_child_non_homogeneous, bound=None), 'set_child_secondary': gi.FunctionInfo(set_child_secondary, bound=None), 'set_layout': gi.FunctionInfo(set_layout, bound=None), 'box': <property object at 0x000002ece8fcf380>, 'priv': <property object at 0x000002ece8fcf470>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkButtonBox (3922098368)>'
