...
class LockButtonAccessible(ButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba8f70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LockButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLockButtonAccessible (3922102544)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac0b830>, 'priv': <property object at 0x000002eceac0b920>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLockButtonAccessible (3922102544)>'
