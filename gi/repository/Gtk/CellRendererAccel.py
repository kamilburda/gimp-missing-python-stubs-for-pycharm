...
class CellRendererAccel(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9aaf880>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererAccel), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererAccel (3855519712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'do_accel_cleared': gi.VFuncInfo(accel_cleared, bound=None), 'do_accel_edited': gi.VFuncInfo(accel_edited, bound=None), 'parent': <property object at 0x000002ece9006a70>, 'priv': <property object at 0x000002ece9006b60>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererAccel (3855519712)>'
