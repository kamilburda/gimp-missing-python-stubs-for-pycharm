...
class NotebookAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abf460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NotebookAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNotebookAccessible (3860382672)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac1fa60>, 'priv': <property object at 0x000002eceac1fb50>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNotebookAccessible (3860382672)>'
