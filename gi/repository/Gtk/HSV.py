...
class HSV(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9e980>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HSV), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHSV (3871458816)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'to_rgb': gi.FunctionInfo(to_rgb, bound=None), 'get_color': gi.FunctionInfo(get_color, bound=None), 'get_metrics': gi.FunctionInfo(get_metrics, bound=None), 'is_adjusting': gi.FunctionInfo(is_adjusting, bound=None), 'set_color': gi.FunctionInfo(set_color, bound=None), 'set_metrics': gi.FunctionInfo(set_metrics, bound=None), 'do_changed': gi.VFuncInfo(changed, bound=None), 'do_move': gi.VFuncInfo(move, bound=None), 'parent_instance': <property object at 0x000002eceabdf790>, 'priv': <property object at 0x000002eceabdf880>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHSV (3871458816)>'
