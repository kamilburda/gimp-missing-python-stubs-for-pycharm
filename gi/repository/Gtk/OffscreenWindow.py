...
class OffscreenWindow(__gi_overrides_Gtk.Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abef80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(OffscreenWindow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkOffscreenWindow (3922101824)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_pixbuf': gi.FunctionInfo(get_pixbuf, bound=None), 'get_surface': gi.FunctionInfo(get_surface, bound=None), 'parent_object': <property object at 0x000002eceac260c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkOffscreenWindow (3922101824)>'
