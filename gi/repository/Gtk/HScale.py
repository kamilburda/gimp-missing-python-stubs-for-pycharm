...
class HScale(Scale):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9fc70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HScale), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHScale (3922096352)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_range': gi.FunctionInfo(new_with_range, bound=None), 'scale': <property object at 0x000002eceabe8400>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHScale (3922096352)>'
