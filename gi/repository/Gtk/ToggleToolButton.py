...
class ToggleToolButton(__gi_overrides_Gtk.ToolButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabbb730>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToggleToolButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToggleToolButton (3867896304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_stock': gi.FunctionInfo(new_from_stock, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'do_toggled': gi.VFuncInfo(toggled, bound=None), 'parent': <property object at 0x000002eceac48ef0>, 'priv': <property object at 0x000002eceac48fe0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToggleToolButton (3867896304)>'
