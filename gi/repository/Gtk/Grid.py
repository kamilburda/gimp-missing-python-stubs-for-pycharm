...
class Grid(__gi_overrides_Gtk.Container, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9fb20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Grid), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGrid (3871455232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'attach': gi.FunctionInfo(attach, bound=None), 'attach_next_to': gi.FunctionInfo(attach_next_to, bound=None), 'get_baseline_row': gi.FunctionInfo(get_baseline_row, bound=None), 'get_child_at': gi.FunctionInfo(get_child_at, bound=None), 'get_column_homogeneous': gi.FunctionInfo(get_column_homogeneous, bound=None), 'get_column_spacing': gi.FunctionInfo(get_column_spacing, bound=None), 'get_row_baseline_position': gi.FunctionInfo(get_row_baseline_position, bound=None), 'get_row_homogeneous': gi.FunctionInfo(get_row_homogeneous, bound=None), 'get_row_spacing': gi.FunctionInfo(get_row_spacing, bound=None), 'insert_column': gi.FunctionInfo(insert_column, bound=None), 'insert_next_to': gi.FunctionInfo(insert_next_to, bound=None), 'insert_row': gi.FunctionInfo(insert_row, bound=None), 'remove_column': gi.FunctionInfo(remove_column, bound=None), 'remove_row': gi.FunctionInfo(remove_row, bound=None), 'set_baseline_row': gi.FunctionInfo(set_baseline_row, bound=None), 'set_column_homogeneous': gi.FunctionInfo(set_column_homogeneous, bound=None), 'set_column_spacing': gi.FunctionInfo(set_column_spacing, bound=None), 'set_row_baseline_position': gi.FunctionInfo(set_row_baseline_position, bound=None), 'set_row_homogeneous': gi.FunctionInfo(set_row_homogeneous, bound=None), 'set_row_spacing': gi.FunctionInfo(set_row_spacing, bound=None), 'container': <property object at 0x000002eceabde340>, 'priv': <property object at 0x000002eceabde430>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGrid (3871455232)>'
