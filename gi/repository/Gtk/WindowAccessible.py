...
class WindowAccessible(ContainerAccessible, __gi_repository_Atk.Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabac970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WindowAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkWindowAccessible (3860384976)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac31b20>, 'priv': <property object at 0x000002eceac31c10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWindowAccessible (3860384976)>'
