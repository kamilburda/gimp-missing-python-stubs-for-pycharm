...
class PlacesOpenFlags(__gobject.GFlags):
    ...
    NORMAL = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gtk', '__dict__': <attribute '__dict__' of 'PlacesOpenFlags' objects>, '__doc__': None, '__gtype__': <GType GtkPlacesOpenFlags (3923954160)>, '__flags_values__': {1: <flags GTK_PLACES_OPEN_NORMAL of type Gtk.PlacesOpenFlags>, 2: <flags GTK_PLACES_OPEN_NEW_TAB of type Gtk.PlacesOpenFlags>, 4: <flags GTK_PLACES_OPEN_NEW_WINDOW of type Gtk.PlacesOpenFlags>}, '__info__': gi.EnumInfo(PlacesOpenFlags), 'NORMAL': <flags GTK_PLACES_OPEN_NORMAL of type Gtk.PlacesOpenFlags>, 'NEW_TAB': <flags GTK_PLACES_OPEN_NEW_TAB of type Gtk.PlacesOpenFlags>, 'NEW_WINDOW': <flags GTK_PLACES_OPEN_NEW_WINDOW of type Gtk.PlacesOpenFlags>})"
    __flags_values__ = {
        1: 1,
        2: 2,
        4: 4,
    }
    __gtype__ = None # (!) real value is '<GType GtkPlacesOpenFlags (3923954160)>'
