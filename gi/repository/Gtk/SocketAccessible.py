...
class SocketAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecedf81bd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SocketAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSocketAccessible (3922105856)>, '__doc__': None, '__gsignals__': {}, 'embed': gi.FunctionInfo(embed, bound=None), 'parent': <property object at 0x000002ece9b9d030>, 'priv': <property object at 0x000002ece9b9d120>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSocketAccessible (3922105856)>'
