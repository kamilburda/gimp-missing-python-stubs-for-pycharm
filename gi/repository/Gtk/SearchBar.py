...
class SearchBar(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd26410>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SearchBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSearchBar (3922109312)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'connect_entry': gi.FunctionInfo(connect_entry, bound=None), 'get_search_mode': gi.FunctionInfo(get_search_mode, bound=None), 'get_show_close_button': gi.FunctionInfo(get_show_close_button, bound=None), 'handle_event': gi.FunctionInfo(handle_event, bound=None), 'set_search_mode': gi.FunctionInfo(set_search_mode, bound=None), 'set_show_close_button': gi.FunctionInfo(set_show_close_button, bound=None), 'parent': <property object at 0x000002eceac68fe0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSearchBar (3922109312)>'
