...
class VPaned(__gi_overrides_Gtk.Paned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecee4b5ea0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VPaned), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVPaned (3922113344)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'paned': <property object at 0x000002ece9b4dee0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVPaned (3922113344)>'
