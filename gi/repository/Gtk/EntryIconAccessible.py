...
class EntryIconAccessible(__gi_repository_Atk.Object, __gi_repository_Atk.Action, __gi_repository_Atk.Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abf790>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EntryIconAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEntryIconAccessible (3923971632)>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEntryIconAccessible (3923971632)>'
