...
class RangeAccessible(WidgetAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabb1030>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RangeAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRangeAccessible (3871467008)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac49800>, 'priv': <property object at 0x000002eceac498f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRangeAccessible (3871467008)>'
