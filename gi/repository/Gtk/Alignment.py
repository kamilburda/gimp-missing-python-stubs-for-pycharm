...
class Alignment(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9aafa30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Alignment), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAlignment (3922124288)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_padding': gi.FunctionInfo(get_padding, bound=None), 'set': gi.FunctionInfo(set, bound=None), 'set_padding': gi.FunctionInfo(set_padding, bound=None), 'bin': <property object at 0x000002ece8fb6070>, 'priv': <property object at 0x000002ece8fb6160>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAlignment (3922124288)>'
