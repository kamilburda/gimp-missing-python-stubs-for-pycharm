...
class SortType(__gobject.GEnum):
    ...
    DESCENDING = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gtk', '__dict__': <attribute '__dict__' of 'SortType' objects>, '__doc__': None, '__gtype__': <GType GtkSortType (3923966368)>, '__enum_values__': {0: <enum GTK_SORT_ASCENDING of type Gtk.SortType>, 1: <enum GTK_SORT_DESCENDING of type Gtk.SortType>}, '__info__': gi.EnumInfo(SortType), 'ASCENDING': <enum GTK_SORT_ASCENDING of type Gtk.SortType>, 'DESCENDING': <enum GTK_SORT_DESCENDING of type Gtk.SortType>})"
    __enum_values__ = {
        0: 0,
        1: 1,
    }
    __gtype__ = None # (!) real value is '<GType GtkSortType (3923966368)>'
