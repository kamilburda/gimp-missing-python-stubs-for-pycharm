...
class CellRendererSpin(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab7a30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererSpin), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererSpin (3855518048)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent': <property object at 0x000002eceabb5d00>, 'priv': <property object at 0x000002eceabb5df0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererSpin (3855518048)>'
