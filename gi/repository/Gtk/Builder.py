...
class Builder(Builder):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab8c70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'connect_signals': <function Builder.connect_signals at 0x000002ece8a91e40>, 'add_from_string': <function Builder.add_from_string at 0x000002ece8a91ee0>, 'add_objects_from_string': <function Builder.add_objects_from_string at 0x000002ece8a91f80>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkBuilder (3867806480)>'
