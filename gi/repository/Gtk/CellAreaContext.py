...
class CellAreaContext(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab6d10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellAreaContext), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellAreaContext (3855028896)>, '__doc__': None, '__gsignals__': {}, 'allocate': gi.FunctionInfo(allocate, bound=None), 'get_allocation': gi.FunctionInfo(get_allocation, bound=None), 'get_area': gi.FunctionInfo(get_area, bound=None), 'get_preferred_height': gi.FunctionInfo(get_preferred_height, bound=None), 'get_preferred_height_for_width': gi.FunctionInfo(get_preferred_height_for_width, bound=None), 'get_preferred_width': gi.FunctionInfo(get_preferred_width, bound=None), 'get_preferred_width_for_height': gi.FunctionInfo(get_preferred_width_for_height, bound=None), 'push_preferred_height': gi.FunctionInfo(push_preferred_height, bound=None), 'push_preferred_width': gi.FunctionInfo(push_preferred_width, bound=None), 'reset': gi.FunctionInfo(reset, bound=None), 'do_allocate': gi.VFuncInfo(allocate, bound=None), 'do_get_preferred_height_for_width': gi.VFuncInfo(get_preferred_height_for_width, bound=None), 'do_get_preferred_width_for_height': gi.VFuncInfo(get_preferred_width_for_height, bound=None), 'do_reset': gi.VFuncInfo(reset, bound=None), 'parent_instance': <property object at 0x000002ece90049a0>, 'priv': <property object at 0x000002ece9004b30>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellAreaContext (3855028896)>'
