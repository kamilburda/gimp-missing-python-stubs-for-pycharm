...
class PopoverMenu(Popover):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabb0a30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PopoverMenu), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPopoverMenu (3922106144)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'open_submenu': gi.FunctionInfo(open_submenu, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPopoverMenu (3922106144)>'
