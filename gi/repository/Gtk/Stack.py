...
class Stack(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1eb30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Stack), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStack (3871468160)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_named': gi.FunctionInfo(add_named, bound=None), 'add_titled': gi.FunctionInfo(add_titled, bound=None), 'get_child_by_name': gi.FunctionInfo(get_child_by_name, bound=None), 'get_hhomogeneous': gi.FunctionInfo(get_hhomogeneous, bound=None), 'get_homogeneous': gi.FunctionInfo(get_homogeneous, bound=None), 'get_interpolate_size': gi.FunctionInfo(get_interpolate_size, bound=None), 'get_transition_duration': gi.FunctionInfo(get_transition_duration, bound=None), 'get_transition_running': gi.FunctionInfo(get_transition_running, bound=None), 'get_transition_type': gi.FunctionInfo(get_transition_type, bound=None), 'get_vhomogeneous': gi.FunctionInfo(get_vhomogeneous, bound=None), 'get_visible_child': gi.FunctionInfo(get_visible_child, bound=None), 'get_visible_child_name': gi.FunctionInfo(get_visible_child_name, bound=None), 'set_hhomogeneous': gi.FunctionInfo(set_hhomogeneous, bound=None), 'set_homogeneous': gi.FunctionInfo(set_homogeneous, bound=None), 'set_interpolate_size': gi.FunctionInfo(set_interpolate_size, bound=None), 'set_transition_duration': gi.FunctionInfo(set_transition_duration, bound=None), 'set_transition_type': gi.FunctionInfo(set_transition_type, bound=None), 'set_vhomogeneous': gi.FunctionInfo(set_vhomogeneous, bound=None), 'set_visible_child': gi.FunctionInfo(set_visible_child, bound=None), 'set_visible_child_full': gi.FunctionInfo(set_visible_child_full, bound=None), 'set_visible_child_name': gi.FunctionInfo(set_visible_child_name, bound=None), 'parent_instance': <property object at 0x000002ece9b9f420>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStack (3871468160)>'
