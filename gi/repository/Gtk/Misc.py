...
class Misc(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9aaf9a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Misc), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMisc (3860578480)>, '__doc__': None, '__gsignals__': {}, 'get_alignment': gi.FunctionInfo(get_alignment, bound=None), 'get_padding': gi.FunctionInfo(get_padding, bound=None), 'set_alignment': gi.FunctionInfo(set_alignment, bound=None), 'set_padding': gi.FunctionInfo(set_padding, bound=None), 'widget': <property object at 0x000002ece8ac3ba0>, 'priv': <property object at 0x000002ece8ac3c90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMisc (3860578480)>'
