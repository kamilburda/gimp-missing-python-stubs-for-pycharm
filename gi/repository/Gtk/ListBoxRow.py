...
class ListBoxRow(Bin, Actionable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabaa950>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ListBoxRow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkListBoxRow (3922095488)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'changed': gi.FunctionInfo(changed, bound=None), 'get_activatable': gi.FunctionInfo(get_activatable, bound=None), 'get_header': gi.FunctionInfo(get_header, bound=None), 'get_index': gi.FunctionInfo(get_index, bound=None), 'get_selectable': gi.FunctionInfo(get_selectable, bound=None), 'is_selected': gi.FunctionInfo(is_selected, bound=None), 'set_activatable': gi.FunctionInfo(set_activatable, bound=None), 'set_header': gi.FunctionInfo(set_header, bound=None), 'set_selectable': gi.FunctionInfo(set_selectable, bound=None), 'do_activate': gi.VFuncInfo(activate, bound=None), 'parent_instance': <property object at 0x000002eceac0a7a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkListBoxRow (3922095488)>'
