...
class ToolPalette(__gi_overrides_Gtk.Container, Orientable, Scrollable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1f130>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToolPalette), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToolPalette (3871465088)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_drag_target_group': gi.FunctionInfo(get_drag_target_group, bound=None), 'get_drag_target_item': gi.FunctionInfo(get_drag_target_item, bound=None), 'add_drag_dest': gi.FunctionInfo(add_drag_dest, bound=None), 'get_drag_item': gi.FunctionInfo(get_drag_item, bound=None), 'get_drop_group': gi.FunctionInfo(get_drop_group, bound=None), 'get_drop_item': gi.FunctionInfo(get_drop_item, bound=None), 'get_exclusive': gi.FunctionInfo(get_exclusive, bound=None), 'get_expand': gi.FunctionInfo(get_expand, bound=None), 'get_group_position': gi.FunctionInfo(get_group_position, bound=None), 'get_hadjustment': gi.FunctionInfo(get_hadjustment, bound=None), 'get_icon_size': gi.FunctionInfo(get_icon_size, bound=None), 'get_style': gi.FunctionInfo(get_style, bound=None), 'get_vadjustment': gi.FunctionInfo(get_vadjustment, bound=None), 'set_drag_source': gi.FunctionInfo(set_drag_source, bound=None), 'set_exclusive': gi.FunctionInfo(set_exclusive, bound=None), 'set_expand': gi.FunctionInfo(set_expand, bound=None), 'set_group_position': gi.FunctionInfo(set_group_position, bound=None), 'set_icon_size': gi.FunctionInfo(set_icon_size, bound=None), 'set_style': gi.FunctionInfo(set_style, bound=None), 'unset_icon_size': gi.FunctionInfo(unset_icon_size, bound=None), 'unset_style': gi.FunctionInfo(unset_style, bound=None), 'parent_instance': <property object at 0x000002ece9b5fc90>, 'priv': <property object at 0x000002ece9b5fd80>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToolPalette (3871465088)>'
