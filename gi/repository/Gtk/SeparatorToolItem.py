...
class SeparatorToolItem(ToolItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1ca30>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SeparatorToolItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSeparatorToolItem (3922110176)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_draw': gi.FunctionInfo(get_draw, bound=None), 'set_draw': gi.FunctionInfo(set_draw, bound=None), 'parent': <property object at 0x000002eceac6abb0>, 'priv': <property object at 0x000002eceac6aca0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSeparatorToolItem (3922110176)>'
