...
class ContainerAccessible(WidgetAccessible):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ContainerAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkContainerAccessible (3867628448)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece8fcecf0>, 'priv': <property object at 0x000002ece8fcede0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkContainerAccessible (3867628448)>'
