...
class DrawingArea(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab52d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(DrawingArea), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkDrawingArea (3855518560)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'widget': <property object at 0x000002eceab796c0>, 'dummy': <property object at 0x000002eceab797b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkDrawingArea (3855518560)>'
