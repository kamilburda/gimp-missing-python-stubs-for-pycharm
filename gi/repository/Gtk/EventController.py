...
class EventController(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9a950>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventController), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventController (3923973760)>, '__doc__': None, '__gsignals__': {}, 'get_propagation_phase': gi.FunctionInfo(get_propagation_phase, bound=None), 'get_widget': gi.FunctionInfo(get_widget, bound=None), 'handle_event': gi.FunctionInfo(handle_event, bound=None), 'reset': gi.FunctionInfo(reset, bound=None), 'set_propagation_phase': gi.FunctionInfo(set_propagation_phase, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventController (3923973760)>'
