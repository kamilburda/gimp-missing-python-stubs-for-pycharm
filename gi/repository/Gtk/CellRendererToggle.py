...
class CellRendererToggle(CellRenderer):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abba00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererToggle), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererToggle (3855515488)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_activatable': gi.FunctionInfo(get_activatable, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'get_radio': gi.FunctionInfo(get_radio, bound=None), 'set_activatable': gi.FunctionInfo(set_activatable, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'set_radio': gi.FunctionInfo(set_radio, bound=None), 'do_toggled': gi.VFuncInfo(toggled, bound=None), 'parent': <property object at 0x000002eceabb72e0>, 'priv': <property object at 0x000002eceabb73d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererToggle (3855515488)>'
