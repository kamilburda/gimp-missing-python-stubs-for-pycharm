...
class RecentChooserWidget(__gi_overrides_Gtk.Box, RecentChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece90545b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentChooserWidget (3922103696)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_for_manager': gi.FunctionInfo(new_for_manager, bound=None), 'parent_instance': <property object at 0x000002eceac52c50>, 'priv': <property object at 0x000002eceac52d40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentChooserWidget (3922103696)>'
