...
class FontButton(__gi_overrides_Gtk.Button, FontChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abf310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontButton (3922097504)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_font': gi.FunctionInfo(new_with_font, bound=None), 'get_font_name': gi.FunctionInfo(get_font_name, bound=None), 'get_show_size': gi.FunctionInfo(get_show_size, bound=None), 'get_show_style': gi.FunctionInfo(get_show_style, bound=None), 'get_title': gi.FunctionInfo(get_title, bound=None), 'get_use_font': gi.FunctionInfo(get_use_font, bound=None), 'get_use_size': gi.FunctionInfo(get_use_size, bound=None), 'set_font_name': gi.FunctionInfo(set_font_name, bound=None), 'set_show_size': gi.FunctionInfo(set_show_size, bound=None), 'set_show_style': gi.FunctionInfo(set_show_style, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None), 'set_use_font': gi.FunctionInfo(set_use_font, bound=None), 'set_use_size': gi.FunctionInfo(set_use_size, bound=None), 'do_font_set': gi.VFuncInfo(font_set, bound=None), 'button': <property object at 0x000002eceabd5170>, 'priv': <property object at 0x000002eceabd5260>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontButton (3922097504)>'
