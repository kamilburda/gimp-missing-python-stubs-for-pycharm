...
class ContainerCellAccessible(CellAccessible):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ContainerCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkContainerCellAccessible (3855515744)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_child': gi.FunctionInfo(add_child, bound=None), 'get_children': gi.FunctionInfo(get_children, bound=None), 'remove_child': gi.FunctionInfo(remove_child, bound=None), 'parent': <property object at 0x000002eceab82a20>, 'priv': <property object at 0x000002eceab82b10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkContainerCellAccessible (3855515744)>'
