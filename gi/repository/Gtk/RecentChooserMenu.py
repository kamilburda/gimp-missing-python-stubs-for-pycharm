...
class RecentChooserMenu(__gi_overrides_Gtk.Menu, Activatable, RecentChooser):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentChooserMenu), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentChooserMenu (3922104128)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_for_manager': gi.FunctionInfo(new_for_manager, bound=None), 'get_show_numbers': gi.FunctionInfo(get_show_numbers, bound=None), 'set_show_numbers': gi.FunctionInfo(set_show_numbers, bound=None), 'parent_instance': <property object at 0x000002eceac52430>, 'priv': <property object at 0x000002eceac52520>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentChooserMenu (3922104128)>'
