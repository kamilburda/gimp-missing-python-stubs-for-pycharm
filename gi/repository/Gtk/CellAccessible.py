...
class CellAccessible(Accessible, __gi_repository_Atk.Action, __gi_repository_Atk.Component, __gi_repository_Atk.TableCell):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab8610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellAccessible (3855513440)>, '__doc__': None, '__gsignals__': {}, 'do_update_cache': gi.VFuncInfo(update_cache, bound=None), 'parent': <property object at 0x000002ece8fcc630>, 'priv': <property object at 0x000002ece8fcc720>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellAccessible (3855513440)>'
