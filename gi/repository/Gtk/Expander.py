...
class Expander(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ac1420>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Expander), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkExpander (3922094048)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic, bound=None), 'get_expanded': gi.FunctionInfo(get_expanded, bound=None), 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_label_fill': gi.FunctionInfo(get_label_fill, bound=None), 'get_label_widget': gi.FunctionInfo(get_label_widget, bound=None), 'get_resize_toplevel': gi.FunctionInfo(get_resize_toplevel, bound=None), 'get_spacing': gi.FunctionInfo(get_spacing, bound=None), 'get_use_markup': gi.FunctionInfo(get_use_markup, bound=None), 'get_use_underline': gi.FunctionInfo(get_use_underline, bound=None), 'set_expanded': gi.FunctionInfo(set_expanded, bound=None), 'set_label': gi.FunctionInfo(set_label, bound=None), 'set_label_fill': gi.FunctionInfo(set_label_fill, bound=None), 'set_label_widget': gi.FunctionInfo(set_label_widget, bound=None), 'set_resize_toplevel': gi.FunctionInfo(set_resize_toplevel, bound=None), 'set_spacing': gi.FunctionInfo(set_spacing, bound=None), 'set_use_markup': gi.FunctionInfo(set_use_markup, bound=None), 'set_use_underline': gi.FunctionInfo(set_use_underline, bound=None), 'do_activate': gi.VFuncInfo(activate, bound=None), 'bin': <property object at 0x000002eceabbf240>, 'priv': <property object at 0x000002eceabbf330>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkExpander (3922094048)>'
