...
class ColorChooserWidget(__gi_overrides_Gtk.Box, ColorChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abdf60>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorChooserWidget (3922101104)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x000002eceab8b790>, 'priv': <property object at 0x000002eceab8b880>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorChooserWidget (3922101104)>'
