...
class ToggleButton(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab3cd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToggleButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToggleButton (3922092896)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_label': gi.FunctionInfo(new_with_label, bound=None), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'get_inconsistent': gi.FunctionInfo(get_inconsistent, bound=None), 'get_mode': gi.FunctionInfo(get_mode, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'set_inconsistent': gi.FunctionInfo(set_inconsistent, bound=None), 'set_mode': gi.FunctionInfo(set_mode, bound=None), 'toggled': gi.FunctionInfo(toggled, bound=None), 'do_toggled': gi.VFuncInfo(toggled, bound=None), 'button': <property object at 0x000002eceab88450>, 'priv': <property object at 0x000002eceab88540>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToggleButton (3922092896)>'
