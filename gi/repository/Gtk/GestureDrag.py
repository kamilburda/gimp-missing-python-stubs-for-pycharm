...
class GestureDrag(GestureSingle):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9d570>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureDrag), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureDrag (3871456384)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_offset': gi.FunctionInfo(get_offset, bound=None), 'get_start_point': gi.FunctionInfo(get_start_point, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureDrag (3871456384)>'
