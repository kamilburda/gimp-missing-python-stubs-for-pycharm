...
class ActionBar(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab20b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ActionBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkActionBar (3922124144)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_center_widget': gi.FunctionInfo(get_center_widget, bound=None), 'pack_end': gi.FunctionInfo(pack_end, bound=None), 'pack_start': gi.FunctionInfo(pack_start, bound=None), 'set_center_widget': gi.FunctionInfo(set_center_widget, bound=None), 'bin': <property object at 0x000002ece8faf100>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkActionBar (3922124144)>'
