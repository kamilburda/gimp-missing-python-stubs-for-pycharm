...
class TearoffMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9028520>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TearoffMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTearoffMenuItem (3922112192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'menu_item': <property object at 0x000002ece9b77150>, 'priv': <property object at 0x000002ece9b77240>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTearoffMenuItem (3922112192)>'
