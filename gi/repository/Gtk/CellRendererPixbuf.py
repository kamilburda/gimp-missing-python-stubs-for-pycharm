...
class CellRendererPixbuf(CellRenderer):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab5360>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererPixbuf), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererPixbuf (3855512032)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent': <property object at 0x000002eceabb4db0>, 'priv': <property object at 0x000002eceabb4ea0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererPixbuf (3855512032)>'
