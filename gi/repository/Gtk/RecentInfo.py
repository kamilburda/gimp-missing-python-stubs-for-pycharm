...
class RecentInfo(RecentInfo):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'get_application_info': <function strip_boolean_result.<locals>.wrapped at 0x000002ece8a93920>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GtkRecentInfo (3867805472)>'
