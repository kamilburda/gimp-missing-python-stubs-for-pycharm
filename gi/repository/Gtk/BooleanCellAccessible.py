...
class BooleanCellAccessible(RendererCellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab3fd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(BooleanCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkBooleanCellAccessible (3922098080)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece8fcca90>, 'priv': <property object at 0x000002ece8fccb80>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkBooleanCellAccessible (3922098080)>'
