...
class AspectFrame(Frame):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab6bc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AspectFrame), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAspectFrame (3922099232)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set': gi.FunctionInfo(set, bound=None), 'frame': <property object at 0x000002ece8fc15d0>, 'priv': <property object at 0x000002ece8fc16c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAspectFrame (3922099232)>'
