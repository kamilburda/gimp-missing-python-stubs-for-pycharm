...
class TreeViewColumn(TreeViewColumn):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecee4b4a00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__init__': <function TreeViewColumn.__init__ at 0x000002ece8a7bec0>, 'cell_get_position': <function strip_boolean_result.<locals>.wrapped at 0x000002ece8a7bf60>, 'set_cell_data_func': <function TreeViewColumn.set_cell_data_func at 0x000002ece8a6c040>, 'set_attributes': <function TreeViewColumn.set_attributes at 0x000002ece8a6c0e0>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeViewColumn (3867807376)>'
