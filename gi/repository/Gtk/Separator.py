...
class Separator(__gi_overrides_Gtk.Widget, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece8a41a20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Separator), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSeparator (3871460864)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'widget': <property object at 0x000002eceabe8860>, 'priv': <property object at 0x000002eceabe8950>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSeparator (3871460864)>'
