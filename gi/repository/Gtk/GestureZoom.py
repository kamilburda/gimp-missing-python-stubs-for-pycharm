...
class GestureZoom(Gesture):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9ef50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureZoom), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureZoom (3871460096)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_scale_delta': gi.FunctionInfo(get_scale_delta, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureZoom (3871460096)>'
