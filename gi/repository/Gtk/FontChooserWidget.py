...
class FontChooserWidget(__gi_overrides_Gtk.Box, FontChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab98550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontChooserWidget (3922099520)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x000002eceabd6c50>, 'priv': <property object at 0x000002eceabd6d40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontChooserWidget (3922099520)>'
