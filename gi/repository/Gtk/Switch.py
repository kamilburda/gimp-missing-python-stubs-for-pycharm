...
class Switch(__gi_overrides_Gtk.Widget, Actionable, Activatable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1f0a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Switch), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSwitch (3871463040)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'get_state': gi.FunctionInfo(get_state, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'set_state': gi.FunctionInfo(set_state, bound=None), 'do_activate': gi.VFuncInfo(activate, bound=None), 'do_state_set': gi.VFuncInfo(state_set, bound=None), 'parent_instance': <property object at 0x000002ece9b7fe20>, 'priv': <property object at 0x000002ece9b7ff10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSwitch (3871463040)>'
