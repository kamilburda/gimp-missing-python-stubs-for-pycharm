...
class ScaleButtonAccessible(ButtonAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd246d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScaleButtonAccessible (3922105280)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac5a4d0>, 'priv': <property object at 0x000002eceac5a5c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleButtonAccessible (3922105280)>'
