...
class StackSidebar(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1de70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StackSidebar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStackSidebar (3922108304)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_stack': gi.FunctionInfo(get_stack, bound=None), 'set_stack': gi.FunctionInfo(set_stack, bound=None), 'parent': <property object at 0x000002ece9b9f9c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStackSidebar (3922108304)>'
