...
class CellRenderer(__gi_repository_GObject.InitiallyUnowned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9aafeb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRenderer), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRenderer (3855029120)>, '__doc__': None, '__gsignals__': {}, 'set_accessible_type': <classmethod(gi.FunctionInfo(set_accessible_type, bound=None))>, 'activate': gi.FunctionInfo(activate, bound=None), 'get_aligned_area': gi.FunctionInfo(get_aligned_area, bound=None), 'get_alignment': gi.FunctionInfo(get_alignment, bound=None), 'get_fixed_size': gi.FunctionInfo(get_fixed_size, bound=None), 'get_padding': gi.FunctionInfo(get_padding, bound=None), 'get_preferred_height': gi.FunctionInfo(get_preferred_height, bound=None), 'get_preferred_height_for_width': gi.FunctionInfo(get_preferred_height_for_width, bound=None), 'get_preferred_size': gi.FunctionInfo(get_preferred_size, bound=None), 'get_preferred_width': gi.FunctionInfo(get_preferred_width, bound=None), 'get_preferred_width_for_height': gi.FunctionInfo(get_preferred_width_for_height, bound=None), 'get_request_mode': gi.FunctionInfo(get_request_mode, bound=None), 'get_sensitive': gi.FunctionInfo(get_sensitive, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'get_state': gi.FunctionInfo(get_state, bound=None), 'get_visible': gi.FunctionInfo(get_visible, bound=None), 'is_activatable': gi.FunctionInfo(is_activatable, bound=None), 'render': gi.FunctionInfo(render, bound=None), 'set_alignment': gi.FunctionInfo(set_alignment, bound=None), 'set_fixed_size': gi.FunctionInfo(set_fixed_size, bound=None), 'set_padding': gi.FunctionInfo(set_padding, bound=None), 'set_sensitive': gi.FunctionInfo(set_sensitive, bound=None), 'set_visible': gi.FunctionInfo(set_visible, bound=None), 'start_editing': gi.FunctionInfo(start_editing, bound=None), 'stop_editing': gi.FunctionInfo(stop_editing, bound=None), 'do_activate': gi.VFuncInfo(activate, bound=None), 'do_editing_canceled': gi.VFuncInfo(editing_canceled, bound=None), 'do_editing_started': gi.VFuncInfo(editing_started, bound=None), 'do_get_aligned_area': gi.VFuncInfo(get_aligned_area, bound=None), 'do_get_preferred_height': gi.VFuncInfo(get_preferred_height, bound=None), 'do_get_preferred_height_for_width': gi.VFuncInfo(get_preferred_height_for_width, bound=None), 'do_get_preferred_width': gi.VFuncInfo(get_preferred_width, bound=None), 'do_get_preferred_width_for_height': gi.VFuncInfo(get_preferred_width_for_height, bound=None), 'do_get_request_mode': gi.VFuncInfo(get_request_mode, bound=None), 'do_get_size': gi.VFuncInfo(get_size, bound=None), 'do_render': gi.VFuncInfo(render, bound=None), 'do_start_editing': gi.VFuncInfo(start_editing, bound=None), 'parent_instance': <property object at 0x000002ece90065c0>, 'priv': <property object at 0x000002ece90066b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRenderer (3855029120)>'
