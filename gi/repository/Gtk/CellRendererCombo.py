...
class CellRendererCombo(CellRendererText):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab24d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererCombo), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererCombo (3855513056)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent': <property object at 0x000002eceabb45e0>, 'priv': <property object at 0x000002eceabb46d0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererCombo (3855513056)>'
