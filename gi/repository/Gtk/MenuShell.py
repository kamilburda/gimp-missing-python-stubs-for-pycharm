...
class MenuShell(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabaa260>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuShell), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuShell (3860583728)>, '__doc__': None, '__gsignals__': {}, 'activate_item': gi.FunctionInfo(activate_item, bound=None), 'append': gi.FunctionInfo(append, bound=None), 'bind_model': gi.FunctionInfo(bind_model, bound=None), 'cancel': gi.FunctionInfo(cancel, bound=None), 'deactivate': gi.FunctionInfo(deactivate, bound=None), 'deselect': gi.FunctionInfo(deselect, bound=None), 'get_parent_shell': gi.FunctionInfo(get_parent_shell, bound=None), 'get_selected_item': gi.FunctionInfo(get_selected_item, bound=None), 'get_take_focus': gi.FunctionInfo(get_take_focus, bound=None), 'insert': gi.FunctionInfo(insert, bound=None), 'prepend': gi.FunctionInfo(prepend, bound=None), 'select_first': gi.FunctionInfo(select_first, bound=None), 'select_item': gi.FunctionInfo(select_item, bound=None), 'set_take_focus': gi.FunctionInfo(set_take_focus, bound=None), 'do_activate_current': gi.VFuncInfo(activate_current, bound=None), 'do_cancel': gi.VFuncInfo(cancel, bound=None), 'do_deactivate': gi.VFuncInfo(deactivate, bound=None), 'do_get_popup_delay': gi.VFuncInfo(get_popup_delay, bound=None), 'do_insert': gi.VFuncInfo(insert, bound=None), 'do_move_current': gi.VFuncInfo(move_current, bound=None), 'do_move_selected': gi.VFuncInfo(move_selected, bound=None), 'do_select_item': gi.VFuncInfo(select_item, bound=None), 'do_selection_done': gi.VFuncInfo(selection_done, bound=None), 'container': <property object at 0x000002ece8a660c0>, 'priv': <property object at 0x000002ece8a661b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuShell (3860583728)>'
