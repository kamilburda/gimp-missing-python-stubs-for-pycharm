...
class RegionFlags(__gobject.GFlags):
    ...
    SORTED = 32
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gtk', '__dict__': <attribute '__dict__' of 'RegionFlags' objects>, '__doc__': None, '__gtype__': <GType GtkRegionFlags (3923960656)>, '__flags_values__': {1: <flags GTK_REGION_EVEN of type Gtk.RegionFlags>, 2: <flags GTK_REGION_ODD of type Gtk.RegionFlags>, 4: <flags GTK_REGION_FIRST of type Gtk.RegionFlags>, 8: <flags GTK_REGION_LAST of type Gtk.RegionFlags>, 16: <flags GTK_REGION_ONLY of type Gtk.RegionFlags>, 32: <flags GTK_REGION_SORTED of type Gtk.RegionFlags>}, '__info__': gi.EnumInfo(RegionFlags), 'EVEN': <flags GTK_REGION_EVEN of type Gtk.RegionFlags>, 'ODD': <flags GTK_REGION_ODD of type Gtk.RegionFlags>, 'FIRST': <flags GTK_REGION_FIRST of type Gtk.RegionFlags>, 'LAST': <flags GTK_REGION_LAST of type Gtk.RegionFlags>, 'ONLY': <flags GTK_REGION_ONLY of type Gtk.RegionFlags>, 'SORTED': <flags GTK_REGION_SORTED of type Gtk.RegionFlags>})"
    __flags_values__ = {
        1: 1,
        2: 2,
        4: 4,
    ...
    __gtype__ = None # (!) real value is '<GType GtkRegionFlags (3923960656)>'
