...
class ButtonAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab4f10>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkButtonAccessible (3922093616)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece8fcef20>, 'priv': <property object at 0x000002ece8fcf010>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkButtonAccessible (3922093616)>'
