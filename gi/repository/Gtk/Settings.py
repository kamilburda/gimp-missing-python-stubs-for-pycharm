...
class Settings(__gi_overrides_GObject.Object, StyleProvider):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd27cd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Settings), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSettings (3923966816)>, '__doc__': None, '__gsignals__': {}, 'get_default': gi.FunctionInfo(get_default, bound=None), 'get_for_screen': gi.FunctionInfo(get_for_screen, bound=None), 'install_property': gi.FunctionInfo(install_property, bound=None), 'install_property_parser': gi.FunctionInfo(install_property_parser, bound=None), 'reset_property': gi.FunctionInfo(reset_property, bound=None), 'set_double_property': gi.FunctionInfo(set_double_property, bound=None), 'set_long_property': gi.FunctionInfo(set_long_property, bound=None), 'set_property_value': gi.FunctionInfo(set_property_value, bound=None), 'set_string_property': gi.FunctionInfo(set_string_property, bound=None), 'parent_instance': <property object at 0x000002eceac6b3d0>, 'priv': <property object at 0x000002eceac6b4c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSettings (3923966816)>'
