...
class ToggleButtonAccessible(ButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabaa530>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToggleButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToggleButtonAccessible (3922105568)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac11800>, 'priv': <property object at 0x000002eceac118f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToggleButtonAccessible (3922105568)>'
