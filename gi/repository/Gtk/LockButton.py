...
class LockButton(__gi_overrides_Gtk.Button):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabab970>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LockButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLockButton (3922100672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_permission': gi.FunctionInfo(get_permission, bound=None), 'set_permission': gi.FunctionInfo(set_permission, bound=None), 'parent': <property object at 0x000002eceac0b600>, 'priv': <property object at 0x000002eceac0b6f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLockButton (3922100672)>'
