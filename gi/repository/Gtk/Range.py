...
class Range(__gi_overrides_Gtk.Widget, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba33a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Range), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRange (3860580400)>, '__doc__': None, '__gsignals__': {}, 'get_adjustment': gi.FunctionInfo(get_adjustment, bound=None), 'get_fill_level': gi.FunctionInfo(get_fill_level, bound=None), 'get_flippable': gi.FunctionInfo(get_flippable, bound=None), 'get_inverted': gi.FunctionInfo(get_inverted, bound=None), 'get_lower_stepper_sensitivity': gi.FunctionInfo(get_lower_stepper_sensitivity, bound=None), 'get_min_slider_size': gi.FunctionInfo(get_min_slider_size, bound=None), 'get_range_rect': gi.FunctionInfo(get_range_rect, bound=None), 'get_restrict_to_fill_level': gi.FunctionInfo(get_restrict_to_fill_level, bound=None), 'get_round_digits': gi.FunctionInfo(get_round_digits, bound=None), 'get_show_fill_level': gi.FunctionInfo(get_show_fill_level, bound=None), 'get_slider_range': gi.FunctionInfo(get_slider_range, bound=None), 'get_slider_size_fixed': gi.FunctionInfo(get_slider_size_fixed, bound=None), 'get_upper_stepper_sensitivity': gi.FunctionInfo(get_upper_stepper_sensitivity, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'set_adjustment': gi.FunctionInfo(set_adjustment, bound=None), 'set_fill_level': gi.FunctionInfo(set_fill_level, bound=None), 'set_flippable': gi.FunctionInfo(set_flippable, bound=None), 'set_increments': gi.FunctionInfo(set_increments, bound=None), 'set_inverted': gi.FunctionInfo(set_inverted, bound=None), 'set_lower_stepper_sensitivity': gi.FunctionInfo(set_lower_stepper_sensitivity, bound=None), 'set_min_slider_size': gi.FunctionInfo(set_min_slider_size, bound=None), 'set_range': gi.FunctionInfo(set_range, bound=None), 'set_restrict_to_fill_level': gi.FunctionInfo(set_restrict_to_fill_level, bound=None), 'set_round_digits': gi.FunctionInfo(set_round_digits, bound=None), 'set_show_fill_level': gi.FunctionInfo(set_show_fill_level, bound=None), 'set_slider_size_fixed': gi.FunctionInfo(set_slider_size_fixed, bound=None), 'set_upper_stepper_sensitivity': gi.FunctionInfo(set_upper_stepper_sensitivity, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None), 'do_adjust_bounds': gi.VFuncInfo(adjust_bounds, bound=None), 'do_change_value': gi.VFuncInfo(change_value, bound=None), 'do_get_range_border': gi.VFuncInfo(get_range_border, bound=None), 'do_get_range_size_request': gi.VFuncInfo(get_range_size_request, bound=None), 'do_move_slider': gi.VFuncInfo(move_slider, bound=None), 'do_value_changed': gi.VFuncInfo(value_changed, bound=None), 'widget': <property object at 0x000002ece8a64cc0>, 'priv': <property object at 0x000002ece8a64db0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRange (3860580400)>'
