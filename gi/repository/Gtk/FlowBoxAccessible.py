...
class FlowBoxAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab0850>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBoxAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBoxAccessible (3922095920)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabcb600>, 'priv': <property object at 0x000002eceabcb6f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBoxAccessible (3922095920)>'
