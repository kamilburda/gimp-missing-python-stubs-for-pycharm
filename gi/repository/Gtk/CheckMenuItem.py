...
class CheckMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab8bb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckMenuItem (3922095776)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_label': gi.FunctionInfo(new_with_label, bound=None), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic, bound=None), 'get_active': gi.FunctionInfo(get_active, bound=None), 'get_draw_as_radio': gi.FunctionInfo(get_draw_as_radio, bound=None), 'get_inconsistent': gi.FunctionInfo(get_inconsistent, bound=None), 'set_active': gi.FunctionInfo(set_active, bound=None), 'set_draw_as_radio': gi.FunctionInfo(set_draw_as_radio, bound=None), 'set_inconsistent': gi.FunctionInfo(set_inconsistent, bound=None), 'toggled': gi.FunctionInfo(toggled, bound=None), 'do_draw_indicator': gi.VFuncInfo(draw_indicator, bound=None), 'do_toggled': gi.VFuncInfo(toggled, bound=None), 'menu_item': <property object at 0x000002eceab88e00>, 'priv': <property object at 0x000002eceab88ef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckMenuItem (3922095776)>'
