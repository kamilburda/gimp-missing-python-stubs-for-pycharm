...
class GesturePan(GestureDrag):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abcb20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GesturePan), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGesturePan (3922094192)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_orientation': gi.FunctionInfo(get_orientation, bound=None), 'set_orientation': gi.FunctionInfo(set_orientation, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGesturePan (3922094192)>'
