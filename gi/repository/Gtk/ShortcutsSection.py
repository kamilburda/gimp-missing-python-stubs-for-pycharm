...
class ShortcutsSection(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1f550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ShortcutsSection), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkShortcutsSection (3922108160)>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutsSection (3922108160)>'
