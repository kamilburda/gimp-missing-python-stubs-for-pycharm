...
class FontSelectionDialog(FontSelectionDialog):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9d8a0>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__init__': <function deprecated_init.<locals>.new_init at 0x000002ece8a92de0>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontSelectionDialog (3860982848)>'
