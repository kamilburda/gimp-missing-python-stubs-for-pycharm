...
class NotebookPageAccessible(__gi_repository_Atk.Object, __gi_repository_Atk.Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab6cb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NotebookPageAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNotebookPageAccessible (3923948224)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'invalidate': gi.FunctionInfo(invalidate, bound=None), 'parent': <property object at 0x000002eceac25260>, 'priv': <property object at 0x000002eceac25350>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNotebookPageAccessible (3923948224)>'
