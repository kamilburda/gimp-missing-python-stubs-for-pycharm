...
class ScaleAccessible(RangeAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabb8820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScaleAccessible (3922106576)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac59e40>, 'priv': <property object at 0x000002eceac59f30>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleAccessible (3922106576)>'
