...
class InfoBar(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba3b80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(InfoBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkInfoBar (3922099952)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_action_widget': gi.FunctionInfo(add_action_widget, bound=None), 'add_button': gi.FunctionInfo(add_button, bound=None), 'get_action_area': gi.FunctionInfo(get_action_area, bound=None), 'get_content_area': gi.FunctionInfo(get_content_area, bound=None), 'get_message_type': gi.FunctionInfo(get_message_type, bound=None), 'get_revealed': gi.FunctionInfo(get_revealed, bound=None), 'get_show_close_button': gi.FunctionInfo(get_show_close_button, bound=None), 'response': gi.FunctionInfo(response, bound=None), 'set_default_response': gi.FunctionInfo(set_default_response, bound=None), 'set_message_type': gi.FunctionInfo(set_message_type, bound=None), 'set_response_sensitive': gi.FunctionInfo(set_response_sensitive, bound=None), 'set_revealed': gi.FunctionInfo(set_revealed, bound=None), 'set_show_close_button': gi.FunctionInfo(set_show_close_button, bound=None), 'do_close': gi.VFuncInfo(close, bound=None), 'do_response': gi.VFuncInfo(response, bound=None), 'parent': <property object at 0x000002eceabfce50>, 'priv': <property object at 0x000002eceabfcf40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkInfoBar (3922099952)>'
