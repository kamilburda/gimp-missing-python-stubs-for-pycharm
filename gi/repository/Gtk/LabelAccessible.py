...
class LabelAccessible(WidgetAccessible, __gi_repository_Atk.Hypertext, __gi_repository_Atk.Text):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba7190>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LabelAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLabelAccessible (3871459200)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabfe340>, 'priv': <property object at 0x000002eceabfe430>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLabelAccessible (3871459200)>'
