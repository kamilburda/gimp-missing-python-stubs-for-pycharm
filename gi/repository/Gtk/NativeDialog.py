...
class NativeDialog(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9b430>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(NativeDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNativeDialog (3923975664)>, '__doc__': None, '__gsignals__': {}, 'destroy': gi.FunctionInfo(destroy, bound=None), 'get_modal': gi.FunctionInfo(get_modal, bound=None), 'get_title': gi.FunctionInfo(get_title, bound=None), 'get_transient_for': gi.FunctionInfo(get_transient_for, bound=None), 'get_visible': gi.FunctionInfo(get_visible, bound=None), 'hide': gi.FunctionInfo(hide, bound=None), 'run': gi.FunctionInfo(run, bound=None), 'set_modal': gi.FunctionInfo(set_modal, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None), 'set_transient_for': gi.FunctionInfo(set_transient_for, bound=None), 'show': gi.FunctionInfo(show, bound=None), 'do_hide': gi.VFuncInfo(hide, bound=None), 'do_response': gi.VFuncInfo(response, bound=None), 'do_show': gi.VFuncInfo(show, bound=None), 'parent_instance': <property object at 0x000002eceabc9170>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNativeDialog (3923975664)>'
