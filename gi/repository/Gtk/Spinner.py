...
class Spinner(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1e440>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Spinner), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinner (3871463808)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'start': gi.FunctionInfo(start, bound=None), 'stop': gi.FunctionInfo(stop, bound=None), 'parent': <property object at 0x000002ece9b9e7a0>, 'priv': <property object at 0x000002ece9b9e890>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinner (3871463808)>'
