...
class Window(Window):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece8a3ac20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '__init__': <function Window.__init__ at 0x000002ece8a92160>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWindow (3855878912)>'
