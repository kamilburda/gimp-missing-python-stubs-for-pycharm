...
class Frame(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab4100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Frame), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFrame (3922100816)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_label': gi.FunctionInfo(get_label, bound=None), 'get_label_align': gi.FunctionInfo(get_label_align, bound=None), 'get_label_widget': gi.FunctionInfo(get_label_widget, bound=None), 'get_shadow_type': gi.FunctionInfo(get_shadow_type, bound=None), 'set_label': gi.FunctionInfo(set_label, bound=None), 'set_label_align': gi.FunctionInfo(set_label_align, bound=None), 'set_label_widget': gi.FunctionInfo(set_label_widget, bound=None), 'set_shadow_type': gi.FunctionInfo(set_shadow_type, bound=None), 'do_compute_child_allocation': gi.VFuncInfo(compute_child_allocation, bound=None), 'bin': <property object at 0x000002ece8fc13a0>, 'priv': <property object at 0x000002ece8fc1490>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFrame (3922100816)>'
