...
class IMContext(IMContext):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba3b50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'get_surrounding': <function strip_boolean_result.<locals>.wrapped at 0x000002ece8a937e0>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIMContext (3867805360)>'
