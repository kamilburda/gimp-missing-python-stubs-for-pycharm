...
class ProgressBar(__gi_overrides_Gtk.Widget, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabaac80>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProgressBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkProgressBar (3871453824)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_ellipsize': gi.FunctionInfo(get_ellipsize, bound=None), 'get_fraction': gi.FunctionInfo(get_fraction, bound=None), 'get_inverted': gi.FunctionInfo(get_inverted, bound=None), 'get_pulse_step': gi.FunctionInfo(get_pulse_step, bound=None), 'get_show_text': gi.FunctionInfo(get_show_text, bound=None), 'get_text': gi.FunctionInfo(get_text, bound=None), 'pulse': gi.FunctionInfo(pulse, bound=None), 'set_ellipsize': gi.FunctionInfo(set_ellipsize, bound=None), 'set_fraction': gi.FunctionInfo(set_fraction, bound=None), 'set_inverted': gi.FunctionInfo(set_inverted, bound=None), 'set_pulse_step': gi.FunctionInfo(set_pulse_step, bound=None), 'set_show_text': gi.FunctionInfo(set_show_text, bound=None), 'set_text': gi.FunctionInfo(set_text, bound=None), 'parent': <property object at 0x000002eceac3d8f0>, 'priv': <property object at 0x000002eceac3d9e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkProgressBar (3871453824)>'
