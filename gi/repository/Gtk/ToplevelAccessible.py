...
class ToplevelAccessible(__gi_repository_Atk.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9028c70>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ToplevelAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkToplevelAccessible (3867664944)>, '__doc__': None, '__gsignals__': {}, 'get_children': gi.FunctionInfo(get_children, bound=None), 'parent': <property object at 0x000002ece9b59c10>, 'priv': <property object at 0x000002ece9b59d00>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkToplevelAccessible (3867664944)>'
