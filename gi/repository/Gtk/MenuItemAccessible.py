...
class MenuItemAccessible(ContainerAccessible, __gi_repository_Atk.Action, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab93c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuItemAccessible (3860384112)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceab89080>, 'priv': <property object at 0x000002eceab89170>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuItemAccessible (3860384112)>'
