...
class IMContextSimple(__gi_overrides_Gtk.IMContext):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9a200>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IMContextSimple), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkIMContextSimple (3923976224)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_compose_file': gi.FunctionInfo(add_compose_file, bound=None), 'object': <property object at 0x000002eceabebd80>, 'priv': <property object at 0x000002eceabebe70>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIMContextSimple (3923976224)>'
