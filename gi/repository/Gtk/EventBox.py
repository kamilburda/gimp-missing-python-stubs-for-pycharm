...
class EventBox(Bin):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventBox (3922095200)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_above_child': gi.FunctionInfo(get_above_child, bound=None), 'get_visible_window': gi.FunctionInfo(get_visible_window, bound=None), 'set_above_child': gi.FunctionInfo(set_above_child, bound=None), 'set_visible_window': gi.FunctionInfo(set_visible_window, bound=None), 'bin': <property object at 0x000002eceabbe4d0>, 'priv': <property object at 0x000002eceabbe5c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventBox (3922095200)>'
