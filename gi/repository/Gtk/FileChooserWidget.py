...
class FileChooserWidget(__gi_overrides_Gtk.Box, FileChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab98fd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFileChooserWidget (3922095344)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x000002eceabc9490>, 'priv': <property object at 0x000002eceabc9580>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserWidget (3922095344)>'
