...
class FlowBoxChild(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abc670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FlowBoxChild), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFlowBoxChild (3922096208)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'changed': gi.FunctionInfo(changed, bound=None), 'get_index': gi.FunctionInfo(get_index, bound=None), 'is_selected': gi.FunctionInfo(is_selected, bound=None), 'do_activate': gi.VFuncInfo(activate, bound=None), 'parent_instance': <property object at 0x000002eceabcba60>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFlowBoxChild (3922096208)>'
