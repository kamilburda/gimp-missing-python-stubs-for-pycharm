...
class PopoverAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabb19f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PopoverAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPopoverAccessible (3922107008)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac32480>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPopoverAccessible (3922107008)>'
