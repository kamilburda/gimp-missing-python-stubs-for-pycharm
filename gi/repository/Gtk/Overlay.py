...
class Overlay(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9ceb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Overlay), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkOverlay (3922110464)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_overlay': gi.FunctionInfo(add_overlay, bound=None), 'get_overlay_pass_through': gi.FunctionInfo(get_overlay_pass_through, bound=None), 'reorder_overlay': gi.FunctionInfo(reorder_overlay, bound=None), 'set_overlay_pass_through': gi.FunctionInfo(set_overlay_pass_through, bound=None), 'do_get_child_position': gi.VFuncInfo(get_child_position, bound=None), 'parent': <property object at 0x000002eceac26a20>, 'priv': <property object at 0x000002eceac26b10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkOverlay (3922110464)>'
