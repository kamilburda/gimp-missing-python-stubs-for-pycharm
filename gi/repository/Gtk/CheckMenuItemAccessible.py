...
class CheckMenuItemAccessible(MenuItemAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abe200>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckMenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckMenuItemAccessible (3922097648)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceab892b0>, 'priv': <property object at 0x000002eceab893a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckMenuItemAccessible (3922097648)>'
