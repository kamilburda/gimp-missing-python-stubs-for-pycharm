...
class EventControllerScroll(EventController):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab99240>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventControllerScroll), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventControllerScroll (3923971296)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_flags': gi.FunctionInfo(get_flags, bound=None), 'set_flags': gi.FunctionInfo(set_flags, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventControllerScroll (3923971296)>'
