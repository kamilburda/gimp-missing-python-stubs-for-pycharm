...
class CellAreaBox(CellArea, Orientable):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellAreaBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellAreaBox (3855517664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_spacing': gi.FunctionInfo(get_spacing, bound=None), 'pack_end': gi.FunctionInfo(pack_end, bound=None), 'pack_start': gi.FunctionInfo(pack_start, bound=None), 'set_spacing': gi.FunctionInfo(set_spacing, bound=None), 'parent_instance': <property object at 0x000002ece8ff67f0>, 'priv': <property object at 0x000002ece8ff68e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellAreaBox (3855517664)>'
