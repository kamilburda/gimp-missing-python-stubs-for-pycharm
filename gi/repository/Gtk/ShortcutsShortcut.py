...
class ShortcutsShortcut(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1e110>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ShortcutsShortcut), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkShortcutsShortcut (3922105424)>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutsShortcut (3922105424)>'
