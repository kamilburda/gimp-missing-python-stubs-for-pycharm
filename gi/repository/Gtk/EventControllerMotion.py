...
class EventControllerMotion(EventController):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9b040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(EventControllerMotion), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkEventControllerMotion (3923973984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkEventControllerMotion (3923973984)>'
