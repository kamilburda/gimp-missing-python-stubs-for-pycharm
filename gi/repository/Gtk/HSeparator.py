...
class HSeparator(Separator):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece8a424d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HSeparator), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHSeparator (3871454848)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'separator': <property object at 0x000002eceabe8a90>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHSeparator (3871454848)>'
