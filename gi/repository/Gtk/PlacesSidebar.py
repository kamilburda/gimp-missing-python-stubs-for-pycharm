...
class PlacesSidebar(__gi_overrides_Gtk.ScrolledWindow):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabaf940>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PlacesSidebar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPlacesSidebar (3922102688)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_shortcut': gi.FunctionInfo(add_shortcut, bound=None), 'get_local_only': gi.FunctionInfo(get_local_only, bound=None), 'get_location': gi.FunctionInfo(get_location, bound=None), 'get_nth_bookmark': gi.FunctionInfo(get_nth_bookmark, bound=None), 'get_open_flags': gi.FunctionInfo(get_open_flags, bound=None), 'get_show_connect_to_server': gi.FunctionInfo(get_show_connect_to_server, bound=None), 'get_show_desktop': gi.FunctionInfo(get_show_desktop, bound=None), 'get_show_enter_location': gi.FunctionInfo(get_show_enter_location, bound=None), 'get_show_other_locations': gi.FunctionInfo(get_show_other_locations, bound=None), 'get_show_recent': gi.FunctionInfo(get_show_recent, bound=None), 'get_show_starred_location': gi.FunctionInfo(get_show_starred_location, bound=None), 'get_show_trash': gi.FunctionInfo(get_show_trash, bound=None), 'list_shortcuts': gi.FunctionInfo(list_shortcuts, bound=None), 'remove_shortcut': gi.FunctionInfo(remove_shortcut, bound=None), 'set_drop_targets_visible': gi.FunctionInfo(set_drop_targets_visible, bound=None), 'set_local_only': gi.FunctionInfo(set_local_only, bound=None), 'set_location': gi.FunctionInfo(set_location, bound=None), 'set_open_flags': gi.FunctionInfo(set_open_flags, bound=None), 'set_show_connect_to_server': gi.FunctionInfo(set_show_connect_to_server, bound=None), 'set_show_desktop': gi.FunctionInfo(set_show_desktop, bound=None), 'set_show_enter_location': gi.FunctionInfo(set_show_enter_location, bound=None), 'set_show_other_locations': gi.FunctionInfo(set_show_other_locations, bound=None), 'set_show_recent': gi.FunctionInfo(set_show_recent, bound=None), 'set_show_starred_location': gi.FunctionInfo(set_show_starred_location, bound=None), 'set_show_trash': gi.FunctionInfo(set_show_trash, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPlacesSidebar (3922102688)>'
