...
class SpinButtonAccessible(EntryAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1fb20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinButtonAccessible (3922108448)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece9b9d760>, 'priv': <property object at 0x000002ece9b9d850>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinButtonAccessible (3922108448)>'
