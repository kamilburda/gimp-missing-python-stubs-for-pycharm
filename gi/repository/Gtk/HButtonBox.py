...
class HButtonBox(ButtonBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abe230>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHButtonBox (3922100096)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'button_box': <property object at 0x000002eceabdf1f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHButtonBox (3922100096)>'
