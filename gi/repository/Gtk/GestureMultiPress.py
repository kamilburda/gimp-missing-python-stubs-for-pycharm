...
class GestureMultiPress(GestureSingle):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9e170>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureMultiPress), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureMultiPress (3871457152)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_area': gi.FunctionInfo(get_area, bound=None), 'set_area': gi.FunctionInfo(set_area, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureMultiPress (3871457152)>'
