...
class ProgressBarAccessible(WidgetAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9056500>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ProgressBarAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkProgressBarAccessible (3871454208)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac3db20>, 'priv': <property object at 0x000002eceac3dc10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkProgressBarAccessible (3871454208)>'
