...
class MenuButton(ToggleButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba7040>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuButton (3867892784)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_align_widget': gi.FunctionInfo(get_align_widget, bound=None), 'get_direction': gi.FunctionInfo(get_direction, bound=None), 'get_menu_model': gi.FunctionInfo(get_menu_model, bound=None), 'get_popover': gi.FunctionInfo(get_popover, bound=None), 'get_popup': gi.FunctionInfo(get_popup, bound=None), 'get_use_popover': gi.FunctionInfo(get_use_popover, bound=None), 'set_align_widget': gi.FunctionInfo(set_align_widget, bound=None), 'set_direction': gi.FunctionInfo(set_direction, bound=None), 'set_menu_model': gi.FunctionInfo(set_menu_model, bound=None), 'set_popover': gi.FunctionInfo(set_popover, bound=None), 'set_popup': gi.FunctionInfo(set_popup, bound=None), 'set_use_popover': gi.FunctionInfo(set_use_popover, bound=None), 'parent': <property object at 0x000002eceac115d0>, 'priv': <property object at 0x000002eceac116c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuButton (3867892784)>'
