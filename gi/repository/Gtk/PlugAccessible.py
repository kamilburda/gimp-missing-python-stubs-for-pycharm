...
class PlugAccessible(WindowAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba9ff0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PlugAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPlugAccessible (3922102400)>, '__doc__': None, '__gsignals__': {}, 'get_id': gi.FunctionInfo(get_id, bound=None), 'parent': <property object at 0x000002eceac31d50>, 'priv': <property object at 0x000002eceac31e40>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPlugAccessible (3922102400)>'
