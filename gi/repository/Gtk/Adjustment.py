...
class Adjustment(Adjustment):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab1fc0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', '_init': <function deprecated_init.<locals>.new_init at 0x000002ece8a6cb80>, '__init__': <function Adjustment.__init__ at 0x000002ece8a6cc20>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAdjustment (3867803456)>'
