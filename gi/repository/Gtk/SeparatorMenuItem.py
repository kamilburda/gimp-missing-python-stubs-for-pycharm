...
class SeparatorMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd27100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SeparatorMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSeparatorMenuItem (3922108016)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'menu_item': <property object at 0x000002eceac6a480>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSeparatorMenuItem (3922108016)>'
