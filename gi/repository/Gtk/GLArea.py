...
class GLArea(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abcfd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GLArea), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGLArea (3855512672)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'attach_buffers': gi.FunctionInfo(attach_buffers, bound=None), 'get_auto_render': gi.FunctionInfo(get_auto_render, bound=None), 'get_context': gi.FunctionInfo(get_context, bound=None), 'get_error': gi.FunctionInfo(get_error, bound=None), 'get_has_alpha': gi.FunctionInfo(get_has_alpha, bound=None), 'get_has_depth_buffer': gi.FunctionInfo(get_has_depth_buffer, bound=None), 'get_has_stencil_buffer': gi.FunctionInfo(get_has_stencil_buffer, bound=None), 'get_required_version': gi.FunctionInfo(get_required_version, bound=None), 'get_use_es': gi.FunctionInfo(get_use_es, bound=None), 'make_current': gi.FunctionInfo(make_current, bound=None), 'queue_render': gi.FunctionInfo(queue_render, bound=None), 'set_auto_render': gi.FunctionInfo(set_auto_render, bound=None), 'set_error': gi.FunctionInfo(set_error, bound=None), 'set_has_alpha': gi.FunctionInfo(set_has_alpha, bound=None), 'set_has_depth_buffer': gi.FunctionInfo(set_has_depth_buffer, bound=None), 'set_has_stencil_buffer': gi.FunctionInfo(set_has_stencil_buffer, bound=None), 'set_required_version': gi.FunctionInfo(set_required_version, bound=None), 'set_use_es': gi.FunctionInfo(set_use_es, bound=None), 'do_render': gi.VFuncInfo(render, bound=None), 'do_resize': gi.VFuncInfo(resize, bound=None), 'parent_instance': <property object at 0x000002eceabdd210>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGLArea (3855512672)>'
