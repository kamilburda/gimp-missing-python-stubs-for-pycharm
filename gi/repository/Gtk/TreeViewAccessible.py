...
class TreeViewAccessible(ContainerAccessible, __gi_repository_Atk.Selection, __gi_repository_Atk.Table, CellAccessibleParent):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecee4b5030>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(TreeViewAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkTreeViewAccessible (3922116944)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece9b524d0>, 'priv': <property object at 0x000002ece9b525c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkTreeViewAccessible (3922116944)>'
