...
class ScrolledWindowAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd24250>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScrolledWindowAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScrolledWindowAccessible (3922107296)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac682c0>, 'priv': <property object at 0x000002eceac683b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScrolledWindowAccessible (3922107296)>'
