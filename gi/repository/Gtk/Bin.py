...
class Bin(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece6dae8f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Bin), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkBin (3860579632)>, '__doc__': None, '__gsignals__': {}, 'get_child': gi.FunctionInfo(get_child, bound=None), 'container': <property object at 0x000002ece8a99260>, 'priv': <property object at 0x000002ece8a99350>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkBin (3860579632)>'
