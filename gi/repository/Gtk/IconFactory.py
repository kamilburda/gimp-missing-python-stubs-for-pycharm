...
class IconFactory(__gi_overrides_GObject.Object, Buildable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9da20>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IconFactory), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkIconFactory (3923976000)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'lookup_default': gi.FunctionInfo(lookup_default, bound=None), 'add': gi.FunctionInfo(add, bound=None), 'add_default': gi.FunctionInfo(add_default, bound=None), 'lookup': gi.FunctionInfo(lookup, bound=None), 'remove_default': gi.FunctionInfo(remove_default, bound=None), 'parent_instance': <property object at 0x000002eceabf0b80>, 'priv': <property object at 0x000002eceabf0c70>})"
    __gdoc__ = 'Object GtkIconFactory\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIconFactory (3923976000)>'
