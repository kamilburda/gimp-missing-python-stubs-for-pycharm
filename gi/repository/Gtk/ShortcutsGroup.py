...
class ShortcutsGroup(__gi_overrides_Gtk.Box):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ShortcutsGroup), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkShortcutsGroup (3922105136)>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutsGroup (3922105136)>'
