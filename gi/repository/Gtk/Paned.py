...
class Paned(Paned):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba0a00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'pack1': <function Paned.pack1 at 0x000002ece8a6d8a0>, 'pack2': <function Paned.pack2 at 0x000002ece8a6d940>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPaned (3860582320)>'
