...
class GestureSwipe(GestureSingle):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9a290>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureSwipe), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureSwipe (3871454720)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_velocity': gi.FunctionInfo(get_velocity, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureSwipe (3871454720)>'
