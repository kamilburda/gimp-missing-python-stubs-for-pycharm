...
class Revealer(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab5390>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Revealer), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRevealer (3922107872)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_child_revealed': gi.FunctionInfo(get_child_revealed, bound=None), 'get_reveal_child': gi.FunctionInfo(get_reveal_child, bound=None), 'get_transition_duration': gi.FunctionInfo(get_transition_duration, bound=None), 'get_transition_type': gi.FunctionInfo(get_transition_type, bound=None), 'set_reveal_child': gi.FunctionInfo(set_reveal_child, bound=None), 'set_transition_duration': gi.FunctionInfo(set_transition_duration, bound=None), 'set_transition_type': gi.FunctionInfo(set_transition_type, bound=None), 'parent_instance': <property object at 0x000002eceac59940>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRevealer (3922107872)>'
