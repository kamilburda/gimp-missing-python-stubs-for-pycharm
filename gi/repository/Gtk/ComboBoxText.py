...
class ComboBoxText(__gi_overrides_Gtk.ComboBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ac0490>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ComboBoxText), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkComboBoxText (3922097360)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_entry': gi.FunctionInfo(new_with_entry, bound=None), 'append': gi.FunctionInfo(append, bound=None), 'append_text': gi.FunctionInfo(append_text, bound=None), 'get_active_text': gi.FunctionInfo(get_active_text, bound=None), 'insert': gi.FunctionInfo(insert, bound=None), 'insert_text': gi.FunctionInfo(insert_text, bound=None), 'prepend': gi.FunctionInfo(prepend, bound=None), 'prepend_text': gi.FunctionInfo(prepend_text, bound=None), 'remove': gi.FunctionInfo(remove, bound=None), 'remove_all': gi.FunctionInfo(remove_all, bound=None), 'parent_instance': <property object at 0x000002eceab81df0>, 'priv': <property object at 0x000002eceab81ee0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkComboBoxText (3922097360)>'
