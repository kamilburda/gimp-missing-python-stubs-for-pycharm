...
class ExpanderAccessible(ContainerAccessible, __gi_repository_Atk.Action):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abc1f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ExpanderAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkExpanderAccessible (3922101248)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabbf470>, 'priv': <property object at 0x000002eceabbf560>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkExpanderAccessible (3922101248)>'
