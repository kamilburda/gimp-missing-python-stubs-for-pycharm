...
class StackSwitcher(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd27f40>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StackSwitcher), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStackSwitcher (3922109744)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_stack': gi.FunctionInfo(get_stack, bound=None), 'set_stack': gi.FunctionInfo(set_stack, bound=None), 'widget': <property object at 0x000002ece9b90130>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStackSwitcher (3922109744)>'
