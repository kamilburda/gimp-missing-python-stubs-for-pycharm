...
class Accessible(__gi_repository_Atk.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab2380>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Accessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAccessible (3867801440)>, '__doc__': None, '__gsignals__': {}, 'connect_widget_destroyed': gi.FunctionInfo(connect_widget_destroyed, bound=None), 'get_widget': gi.FunctionInfo(get_widget, bound=None), 'set_widget': gi.FunctionInfo(set_widget, bound=None), 'do_connect_widget_destroyed': gi.VFuncInfo(connect_widget_destroyed, bound=None), 'do_widget_set': gi.VFuncInfo(widget_set, bound=None), 'do_widget_unset': gi.VFuncInfo(widget_unset, bound=None), 'parent': <property object at 0x000002ece8fae890>, 'priv': <property object at 0x000002ece8fae980>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAccessible (3867801440)>'
