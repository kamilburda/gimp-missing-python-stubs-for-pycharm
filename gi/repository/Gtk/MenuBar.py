...
class MenuBar(MenuShell):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabab100>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuBar (3922109024)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_model': gi.FunctionInfo(new_from_model, bound=None), 'get_child_pack_direction': gi.FunctionInfo(get_child_pack_direction, bound=None), 'get_pack_direction': gi.FunctionInfo(get_pack_direction, bound=None), 'set_child_pack_direction': gi.FunctionInfo(set_child_pack_direction, bound=None), 'set_pack_direction': gi.FunctionInfo(set_pack_direction, bound=None), 'menu_shell': <property object at 0x000002eceac10db0>, 'priv': <property object at 0x000002eceac10ea0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuBar (3922109024)>'
