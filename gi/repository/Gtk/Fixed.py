...
class Fixed(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abffd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Fixed), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFixed (3855514720)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'move': gi.FunctionInfo(move, bound=None), 'put': gi.FunctionInfo(put, bound=None), 'container': <property object at 0x000002eceabca750>, 'priv': <property object at 0x000002eceabca840>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFixed (3855514720)>'
