...
class FileChooserButton(__gi_overrides_Gtk.Box, FileChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abe170>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileChooserButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFileChooserButton (3922092176)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_dialog': gi.FunctionInfo(new_with_dialog, bound=None), 'get_focus_on_click': gi.FunctionInfo(get_focus_on_click, bound=None), 'get_title': gi.FunctionInfo(get_title, bound=None), 'get_width_chars': gi.FunctionInfo(get_width_chars, bound=None), 'set_focus_on_click': gi.FunctionInfo(set_focus_on_click, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None), 'set_width_chars': gi.FunctionInfo(set_width_chars, bound=None), 'do_file_set': gi.VFuncInfo(file_set, bound=None), 'parent': <property object at 0x000002eceabc8130>, 'priv': <property object at 0x000002eceabc8220>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserButton (3922092176)>'
