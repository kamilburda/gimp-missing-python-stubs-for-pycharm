...
class ShortcutLabel(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd24d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ShortcutLabel), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkShortcutLabel (3922105712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_accelerator': gi.FunctionInfo(get_accelerator, bound=None), 'get_disabled_text': gi.FunctionInfo(get_disabled_text, bound=None), 'set_accelerator': gi.FunctionInfo(set_accelerator, bound=None), 'set_disabled_text': gi.FunctionInfo(set_disabled_text, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkShortcutLabel (3922105712)>'
