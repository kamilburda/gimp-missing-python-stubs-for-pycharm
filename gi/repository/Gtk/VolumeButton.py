...
class VolumeButton(ScaleButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecee4b52a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VolumeButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVolumeButton (3867895184)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent': <property object at 0x000002ece9b4eed0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVolumeButton (3867895184)>'
