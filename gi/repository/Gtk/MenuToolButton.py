...
class MenuToolButton(__gi_overrides_Gtk.ToolButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab98670>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuToolButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuToolButton (3867895824)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_stock': gi.FunctionInfo(new_from_stock, bound=None), 'get_menu': gi.FunctionInfo(get_menu, bound=None), 'set_arrow_tooltip_markup': gi.FunctionInfo(set_arrow_tooltip_markup, bound=None), 'set_arrow_tooltip_text': gi.FunctionInfo(set_arrow_tooltip_text, bound=None), 'set_menu': gi.FunctionInfo(set_menu, bound=None), 'do_show_menu': gi.VFuncInfo(show_menu, bound=None), 'parent': <property object at 0x000002eceac1cdb0>, 'priv': <property object at 0x000002eceac1cea0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuToolButton (3867895824)>'
