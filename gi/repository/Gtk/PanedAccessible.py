...
class PanedAccessible(ContainerAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabac9a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PanedAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPanedAccessible (3922104272)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac30450>, 'priv': <property object at 0x000002eceac30540>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPanedAccessible (3922104272)>'
