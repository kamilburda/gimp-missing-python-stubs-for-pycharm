...
class ColorChooserDialog(__gi_overrides_Gtk.Dialog, ColorChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abcc40>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorChooserDialog (3855855136)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x000002eceab8a930>, 'priv': <property object at 0x000002eceab8aa20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorChooserDialog (3855855136)>'
