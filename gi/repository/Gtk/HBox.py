...
class HBox(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba0460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHBox (3922096928)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'box': <property object at 0x000002eceabdef20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHBox (3922096928)>'
