...
class GestureRotate(Gesture):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9c9d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureRotate), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureRotate (3871458688)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_angle_delta': gi.FunctionInfo(get_angle_delta, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureRotate (3871458688)>'
