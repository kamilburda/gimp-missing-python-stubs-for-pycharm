...
class RadioButtonAccessible(ToggleButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabb32b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioButtonAccessible (3867896144)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac3f600>, 'priv': <property object at 0x000002eceac3f6f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioButtonAccessible (3867896144)>'
