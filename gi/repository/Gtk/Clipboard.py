...
class Clipboard(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abddb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Clipboard), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkClipboard (3855035952)>, '__doc__': None, '__gsignals__': {}, 'get': gi.FunctionInfo(get, bound=None), 'get_default': gi.FunctionInfo(get_default, bound=None), 'get_for_display': gi.FunctionInfo(get_for_display, bound=None), 'clear': gi.FunctionInfo(clear, bound=None), 'get_display': gi.FunctionInfo(get_display, bound=None), 'get_owner': gi.FunctionInfo(get_owner, bound=None), 'get_selection': gi.FunctionInfo(get_selection, bound=None), 'request_contents': gi.FunctionInfo(request_contents, bound=None), 'request_image': gi.FunctionInfo(request_image, bound=None), 'request_rich_text': gi.FunctionInfo(request_rich_text, bound=None), 'request_targets': gi.FunctionInfo(request_targets, bound=None), 'request_text': gi.FunctionInfo(request_text, bound=None), 'request_uris': gi.FunctionInfo(request_uris, bound=None), 'set_can_store': gi.FunctionInfo(set_can_store, bound=None), 'set_image': gi.FunctionInfo(set_image, bound=None), 'set_text': gi.FunctionInfo(set_text, bound=None), 'store': gi.FunctionInfo(store, bound=None), 'wait_for_contents': gi.FunctionInfo(wait_for_contents, bound=None), 'wait_for_image': gi.FunctionInfo(wait_for_image, bound=None), 'wait_for_rich_text': gi.FunctionInfo(wait_for_rich_text, bound=None), 'wait_for_targets': gi.FunctionInfo(wait_for_targets, bound=None), 'wait_for_text': gi.FunctionInfo(wait_for_text, bound=None), 'wait_for_uris': gi.FunctionInfo(wait_for_uris, bound=None), 'wait_is_image_available': gi.FunctionInfo(wait_is_image_available, bound=None), 'wait_is_rich_text_available': gi.FunctionInfo(wait_is_rich_text_available, bound=None), 'wait_is_target_available': gi.FunctionInfo(wait_is_target_available, bound=None), 'wait_is_text_available': gi.FunctionInfo(wait_is_text_available, bound=None), 'wait_is_uris_available': gi.FunctionInfo(wait_is_uris_available, bound=None)})"
    __gdoc__ = 'Object GtkClipboard\n\nSignals from GtkClipboard:\n  owner-change (GdkEvent)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkClipboard (3855035952)>'
