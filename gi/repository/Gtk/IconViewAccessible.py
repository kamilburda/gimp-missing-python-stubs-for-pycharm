...
class IconViewAccessible(ContainerAccessible, __gi_repository_Atk.Selection):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9d690>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IconViewAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkIconViewAccessible (3922094480)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabf2200>, 'priv': <property object at 0x000002eceabf22f0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIconViewAccessible (3922094480)>'
