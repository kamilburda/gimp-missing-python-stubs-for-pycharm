...
class FontChooserDialog(__gi_overrides_Gtk.Dialog, FontChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab8a00>'
    _old_arg_names = (
        'title',
        'parent',
        'flags',
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontChooserDialog), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontChooserDialog (3867892944)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x000002eceabd5a80>, 'priv': <property object at 0x000002eceabd5b70>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontChooserDialog (3867892944)>'
