...
class ImageCellAccessible(RendererCellAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba2aa0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageCellAccessible (3922097216)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabf3b00>, 'priv': <property object at 0x000002eceabf3bf0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageCellAccessible (3922097216)>'
