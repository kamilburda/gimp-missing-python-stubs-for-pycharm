...
class ScaleButton(__gi_overrides_Gtk.Button, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd24ac0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ScaleButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScaleButton (3922109168)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_adjustment': gi.FunctionInfo(get_adjustment, bound=None), 'get_minus_button': gi.FunctionInfo(get_minus_button, bound=None), 'get_plus_button': gi.FunctionInfo(get_plus_button, bound=None), 'get_popup': gi.FunctionInfo(get_popup, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'set_adjustment': gi.FunctionInfo(set_adjustment, bound=None), 'set_icons': gi.FunctionInfo(set_icons, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None), 'do_value_changed': gi.VFuncInfo(value_changed, bound=None), 'parent': <property object at 0x000002eceac5a2a0>, 'priv': <property object at 0x000002eceac5a390>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScaleButton (3922109168)>'
