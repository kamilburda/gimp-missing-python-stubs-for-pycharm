...
class AppChooserWidget(__gi_overrides_Gtk.Box, AppChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab6170>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AppChooserWidget), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAppChooserWidget (3922121408)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_default_text': gi.FunctionInfo(get_default_text, bound=None), 'get_show_all': gi.FunctionInfo(get_show_all, bound=None), 'get_show_default': gi.FunctionInfo(get_show_default, bound=None), 'get_show_fallback': gi.FunctionInfo(get_show_fallback, bound=None), 'get_show_other': gi.FunctionInfo(get_show_other, bound=None), 'get_show_recommended': gi.FunctionInfo(get_show_recommended, bound=None), 'set_default_text': gi.FunctionInfo(set_default_text, bound=None), 'set_show_all': gi.FunctionInfo(set_show_all, bound=None), 'set_show_default': gi.FunctionInfo(set_show_default, bound=None), 'set_show_fallback': gi.FunctionInfo(set_show_fallback, bound=None), 'set_show_other': gi.FunctionInfo(set_show_other, bound=None), 'set_show_recommended': gi.FunctionInfo(set_show_recommended, bound=None), 'do_application_activated': gi.VFuncInfo(application_activated, bound=None), 'do_application_selected': gi.VFuncInfo(application_selected, bound=None), 'do_populate_popup': gi.VFuncInfo(populate_popup, bound=None), 'parent': <property object at 0x000002ece8fb7330>, 'priv': <property object at 0x000002ece8fb7420>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserWidget (3922121408)>'
