...
class FileChooserWidgetAccessible(ContainerAccessible, __gi_repository_Atk.Action):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ac0310>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FileChooserWidgetAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFileChooserWidgetAccessible (3922098512)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceabc96c0>, 'priv': <property object at 0x000002eceabc97b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFileChooserWidgetAccessible (3922098512)>'
