...
class ListBoxRowAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabab580>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ListBoxRowAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkListBoxRowAccessible (3922093184)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac0a8e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkListBoxRowAccessible (3922093184)>'
