...
class StatusbarAccessible(ContainerAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9028940>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(StatusbarAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkStatusbarAccessible (3922111472)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece9b91a80>, 'priv': <property object at 0x000002ece9b91b70>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkStatusbarAccessible (3922111472)>'
