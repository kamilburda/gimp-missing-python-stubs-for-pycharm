...
class GestureStylus(GestureSingle):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9f760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(GestureStylus), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGestureStylus (3871461376)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_axes': gi.FunctionInfo(get_axes, bound=None), 'get_axis': gi.FunctionInfo(get_axis, bound=None), 'get_device_tool': gi.FunctionInfo(get_device_tool, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGestureStylus (3871461376)>'
