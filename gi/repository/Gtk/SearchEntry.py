...
class SearchEntry(Entry):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ececd24ee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SearchEntry), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSearchEntry (3871465984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'handle_event': gi.FunctionInfo(handle_event, bound=None), 'do_next_match': gi.VFuncInfo(next_match, bound=None), 'do_previous_match': gi.VFuncInfo(previous_match, bound=None), 'do_search_changed': gi.VFuncInfo(search_changed, bound=None), 'do_stop_search': gi.VFuncInfo(stop_search, bound=None), 'parent': <property object at 0x000002eceac69670>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSearchEntry (3871465984)>'
