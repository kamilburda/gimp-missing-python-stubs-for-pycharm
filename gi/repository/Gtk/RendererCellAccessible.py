...
class RendererCellAccessible(CellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab5570>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RendererCellAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRendererCellAccessible (3855519584)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent': <property object at 0x000002ece8fcc860>, 'priv': <property object at 0x000002ece8fcc950>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRendererCellAccessible (3855519584)>'
