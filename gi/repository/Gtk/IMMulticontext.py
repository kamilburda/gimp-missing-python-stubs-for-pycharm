...
class IMMulticontext(__gi_overrides_Gtk.IMContext):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba1690>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(IMMulticontext), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkIMMulticontext (3923969168)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'append_menuitems': gi.FunctionInfo(append_menuitems, bound=None), 'get_context_id': gi.FunctionInfo(get_context_id, bound=None), 'set_context_id': gi.FunctionInfo(set_context_id, bound=None), 'object': <property object at 0x000002eceabf0220>, 'priv': <property object at 0x000002eceabf0310>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkIMMulticontext (3923969168)>'
