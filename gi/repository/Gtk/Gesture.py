...
class Gesture(EventController):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab99d50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Gesture), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkGesture (3923970512)>, '__doc__': None, '__gsignals__': {}, 'get_bounding_box': gi.FunctionInfo(get_bounding_box, bound=None), 'get_bounding_box_center': gi.FunctionInfo(get_bounding_box_center, bound=None), 'get_device': gi.FunctionInfo(get_device, bound=None), 'get_group': gi.FunctionInfo(get_group, bound=None), 'get_last_event': gi.FunctionInfo(get_last_event, bound=None), 'get_last_updated_sequence': gi.FunctionInfo(get_last_updated_sequence, bound=None), 'get_point': gi.FunctionInfo(get_point, bound=None), 'get_sequence_state': gi.FunctionInfo(get_sequence_state, bound=None), 'get_sequences': gi.FunctionInfo(get_sequences, bound=None), 'get_window': gi.FunctionInfo(get_window, bound=None), 'group': gi.FunctionInfo(group, bound=None), 'handles_sequence': gi.FunctionInfo(handles_sequence, bound=None), 'is_active': gi.FunctionInfo(is_active, bound=None), 'is_grouped_with': gi.FunctionInfo(is_grouped_with, bound=None), 'is_recognized': gi.FunctionInfo(is_recognized, bound=None), 'set_sequence_state': gi.FunctionInfo(set_sequence_state, bound=None), 'set_state': gi.FunctionInfo(set_state, bound=None), 'set_window': gi.FunctionInfo(set_window, bound=None), 'ungroup': gi.FunctionInfo(ungroup, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkGesture (3923970512)>'
