...
class LinkButtonAccessible(ButtonAccessible, __gi_repository_Atk.HyperlinkImpl):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba1f90>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LinkButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLinkButtonAccessible (3922100528)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac08ae0>, 'priv': <property object at 0x000002eceac08bd0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLinkButtonAccessible (3922100528)>'
