...
class VButtonBox(ButtonBox):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecee5b0550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VButtonBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVButtonBox (3922112768)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'button_box': <property object at 0x000002ece9b4dc10>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVButtonBox (3922112768)>'
