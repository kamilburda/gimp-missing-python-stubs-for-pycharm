...
class PadController(EventController):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabac280>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(PadController), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPadController (3923950240)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set_action': gi.FunctionInfo(set_action, bound=None), 'set_action_entries': gi.FunctionInfo(set_action_entries, bound=None)})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPadController (3923950240)>'
