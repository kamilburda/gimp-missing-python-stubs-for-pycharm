...
class LevelBarAccessible(WidgetAccessible, __gi_repository_Atk.Value):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba1990>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LevelBarAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLevelBarAccessible (3871460224)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac08090>, 'priv': <property object at 0x000002eceac08180>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLevelBarAccessible (3871460224)>'
