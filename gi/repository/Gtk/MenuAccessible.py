...
class MenuAccessible(MenuShellAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceababee0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuAccessible (3922107584)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac108b0>, 'priv': <property object at 0x000002eceac109a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuAccessible (3922107584)>'
