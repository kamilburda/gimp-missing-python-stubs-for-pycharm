...
class LevelBar(__gi_overrides_Gtk.Widget, Orientable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba06d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(LevelBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLevelBar (3871455872)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_for_interval': gi.FunctionInfo(new_for_interval, bound=None), 'add_offset_value': gi.FunctionInfo(add_offset_value, bound=None), 'get_inverted': gi.FunctionInfo(get_inverted, bound=None), 'get_max_value': gi.FunctionInfo(get_max_value, bound=None), 'get_min_value': gi.FunctionInfo(get_min_value, bound=None), 'get_mode': gi.FunctionInfo(get_mode, bound=None), 'get_offset_value': gi.FunctionInfo(get_offset_value, bound=None), 'get_value': gi.FunctionInfo(get_value, bound=None), 'remove_offset_value': gi.FunctionInfo(remove_offset_value, bound=None), 'set_inverted': gi.FunctionInfo(set_inverted, bound=None), 'set_max_value': gi.FunctionInfo(set_max_value, bound=None), 'set_min_value': gi.FunctionInfo(set_min_value, bound=None), 'set_mode': gi.FunctionInfo(set_mode, bound=None), 'set_value': gi.FunctionInfo(set_value, bound=None), 'do_offset_changed': gi.VFuncInfo(offset_changed, bound=None), 'parent': <property object at 0x000002eceabffdd0>, 'priv': <property object at 0x000002eceabffec0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLevelBar (3871455872)>'
