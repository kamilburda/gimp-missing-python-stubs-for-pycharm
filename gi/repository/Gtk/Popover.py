...
class Popover(Bin):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabaf760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Popover), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkPopover (3922107440)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_model': gi.FunctionInfo(new_from_model, bound=None), 'bind_model': gi.FunctionInfo(bind_model, bound=None), 'get_constrain_to': gi.FunctionInfo(get_constrain_to, bound=None), 'get_default_widget': gi.FunctionInfo(get_default_widget, bound=None), 'get_modal': gi.FunctionInfo(get_modal, bound=None), 'get_pointing_to': gi.FunctionInfo(get_pointing_to, bound=None), 'get_position': gi.FunctionInfo(get_position, bound=None), 'get_relative_to': gi.FunctionInfo(get_relative_to, bound=None), 'get_transitions_enabled': gi.FunctionInfo(get_transitions_enabled, bound=None), 'popdown': gi.FunctionInfo(popdown, bound=None), 'popup': gi.FunctionInfo(popup, bound=None), 'set_constrain_to': gi.FunctionInfo(set_constrain_to, bound=None), 'set_default_widget': gi.FunctionInfo(set_default_widget, bound=None), 'set_modal': gi.FunctionInfo(set_modal, bound=None), 'set_pointing_to': gi.FunctionInfo(set_pointing_to, bound=None), 'set_position': gi.FunctionInfo(set_position, bound=None), 'set_relative_to': gi.FunctionInfo(set_relative_to, bound=None), 'set_transitions_enabled': gi.FunctionInfo(set_transitions_enabled, bound=None), 'do_closed': gi.VFuncInfo(closed, bound=None), 'parent_instance': <property object at 0x000002eceac32250>, 'priv': <property object at 0x000002eceac32340>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkPopover (3922107440)>'
