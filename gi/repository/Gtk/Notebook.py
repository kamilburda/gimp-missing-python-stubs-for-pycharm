...
class Notebook(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ac3d00>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Notebook), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkNotebook (3867634976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'append_page': gi.FunctionInfo(append_page, bound=None), 'append_page_menu': gi.FunctionInfo(append_page_menu, bound=None), 'detach_tab': gi.FunctionInfo(detach_tab, bound=None), 'get_action_widget': gi.FunctionInfo(get_action_widget, bound=None), 'get_current_page': gi.FunctionInfo(get_current_page, bound=None), 'get_group_name': gi.FunctionInfo(get_group_name, bound=None), 'get_menu_label': gi.FunctionInfo(get_menu_label, bound=None), 'get_menu_label_text': gi.FunctionInfo(get_menu_label_text, bound=None), 'get_n_pages': gi.FunctionInfo(get_n_pages, bound=None), 'get_nth_page': gi.FunctionInfo(get_nth_page, bound=None), 'get_scrollable': gi.FunctionInfo(get_scrollable, bound=None), 'get_show_border': gi.FunctionInfo(get_show_border, bound=None), 'get_show_tabs': gi.FunctionInfo(get_show_tabs, bound=None), 'get_tab_detachable': gi.FunctionInfo(get_tab_detachable, bound=None), 'get_tab_hborder': gi.FunctionInfo(get_tab_hborder, bound=None), 'get_tab_label': gi.FunctionInfo(get_tab_label, bound=None), 'get_tab_label_text': gi.FunctionInfo(get_tab_label_text, bound=None), 'get_tab_pos': gi.FunctionInfo(get_tab_pos, bound=None), 'get_tab_reorderable': gi.FunctionInfo(get_tab_reorderable, bound=None), 'get_tab_vborder': gi.FunctionInfo(get_tab_vborder, bound=None), 'insert_page': gi.FunctionInfo(insert_page, bound=None), 'insert_page_menu': gi.FunctionInfo(insert_page_menu, bound=None), 'next_page': gi.FunctionInfo(next_page, bound=None), 'page_num': gi.FunctionInfo(page_num, bound=None), 'popup_disable': gi.FunctionInfo(popup_disable, bound=None), 'popup_enable': gi.FunctionInfo(popup_enable, bound=None), 'prepend_page': gi.FunctionInfo(prepend_page, bound=None), 'prepend_page_menu': gi.FunctionInfo(prepend_page_menu, bound=None), 'prev_page': gi.FunctionInfo(prev_page, bound=None), 'remove_page': gi.FunctionInfo(remove_page, bound=None), 'reorder_child': gi.FunctionInfo(reorder_child, bound=None), 'set_action_widget': gi.FunctionInfo(set_action_widget, bound=None), 'set_current_page': gi.FunctionInfo(set_current_page, bound=None), 'set_group_name': gi.FunctionInfo(set_group_name, bound=None), 'set_menu_label': gi.FunctionInfo(set_menu_label, bound=None), 'set_menu_label_text': gi.FunctionInfo(set_menu_label_text, bound=None), 'set_scrollable': gi.FunctionInfo(set_scrollable, bound=None), 'set_show_border': gi.FunctionInfo(set_show_border, bound=None), 'set_show_tabs': gi.FunctionInfo(set_show_tabs, bound=None), 'set_tab_detachable': gi.FunctionInfo(set_tab_detachable, bound=None), 'set_tab_label': gi.FunctionInfo(set_tab_label, bound=None), 'set_tab_label_text': gi.FunctionInfo(set_tab_label_text, bound=None), 'set_tab_pos': gi.FunctionInfo(set_tab_pos, bound=None), 'set_tab_reorderable': gi.FunctionInfo(set_tab_reorderable, bound=None), 'do_change_current_page': gi.VFuncInfo(change_current_page, bound=None), 'do_focus_tab': gi.VFuncInfo(focus_tab, bound=None), 'do_insert_page': gi.VFuncInfo(insert_page, bound=None), 'do_move_focus_out': gi.VFuncInfo(move_focus_out, bound=None), 'do_page_added': gi.VFuncInfo(page_added, bound=None), 'do_page_removed': gi.VFuncInfo(page_removed, bound=None), 'do_page_reordered': gi.VFuncInfo(page_reordered, bound=None), 'do_reorder_tab': gi.VFuncInfo(reorder_tab, bound=None), 'do_select_page': gi.VFuncInfo(select_page, bound=None), 'do_switch_page': gi.VFuncInfo(switch_page, bound=None), 'container': <property object at 0x000002eceac1f830>, 'priv': <property object at 0x000002eceac1f920>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkNotebook (3867634976)>'
