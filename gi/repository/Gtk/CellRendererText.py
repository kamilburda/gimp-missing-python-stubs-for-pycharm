...
class CellRendererText(CellRenderer):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab04f0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CellRendererText), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCellRendererText (3855512928)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'set_fixed_height_from_font': gi.FunctionInfo(set_fixed_height_from_font, bound=None), 'do_edited': gi.VFuncInfo(edited, bound=None), 'parent': <property object at 0x000002ece9006840>, 'priv': <property object at 0x000002ece9006930>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCellRendererText (3855512928)>'
