...
class RecentFilter(__gi_repository_GObject.InitiallyUnowned, Buildable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece90294b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentFilter), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentFilter (3923958976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'add_age': gi.FunctionInfo(add_age, bound=None), 'add_application': gi.FunctionInfo(add_application, bound=None), 'add_custom': gi.FunctionInfo(add_custom, bound=None), 'add_group': gi.FunctionInfo(add_group, bound=None), 'add_mime_type': gi.FunctionInfo(add_mime_type, bound=None), 'add_pattern': gi.FunctionInfo(add_pattern, bound=None), 'add_pixbuf_formats': gi.FunctionInfo(add_pixbuf_formats, bound=None), 'filter': gi.FunctionInfo(filter, bound=None), 'get_name': gi.FunctionInfo(get_name, bound=None), 'get_needed': gi.FunctionInfo(get_needed, bound=None), 'set_name': gi.FunctionInfo(set_name, bound=None)})"
    __gdoc__ = 'Object GtkRecentFilter\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentFilter (3923958976)>'
