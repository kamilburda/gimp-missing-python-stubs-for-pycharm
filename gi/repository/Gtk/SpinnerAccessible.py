...
class SpinnerAccessible(WidgetAccessible, __gi_repository_Atk.Image):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ecece1e7d0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(SpinnerAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkSpinnerAccessible (3871467264)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece9b9e9d0>, 'priv': <property object at 0x000002ece9b9eac0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkSpinnerAccessible (3871467264)>'
