...
class HeaderBar(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9ffd0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(HeaderBar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkHeaderBar (3871456640)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_custom_title': gi.FunctionInfo(get_custom_title, bound=None), 'get_decoration_layout': gi.FunctionInfo(get_decoration_layout, bound=None), 'get_has_subtitle': gi.FunctionInfo(get_has_subtitle, bound=None), 'get_show_close_button': gi.FunctionInfo(get_show_close_button, bound=None), 'get_subtitle': gi.FunctionInfo(get_subtitle, bound=None), 'get_title': gi.FunctionInfo(get_title, bound=None), 'pack_end': gi.FunctionInfo(pack_end, bound=None), 'pack_start': gi.FunctionInfo(pack_start, bound=None), 'set_custom_title': gi.FunctionInfo(set_custom_title, bound=None), 'set_decoration_layout': gi.FunctionInfo(set_decoration_layout, bound=None), 'set_has_subtitle': gi.FunctionInfo(set_has_subtitle, bound=None), 'set_show_close_button': gi.FunctionInfo(set_show_close_button, bound=None), 'set_subtitle': gi.FunctionInfo(set_subtitle, bound=None), 'set_title': gi.FunctionInfo(set_title, bound=None), 'container': <property object at 0x000002eceabe9760>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkHeaderBar (3871456640)>'
