...
class Invisible(__gi_overrides_Gtk.Widget):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba6500>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Invisible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkInvisible (3871460992)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_for_screen': gi.FunctionInfo(new_for_screen, bound=None), 'get_screen': gi.FunctionInfo(get_screen, bound=None), 'set_screen': gi.FunctionInfo(set_screen, bound=None), 'widget': <property object at 0x000002eceabfd990>, 'priv': <property object at 0x000002eceabfda80>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkInvisible (3871460992)>'
