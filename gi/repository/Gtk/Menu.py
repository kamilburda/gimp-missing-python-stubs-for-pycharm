...
class Menu(Menu):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabab5e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'popup': <function Menu.popup at 0x000002ece8a6e480>, '__doc__': None, '__gsignals__': {}})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenu (3860390736)>'
