...
class MenuButtonAccessible(ToggleButtonAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba8820>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(MenuButtonAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkMenuButtonAccessible (3867895664)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac11a30>, 'priv': <property object at 0x000002eceac11b20>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkMenuButtonAccessible (3867895664)>'
