...
class VScale(Scale):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VScale), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVScale (3922115072)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_range': gi.FunctionInfo(new_with_range, bound=None), 'scale': <property object at 0x000002ece9b4e1b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVScale (3922115072)>'
