...
class RecentAction(__gi_overrides_Gtk.Action, RecentChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceababbb0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RecentAction), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRecentAction (3923956512)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_for_manager': gi.FunctionInfo(new_for_manager, bound=None), 'get_show_numbers': gi.FunctionInfo(get_show_numbers, bound=None), 'set_show_numbers': gi.FunctionInfo(set_show_numbers, bound=None), 'parent_instance': <property object at 0x000002eceac506d0>, 'priv': <property object at 0x000002eceac507c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRecentAction (3923956512)>'
