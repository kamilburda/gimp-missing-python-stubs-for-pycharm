...
class ApplicationWindow(__gi_overrides_Gtk.Window, __gi_repository_Gio.ActionGroup, __gi_overrides_Gio.ActionMap):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab48b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ApplicationWindow), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkApplicationWindow (3922120832)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_help_overlay': gi.FunctionInfo(get_help_overlay, bound=None), 'get_id': gi.FunctionInfo(get_id, bound=None), 'get_show_menubar': gi.FunctionInfo(get_show_menubar, bound=None), 'set_help_overlay': gi.FunctionInfo(set_help_overlay, bound=None), 'set_show_menubar': gi.FunctionInfo(set_show_menubar, bound=None), 'parent_instance': <property object at 0x000002ece8fc0220>, 'priv': <property object at 0x000002ece8fc0310>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkApplicationWindow (3922120832)>'
