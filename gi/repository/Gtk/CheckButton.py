...
class CheckButton(ToggleButton):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab9090>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(CheckButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkCheckButton (3855854976)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_label': gi.FunctionInfo(new_with_label, bound=None), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic, bound=None), 'do_draw_indicator': gi.VFuncInfo(draw_indicator, bound=None), 'toggle_button': <property object at 0x000002eceab88680>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkCheckButton (3855854976)>'
