...
class FontSelection(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab3760>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(FontSelection), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkFontSelection (3922099664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_face': gi.FunctionInfo(get_face, bound=None), 'get_face_list': gi.FunctionInfo(get_face_list, bound=None), 'get_family': gi.FunctionInfo(get_family, bound=None), 'get_family_list': gi.FunctionInfo(get_family_list, bound=None), 'get_font_name': gi.FunctionInfo(get_font_name, bound=None), 'get_preview_entry': gi.FunctionInfo(get_preview_entry, bound=None), 'get_preview_text': gi.FunctionInfo(get_preview_text, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'get_size_entry': gi.FunctionInfo(get_size_entry, bound=None), 'get_size_list': gi.FunctionInfo(get_size_list, bound=None), 'set_font_name': gi.FunctionInfo(set_font_name, bound=None), 'set_preview_text': gi.FunctionInfo(set_preview_text, bound=None), 'parent_instance': <property object at 0x000002eceabd7830>, 'priv': <property object at 0x000002eceabd7920>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkFontSelection (3922099664)>'
