...
class ImageMenuItem(__gi_overrides_Gtk.MenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceaba1ba0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkImageMenuItem (3922097792)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_stock': gi.FunctionInfo(new_from_stock, bound=None), 'new_with_label': gi.FunctionInfo(new_with_label, bound=None), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic, bound=None), 'get_always_show_image': gi.FunctionInfo(get_always_show_image, bound=None), 'get_image': gi.FunctionInfo(get_image, bound=None), 'get_use_stock': gi.FunctionInfo(get_use_stock, bound=None), 'set_accel_group': gi.FunctionInfo(set_accel_group, bound=None), 'set_always_show_image': gi.FunctionInfo(set_always_show_image, bound=None), 'set_image': gi.FunctionInfo(set_image, bound=None), 'set_use_stock': gi.FunctionInfo(set_use_stock, bound=None), 'menu_item': <property object at 0x000002eceabfc4f0>, 'priv': <property object at 0x000002eceabfc5e0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkImageMenuItem (3922097792)>'
