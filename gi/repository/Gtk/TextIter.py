...
class TextIter(TextIter):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.overrides.Gtk', 'forward_search': <function strip_boolean_result.<locals>.wrapped at 0x000002ece8a78040>, 'backward_search': <function strip_boolean_result.<locals>.wrapped at 0x000002ece8a780e0>, '__doc__': None})"
    __gtype__ = None # (!) real value is '<GType GtkTextIter (3867801552)>'
