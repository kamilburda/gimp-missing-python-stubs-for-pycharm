...
class Scrollbar(Range):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9c250>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Scrollbar), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScrollbar (3860580528)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'range': <property object at 0x000002ece8a64ef0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScrollbar (3860580528)>'
