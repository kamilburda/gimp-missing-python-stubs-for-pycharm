...
class VBox(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9028550>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(VBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkVBox (3922112048)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'box': <property object at 0x000002ece9b4d940>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkVBox (3922112048)>'
