...
class ListBox(__gi_overrides_Gtk.Container):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abb8b0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ListBox), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkListBox (3871456896)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'bind_model': gi.FunctionInfo(bind_model, bound=None), 'drag_highlight_row': gi.FunctionInfo(drag_highlight_row, bound=None), 'drag_unhighlight_row': gi.FunctionInfo(drag_unhighlight_row, bound=None), 'get_activate_on_single_click': gi.FunctionInfo(get_activate_on_single_click, bound=None), 'get_adjustment': gi.FunctionInfo(get_adjustment, bound=None), 'get_row_at_index': gi.FunctionInfo(get_row_at_index, bound=None), 'get_row_at_y': gi.FunctionInfo(get_row_at_y, bound=None), 'get_selected_row': gi.FunctionInfo(get_selected_row, bound=None), 'get_selected_rows': gi.FunctionInfo(get_selected_rows, bound=None), 'get_selection_mode': gi.FunctionInfo(get_selection_mode, bound=None), 'insert': gi.FunctionInfo(insert, bound=None), 'invalidate_filter': gi.FunctionInfo(invalidate_filter, bound=None), 'invalidate_headers': gi.FunctionInfo(invalidate_headers, bound=None), 'invalidate_sort': gi.FunctionInfo(invalidate_sort, bound=None), 'prepend': gi.FunctionInfo(prepend, bound=None), 'select_all': gi.FunctionInfo(select_all, bound=None), 'select_row': gi.FunctionInfo(select_row, bound=None), 'selected_foreach': gi.FunctionInfo(selected_foreach, bound=None), 'set_activate_on_single_click': gi.FunctionInfo(set_activate_on_single_click, bound=None), 'set_adjustment': gi.FunctionInfo(set_adjustment, bound=None), 'set_filter_func': gi.FunctionInfo(set_filter_func, bound=None), 'set_header_func': gi.FunctionInfo(set_header_func, bound=None), 'set_placeholder': gi.FunctionInfo(set_placeholder, bound=None), 'set_selection_mode': gi.FunctionInfo(set_selection_mode, bound=None), 'set_sort_func': gi.FunctionInfo(set_sort_func, bound=None), 'unselect_all': gi.FunctionInfo(unselect_all, bound=None), 'unselect_row': gi.FunctionInfo(unselect_row, bound=None), 'do_activate_cursor_row': gi.VFuncInfo(activate_cursor_row, bound=None), 'do_move_cursor': gi.VFuncInfo(move_cursor, bound=None), 'do_row_activated': gi.VFuncInfo(row_activated, bound=None), 'do_row_selected': gi.VFuncInfo(row_selected, bound=None), 'do_select_all': gi.VFuncInfo(select_all, bound=None), 'do_selected_rows_changed': gi.VFuncInfo(selected_rows_changed, bound=None), 'do_toggle_cursor_row': gi.VFuncInfo(toggle_cursor_row, bound=None), 'do_unselect_all': gi.VFuncInfo(unselect_all, bound=None), 'parent_instance': <property object at 0x000002eceac09620>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkListBox (3871456896)>'
