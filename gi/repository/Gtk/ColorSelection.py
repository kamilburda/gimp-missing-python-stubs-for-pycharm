...
class ColorSelection(__gi_overrides_Gtk.Box):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9abb3a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ColorSelection), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkColorSelection (3922096784)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'palette_from_string': gi.FunctionInfo(palette_from_string, bound=None), 'palette_to_string': gi.FunctionInfo(palette_to_string, bound=None), 'get_current_alpha': gi.FunctionInfo(get_current_alpha, bound=None), 'get_current_color': gi.FunctionInfo(get_current_color, bound=None), 'get_current_rgba': gi.FunctionInfo(get_current_rgba, bound=None), 'get_has_opacity_control': gi.FunctionInfo(get_has_opacity_control, bound=None), 'get_has_palette': gi.FunctionInfo(get_has_palette, bound=None), 'get_previous_alpha': gi.FunctionInfo(get_previous_alpha, bound=None), 'get_previous_color': gi.FunctionInfo(get_previous_color, bound=None), 'get_previous_rgba': gi.FunctionInfo(get_previous_rgba, bound=None), 'is_adjusting': gi.FunctionInfo(is_adjusting, bound=None), 'set_current_alpha': gi.FunctionInfo(set_current_alpha, bound=None), 'set_current_color': gi.FunctionInfo(set_current_color, bound=None), 'set_current_rgba': gi.FunctionInfo(set_current_rgba, bound=None), 'set_has_opacity_control': gi.FunctionInfo(set_has_opacity_control, bound=None), 'set_has_palette': gi.FunctionInfo(set_has_palette, bound=None), 'set_previous_alpha': gi.FunctionInfo(set_previous_alpha, bound=None), 'set_previous_color': gi.FunctionInfo(set_previous_color, bound=None), 'set_previous_rgba': gi.FunctionInfo(set_previous_rgba, bound=None), 'do_color_changed': gi.VFuncInfo(color_changed, bound=None), 'parent_instance': <property object at 0x000002eceab803b0>, 'private_data': <property object at 0x000002eceab804a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkColorSelection (3922096784)>'
