...
class RadioMenuItem(CheckMenuItem):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabbb460>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioMenuItem), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioMenuItem (3867895984)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_from_widget': gi.FunctionInfo(new_from_widget, bound=None), 'new_with_label': gi.FunctionInfo(new_with_label, bound=None), 'new_with_label_from_widget': gi.FunctionInfo(new_with_label_from_widget, bound=None), 'new_with_mnemonic': gi.FunctionInfo(new_with_mnemonic, bound=None), 'new_with_mnemonic_from_widget': gi.FunctionInfo(new_with_mnemonic_from_widget, bound=None), 'get_group': gi.FunctionInfo(get_group, bound=None), 'join_group': gi.FunctionInfo(join_group, bound=None), 'set_group': gi.FunctionInfo(set_group, bound=None), 'do_group_changed': gi.VFuncInfo(group_changed, bound=None), 'check_menu_item': <property object at 0x000002eceac48180>, 'priv': <property object at 0x000002eceac48270>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioMenuItem (3867895984)>'
