...
class WidgetAccessible(Accessible, __gi_repository_Atk.Component):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece9ab59c0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(WidgetAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkWidgetAccessible (3867627680)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002ece8fc0720>, 'priv': <property object at 0x000002ece8fc0810>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkWidgetAccessible (3867627680)>'
