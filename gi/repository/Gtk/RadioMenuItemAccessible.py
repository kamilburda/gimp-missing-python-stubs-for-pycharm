...
class RadioMenuItemAccessible(CheckMenuItemAccessible):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceabb0610>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(RadioMenuItemAccessible), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkRadioMenuItemAccessible (3867896624)>, '__doc__': None, '__gsignals__': {}, 'parent': <property object at 0x000002eceac483b0>, 'priv': <property object at 0x000002eceac484a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkRadioMenuItemAccessible (3867896624)>'
