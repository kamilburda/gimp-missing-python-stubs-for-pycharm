...
class Scale(Range):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9d420>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Scale), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkScale (3871456512)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'new_with_range': gi.FunctionInfo(new_with_range, bound=None), 'add_mark': gi.FunctionInfo(add_mark, bound=None), 'clear_marks': gi.FunctionInfo(clear_marks, bound=None), 'get_digits': gi.FunctionInfo(get_digits, bound=None), 'get_draw_value': gi.FunctionInfo(get_draw_value, bound=None), 'get_has_origin': gi.FunctionInfo(get_has_origin, bound=None), 'get_layout': gi.FunctionInfo(get_layout, bound=None), 'get_layout_offsets': gi.FunctionInfo(get_layout_offsets, bound=None), 'get_value_pos': gi.FunctionInfo(get_value_pos, bound=None), 'set_digits': gi.FunctionInfo(set_digits, bound=None), 'set_draw_value': gi.FunctionInfo(set_draw_value, bound=None), 'set_has_origin': gi.FunctionInfo(set_has_origin, bound=None), 'set_value_pos': gi.FunctionInfo(set_value_pos, bound=None), 'do_draw_value': gi.VFuncInfo(draw_value, bound=None), 'do_format_value': gi.VFuncInfo(format_value, bound=None), 'do_get_layout_offsets': gi.VFuncInfo(get_layout_offsets, bound=None), 'range': <property object at 0x000002eceabe81d0>, 'priv': <property object at 0x000002eceabe82c0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkScale (3871456512)>'
