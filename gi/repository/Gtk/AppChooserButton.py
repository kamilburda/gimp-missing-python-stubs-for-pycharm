...
class AppChooserButton(__gi_overrides_Gtk.ComboBox, AppChooser):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002ece6daa290>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(AppChooserButton), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkAppChooserButton (3922123712)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'append_custom_item': gi.FunctionInfo(append_custom_item, bound=None), 'append_separator': gi.FunctionInfo(append_separator, bound=None), 'get_heading': gi.FunctionInfo(get_heading, bound=None), 'get_show_default_item': gi.FunctionInfo(get_show_default_item, bound=None), 'get_show_dialog_item': gi.FunctionInfo(get_show_dialog_item, bound=None), 'set_active_custom_item': gi.FunctionInfo(set_active_custom_item, bound=None), 'set_heading': gi.FunctionInfo(set_heading, bound=None), 'set_show_default_item': gi.FunctionInfo(set_show_default_item, bound=None), 'set_show_dialog_item': gi.FunctionInfo(set_show_dialog_item, bound=None), 'do_custom_item_activated': gi.VFuncInfo(custom_item_activated, bound=None), 'parent': <property object at 0x000002ece8fb6890>, 'priv': <property object at 0x000002ece8fb6980>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkAppChooserButton (3922123712)>'
