...
class Layout(__gi_overrides_Gtk.Container, Scrollable):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002eceab9f010>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Layout), '__module__': 'gi.repository.Gtk', '__gtype__': <GType GtkLayout (3871453568)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'get_bin_window': gi.FunctionInfo(get_bin_window, bound=None), 'get_hadjustment': gi.FunctionInfo(get_hadjustment, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'get_vadjustment': gi.FunctionInfo(get_vadjustment, bound=None), 'move': gi.FunctionInfo(move, bound=None), 'put': gi.FunctionInfo(put, bound=None), 'set_hadjustment': gi.FunctionInfo(set_hadjustment, bound=None), 'set_size': gi.FunctionInfo(set_size, bound=None), 'set_vadjustment': gi.FunctionInfo(set_vadjustment, bound=None), 'container': <property object at 0x000002eceabff5b0>, 'priv': <property object at 0x000002eceabff6a0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GtkLayout (3871453568)>'
