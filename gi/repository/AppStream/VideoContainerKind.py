...
class VideoContainerKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <VideoContainerKind.UNKNOWN: 0>, 'MKV': <VideoContainerKind.MKV: 1>, 'WEBM': <VideoContainerKind.WEBM: 2>})"
    __name__ = 'VideoContainerKind'
    __qualname__ = 'VideoContainerKind'
