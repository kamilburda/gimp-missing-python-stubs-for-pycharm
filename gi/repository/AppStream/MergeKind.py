...
class MergeKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <MergeKind.NONE: 0>, 'REPLACE': <MergeKind.REPLACE: 1>, 'APPEND': <MergeKind.APPEND: 2>, 'REMOVE_COMPONENT': <MergeKind.REMOVE_COMPONENT: 3>})"
    __name__ = 'MergeKind'
    __qualname__ = 'MergeKind'
