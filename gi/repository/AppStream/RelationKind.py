...
class RelationKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <RelationKind.UNKNOWN: 0>, 'REQUIRES': <RelationKind.REQUIRES: 1>, 'RECOMMENDS': <RelationKind.RECOMMENDS: 2>, 'SUPPORTS': <RelationKind.SUPPORTS: 3>})"
    __name__ = 'RelationKind'
    __qualname__ = 'RelationKind'
