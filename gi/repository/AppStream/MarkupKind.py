...
class MarkupKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <MarkupKind.UNKNOWN: 0>, 'XML': <MarkupKind.XML: 1>, 'TEXT': <MarkupKind.TEXT: 2>, 'MARKDOWN': <MarkupKind.MARKDOWN: 3>})"
    __name__ = 'MarkupKind'
    __qualname__ = 'MarkupKind'
