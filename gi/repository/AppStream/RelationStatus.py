...
class RelationStatus(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <RelationStatus.UNKNOWN: 0>, 'ERROR': <RelationStatus.ERROR: 1>, 'NOT_SATISFIED': <RelationStatus.NOT_SATISFIED: 2>, 'SATISFIED': <RelationStatus.SATISFIED: 3>})"
    __name__ = 'RelationStatus'
    __qualname__ = 'RelationStatus'
