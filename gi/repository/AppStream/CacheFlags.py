...
class CacheFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <CacheFlags.NONE: 0>, 'USE_USER': <CacheFlags.USE_USER: 1>, 'USE_SYSTEM': <CacheFlags.USE_SYSTEM: 2>, 'NO_CLEAR': <CacheFlags.NO_CLEAR: 4>, 'REFRESH_SYSTEM': <CacheFlags.REFRESH_SYSTEM: 8>})"
    __name__ = 'CacheFlags'
    __qualname__ = 'CacheFlags'
