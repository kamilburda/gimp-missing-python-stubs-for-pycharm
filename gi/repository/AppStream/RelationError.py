...
class RelationError(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FAILED': <RelationError.FAILED: 0>, 'BAD_VALUE': <RelationError.BAD_VALUE: 1>, 'NOT_IMPLEMENTED': <RelationError.NOT_IMPLEMENTED: 2>})"
    __name__ = 'RelationError'
    __qualname__ = 'RelationError'
