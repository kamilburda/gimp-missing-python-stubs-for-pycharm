...
class ScreenshotKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ScreenshotKind.UNKNOWN: 0>, 'DEFAULT': <ScreenshotKind.DEFAULT: 1>, 'EXTRA': <ScreenshotKind.EXTRA: 2>})"
    __name__ = 'ScreenshotKind'
    __qualname__ = 'ScreenshotKind'
