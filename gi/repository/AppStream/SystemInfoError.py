...
class SystemInfoError(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FAILED': <SystemInfoError.FAILED: 0>, 'NOT_FOUND': <SystemInfoError.NOT_FOUND: 1>})"
    __name__ = 'SystemInfoError'
    __qualname__ = 'SystemInfoError'
