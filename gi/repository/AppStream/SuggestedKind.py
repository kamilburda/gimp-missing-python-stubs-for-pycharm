...
class SuggestedKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <SuggestedKind.UNKNOWN: 0>, 'UPSTREAM': <SuggestedKind.UPSTREAM: 1>, 'HEURISTIC': <SuggestedKind.HEURISTIC: 2>})"
    __name__ = 'SuggestedKind'
    __qualname__ = 'SuggestedKind'
