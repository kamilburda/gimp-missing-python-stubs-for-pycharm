...
class DataIdMatchFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <DataIdMatchFlags.NONE: 0>, 'SCOPE': <DataIdMatchFlags.SCOPE: 1>, 'BUNDLE_KIND': <DataIdMatchFlags.BUNDLE_KIND: 2>, 'ORIGIN': <DataIdMatchFlags.ORIGIN: 4>, 'ID': <DataIdMatchFlags.ID: 8>, 'BRANCH': <DataIdMatchFlags.BRANCH: 16>})"
    __name__ = 'DataIdMatchFlags'
    __qualname__ = 'DataIdMatchFlags'
