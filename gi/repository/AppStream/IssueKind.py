...
class IssueKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <IssueKind.UNKNOWN: 0>, 'GENERIC': <IssueKind.GENERIC: 1>, 'CVE': <IssueKind.CVE: 2>})"
    __name__ = 'IssueKind'
    __qualname__ = 'IssueKind'
