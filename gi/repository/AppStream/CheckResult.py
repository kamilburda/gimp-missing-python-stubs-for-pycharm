...
class CheckResult(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'ERROR': <CheckResult.ERROR: 0>, 'UNKNOWN': <CheckResult.UNKNOWN: 1>, 'FALSE': <CheckResult.FALSE: 2>, 'TRUE': <CheckResult.TRUE: 3>})"
    __name__ = 'CheckResult'
    __qualname__ = 'CheckResult'
