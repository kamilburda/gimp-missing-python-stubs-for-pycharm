...
class Release(__gi_overrides_GObject.Object):
    ...
    def set_description(self, description, locale=None): # real signature unknown; restored from __doc__
        """ set_description(self, description:str, locale:str=None) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ecec6ce1a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Release), '__module__': 'gi.repository.AppStream', '__gtype__': <GType AsRelease (3928806688)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'add_artifact': gi.FunctionInfo(add_artifact), 'add_issue': gi.FunctionInfo(add_issue), 'add_tag': gi.FunctionInfo(add_tag), 'clear_tags': gi.FunctionInfo(clear_tags), 'get_artifacts': gi.FunctionInfo(get_artifacts), 'get_context': gi.FunctionInfo(get_context), 'get_date': gi.FunctionInfo(get_date), 'get_date_eol': gi.FunctionInfo(get_date_eol), 'get_description': gi.FunctionInfo(get_description), 'get_issues': gi.FunctionInfo(get_issues), 'get_kind': gi.FunctionInfo(get_kind), 'get_timestamp': gi.FunctionInfo(get_timestamp), 'get_timestamp_eol': gi.FunctionInfo(get_timestamp_eol), 'get_urgency': gi.FunctionInfo(get_urgency), 'get_url': gi.FunctionInfo(get_url), 'get_version': gi.FunctionInfo(get_version), 'has_tag': gi.FunctionInfo(has_tag), 'remove_tag': gi.FunctionInfo(remove_tag), 'set_context': gi.FunctionInfo(set_context), 'set_date': gi.FunctionInfo(set_date), 'set_date_eol': gi.FunctionInfo(set_date_eol), 'set_description': gi.FunctionInfo(set_description), 'set_kind': gi.FunctionInfo(set_kind), 'set_timestamp': gi.FunctionInfo(set_timestamp), 'set_timestamp_eol': gi.FunctionInfo(set_timestamp_eol), 'set_urgency': gi.FunctionInfo(set_urgency), 'set_url': gi.FunctionInfo(set_url), 'set_version': gi.FunctionInfo(set_version), 'vercmp': gi.FunctionInfo(vercmp), 'parent_instance': <property object at 0x000001ececbd1850>})"
    __gdoc__ = 'Object AsRelease\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AsRelease (3928806688)>'
