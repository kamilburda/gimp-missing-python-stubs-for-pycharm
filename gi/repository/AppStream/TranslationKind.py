...
class TranslationKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <TranslationKind.UNKNOWN: 0>, 'GETTEXT': <TranslationKind.GETTEXT: 1>, 'QT': <TranslationKind.QT: 2>})"
    __name__ = 'TranslationKind'
    __qualname__ = 'TranslationKind'
