...
class ComponentBoxFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ComponentBoxFlags.NONE: 0>, 'NO_CHECKS': <ComponentBoxFlags.NO_CHECKS: 1>})"
    __name__ = 'ComponentBoxFlags'
    __qualname__ = 'ComponentBoxFlags'
