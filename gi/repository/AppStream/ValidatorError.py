...
class ValidatorError(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FAILED': <ValidatorError.FAILED: 0>, 'INVALID_OVERRIDE': <ValidatorError.INVALID_OVERRIDE: 1>, 'INVALID_FILENAME': <ValidatorError.INVALID_FILENAME: 2>})"
    __name__ = 'ValidatorError'
    __qualname__ = 'ValidatorError'
