...
class FormatStyle(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <FormatStyle.UNKNOWN: 0>, 'METAINFO': <FormatStyle.METAINFO: 1>, 'CATALOG': <FormatStyle.CATALOG: 2>})"
    __name__ = 'FormatStyle'
    __qualname__ = 'FormatStyle'
