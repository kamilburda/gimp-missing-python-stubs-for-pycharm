...
class Image(__gi_overrides_GObject.Object):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001ecec6c3280>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Image), '__module__': 'gi.repository.AppStream', '__gtype__': <GType AsImage (3928804000)>, '__doc__': None, '__gsignals__': {}, 'new': <classmethod(gi.FunctionInfo(new))>, 'get_height': gi.FunctionInfo(get_height), 'get_kind': gi.FunctionInfo(get_kind), 'get_locale': gi.FunctionInfo(get_locale), 'get_scale': gi.FunctionInfo(get_scale), 'get_url': gi.FunctionInfo(get_url), 'get_width': gi.FunctionInfo(get_width), 'set_height': gi.FunctionInfo(set_height), 'set_kind': gi.FunctionInfo(set_kind), 'set_locale': gi.FunctionInfo(set_locale), 'set_scale': gi.FunctionInfo(set_scale), 'set_url': gi.FunctionInfo(set_url), 'set_width': gi.FunctionInfo(set_width), 'parent_instance': <property object at 0x000001ecec6d4360>})"
    __gdoc__ = 'Object AsImage\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AsImage (3928804000)>'
