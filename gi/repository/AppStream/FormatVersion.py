...
class FormatVersion(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <FormatVersion.UNKNOWN: 0>, 'V1_0': <FormatVersion.V1_0: 1>})"
    __name__ = 'FormatVersion'
    __qualname__ = 'FormatVersion'
