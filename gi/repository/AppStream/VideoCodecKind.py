...
class VideoCodecKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <VideoCodecKind.UNKNOWN: 0>, 'VP9': <VideoCodecKind.VP9: 1>, 'AV1': <VideoCodecKind.AV1: 2>})"
    __name__ = 'VideoCodecKind'
    __qualname__ = 'VideoCodecKind'
