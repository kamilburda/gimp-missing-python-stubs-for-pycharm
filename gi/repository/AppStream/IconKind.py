...
class IconKind(__gi__gi.GEnum):
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <IconKind.UNKNOWN: 0>, 'STOCK': <IconKind.STOCK: 1>, 'CACHED': <IconKind.CACHED: 2>, 'LOCAL': <IconKind.LOCAL: 3>, 'REMOTE': <IconKind.REMOTE: 4>})"
    __name__ = 'IconKind'
    __qualname__ = 'IconKind'
