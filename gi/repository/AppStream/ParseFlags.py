...
class ParseFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ParseFlags.NONE: 0>, 'IGNORE_MEDIABASEURL': <ParseFlags.IGNORE_MEDIABASEURL: 1>})"
    __name__ = 'ParseFlags'
    __qualname__ = 'ParseFlags'
