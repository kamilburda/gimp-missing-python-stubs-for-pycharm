...
class PoolError(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'FAILED': <PoolError.FAILED: 0>, 'INCOMPLETE': <PoolError.INCOMPLETE: 1>, 'COLLISION': <PoolError.COLLISION: 2>, 'CACHE_WRITE_FAILED': <PoolError.CACHE_WRITE_FAILED: 3>, 'CACHE_DAMAGED': <PoolError.CACHE_DAMAGED: 4>})"
    __name__ = 'PoolError'
    __qualname__ = 'PoolError'
