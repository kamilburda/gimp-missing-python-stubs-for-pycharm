...
class SizeKind(__gi__gi.GEnum):
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <SizeKind.UNKNOWN: 0>, 'DOWNLOAD': <SizeKind.DOWNLOAD: 1>, 'INSTALLED': <SizeKind.INSTALLED: 2>})"
    __name__ = 'SizeKind'
    __qualname__ = 'SizeKind'
