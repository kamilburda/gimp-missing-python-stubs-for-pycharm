...
class DisplaySideKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <DisplaySideKind.UNKNOWN: 0>, 'SHORTEST': <DisplaySideKind.SHORTEST: 1>, 'LONGEST': <DisplaySideKind.LONGEST: 2>})"
    __name__ = 'DisplaySideKind'
    __qualname__ = 'DisplaySideKind'
