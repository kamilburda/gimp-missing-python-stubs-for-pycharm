...
class ColorKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ColorKind.UNKNOWN: 0>, 'PRIMARY': <ColorKind.PRIMARY: 1>})"
    __name__ = 'ColorKind'
    __qualname__ = 'ColorKind'
