...
class InternetKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <InternetKind.UNKNOWN: 0>, 'ALWAYS': <InternetKind.ALWAYS: 1>, 'OFFLINE_ONLY': <InternetKind.OFFLINE_ONLY: 2>, 'FIRST_RUN': <InternetKind.FIRST_RUN: 3>})"
    __name__ = 'InternetKind'
    __qualname__ = 'InternetKind'
