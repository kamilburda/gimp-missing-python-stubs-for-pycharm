...
class ArtifactKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ArtifactKind.UNKNOWN: 0>, 'SOURCE': <ArtifactKind.SOURCE: 1>, 'BINARY': <ArtifactKind.BINARY: 2>})"
    __name__ = 'ArtifactKind'
    __qualname__ = 'ArtifactKind'
