...
class ReleaseUrlKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ReleaseUrlKind.UNKNOWN: 0>, 'DETAILS': <ReleaseUrlKind.DETAILS: 1>})"
    __name__ = 'ReleaseUrlKind'
    __qualname__ = 'ReleaseUrlKind'
