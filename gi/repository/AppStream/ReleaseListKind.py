...
class ReleaseListKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ReleaseListKind.UNKNOWN: 0>, 'EMBEDDED': <ReleaseListKind.EMBEDDED: 1>, 'EXTERNAL': <ReleaseListKind.EXTERNAL: 2>})"
    __name__ = 'ReleaseListKind'
    __qualname__ = 'ReleaseListKind'
