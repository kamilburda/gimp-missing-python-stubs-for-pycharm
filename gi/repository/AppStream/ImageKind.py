...
class ImageKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ImageKind.UNKNOWN: 0>, 'SOURCE': <ImageKind.SOURCE: 1>, 'THUMBNAIL': <ImageKind.THUMBNAIL: 2>})"
    __name__ = 'ImageKind'
    __qualname__ = 'ImageKind'
