...
class ScreenshotMediaKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ScreenshotMediaKind.UNKNOWN: 0>, 'IMAGE': <ScreenshotMediaKind.IMAGE: 1>, 'VIDEO': <ScreenshotMediaKind.VIDEO: 2>})"
    __name__ = 'ScreenshotMediaKind'
    __qualname__ = 'ScreenshotMediaKind'
