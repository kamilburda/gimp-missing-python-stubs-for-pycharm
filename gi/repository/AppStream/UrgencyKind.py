...
class UrgencyKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <UrgencyKind.UNKNOWN: 0>, 'LOW': <UrgencyKind.LOW: 1>, 'MEDIUM': <UrgencyKind.MEDIUM: 2>, 'HIGH': <UrgencyKind.HIGH: 3>, 'CRITICAL': <UrgencyKind.CRITICAL: 4>})"
    __name__ = 'UrgencyKind'
    __qualname__ = 'UrgencyKind'
