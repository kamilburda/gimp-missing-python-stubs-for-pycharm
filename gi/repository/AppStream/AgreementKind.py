...
class AgreementKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <AgreementKind.UNKNOWN: 0>, 'GENERIC': <AgreementKind.GENERIC: 1>, 'EULA': <AgreementKind.EULA: 2>, 'PRIVACY': <AgreementKind.PRIVACY: 3>})"
    __name__ = 'AgreementKind'
    __qualname__ = 'AgreementKind'
