...
class PoolFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <PoolFlags.NONE: 0>, 'LOAD_OS_CATALOG': <PoolFlags.LOAD_OS_CATALOG: 1>, 'LOAD_OS_METAINFO': <PoolFlags.LOAD_OS_METAINFO: 2>, 'LOAD_OS_DESKTOP_FILES': <PoolFlags.LOAD_OS_DESKTOP_FILES: 4>, 'LOAD_FLATPAK': <PoolFlags.LOAD_FLATPAK: 8>, 'IGNORE_CACHE_AGE': <PoolFlags.IGNORE_CACHE_AGE: 16>, 'RESOLVE_ADDONS': <PoolFlags.RESOLVE_ADDONS: 32>, 'PREFER_OS_METAINFO': <PoolFlags.PREFER_OS_METAINFO: 64>, 'MONITOR': <PoolFlags.MONITOR: 128>})"
    __name__ = 'PoolFlags'
    __qualname__ = 'PoolFlags'
