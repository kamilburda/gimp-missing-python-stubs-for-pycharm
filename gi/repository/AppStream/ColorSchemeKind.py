...
class ColorSchemeKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ColorSchemeKind.UNKNOWN: 0>, 'LIGHT': <ColorSchemeKind.LIGHT: 1>, 'DARK': <ColorSchemeKind.DARK: 2>})"
    __name__ = 'ColorSchemeKind'
    __qualname__ = 'ColorSchemeKind'
