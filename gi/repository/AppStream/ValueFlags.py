...
class ValueFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ValueFlags.NONE: 0>, 'DUPLICATE_CHECK': <ValueFlags.DUPLICATE_CHECK: 1>, 'NO_TRANSLATION_FALLBACK': <ValueFlags.NO_TRANSLATION_FALLBACK: 2>})"
    __name__ = 'ValueFlags'
    __qualname__ = 'ValueFlags'
