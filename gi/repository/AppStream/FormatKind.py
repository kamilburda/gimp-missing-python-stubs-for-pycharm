...
class FormatKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <FormatKind.UNKNOWN: 0>, 'XML': <FormatKind.XML: 1>, 'YAML': <FormatKind.YAML: 2>, 'DESKTOP_ENTRY': <FormatKind.DESKTOP_ENTRY: 3>})"
    __name__ = 'FormatKind'
    __qualname__ = 'FormatKind'
