...
class VercmpFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <VercmpFlags.NONE: 0>, 'IGNORE_EPOCH': <VercmpFlags.IGNORE_EPOCH: 1>})"
    __name__ = 'VercmpFlags'
    __qualname__ = 'VercmpFlags'
