...
class ReferenceKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ReferenceKind.UNKNOWN: 0>, 'DOI': <ReferenceKind.DOI: 1>, 'CITATION_CFF': <ReferenceKind.CITATION_CFF: 2>, 'REGISTRY': <ReferenceKind.REGISTRY: 3>})"
    __name__ = 'ReferenceKind'
    __qualname__ = 'ReferenceKind'
