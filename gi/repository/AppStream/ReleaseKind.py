...
class ReleaseKind(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ReleaseKind.UNKNOWN: 0>, 'STABLE': <ReleaseKind.STABLE: 1>, 'DEVELOPMENT': <ReleaseKind.DEVELOPMENT: 2>, 'SNAPSHOT': <ReleaseKind.SNAPSHOT: 3>})"
    __name__ = 'ReleaseKind'
    __qualname__ = 'ReleaseKind'
