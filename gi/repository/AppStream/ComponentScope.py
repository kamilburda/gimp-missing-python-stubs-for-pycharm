...
class ComponentScope(__gi__gi.GEnum):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'UNKNOWN': <ComponentScope.UNKNOWN: 0>, 'SYSTEM': <ComponentScope.SYSTEM: 1>, 'USER': <ComponentScope.USER: 2>})"
    __name__ = 'ComponentScope'
    __qualname__ = 'ComponentScope'
