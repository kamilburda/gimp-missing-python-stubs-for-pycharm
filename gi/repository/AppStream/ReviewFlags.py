...
class ReviewFlags(__gi__gi.GFlags):
    # no doc
    ...
    __members__ = None # (!) real value is "mappingproxy({'NONE': <ReviewFlags.NONE: 0>, 'SELF': <ReviewFlags.SELF: 1>, 'VOTED': <ReviewFlags.VOTED: 2>})"
    __name__ = 'ReviewFlags'
    __qualname__ = 'ReviewFlags'
