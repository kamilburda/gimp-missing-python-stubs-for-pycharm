...
class List(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(List), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'List' objects>, '__weakref__': <attribute '__weakref__' of 'List' objects>, '__doc__': None, 'data': <property object at 0x000002830bf16750>, 'next': <property object at 0x000002830bf16840>, 'prev': <property object at 0x000002830bf16930>, 'pop_allocator': gi.FunctionInfo(pop_allocator, bound=None), 'push_allocator': gi.FunctionInfo(push_allocator, bound=None)})"
