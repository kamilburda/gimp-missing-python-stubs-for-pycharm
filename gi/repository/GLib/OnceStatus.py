...
class OnceStatus(__gobject.GEnum):
    ...
    READY = 2
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GLib', '__dict__': <attribute '__dict__' of 'OnceStatus' objects>, '__doc__': None, '__gtype__': <GType PyGLibOnceStatus (163504320)>, '__enum_values__': {0: <enum G_ONCE_STATUS_NOTCALLED of type GLib.OnceStatus>, 1: <enum G_ONCE_STATUS_PROGRESS of type GLib.OnceStatus>, 2: <enum G_ONCE_STATUS_READY of type GLib.OnceStatus>}, '__info__': gi.EnumInfo(OnceStatus), 'NOTCALLED': <enum G_ONCE_STATUS_NOTCALLED of type GLib.OnceStatus>, 'PROGRESS': <enum G_ONCE_STATUS_PROGRESS of type GLib.OnceStatus>, 'READY': <enum G_ONCE_STATUS_READY of type GLib.OnceStatus>})"
    __enum_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType PyGLibOnceStatus (163504320)>'
