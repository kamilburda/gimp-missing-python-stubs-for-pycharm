...
class SList(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(SList), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'SList' objects>, '__weakref__': <attribute '__weakref__' of 'SList' objects>, '__doc__': None, 'data': <property object at 0x000002830bef6430>, 'next': <property object at 0x000002830bef6520>, 'pop_allocator': gi.FunctionInfo(pop_allocator, bound=None), 'push_allocator': gi.FunctionInfo(push_allocator, bound=None)})"
