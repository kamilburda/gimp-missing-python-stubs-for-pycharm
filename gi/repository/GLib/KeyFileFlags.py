...
class KeyFileFlags(__gobject.GFlags):
    ...
    NONE = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.GLib', '__dict__': <attribute '__dict__' of 'KeyFileFlags' objects>, '__doc__': None, '__gtype__': <GType PyGLibKeyFileFlags (163506224)>, '__flags_values__': {0: <flags 0 of type GLib.KeyFileFlags>, 1: <flags G_KEY_FILE_KEEP_COMMENTS of type GLib.KeyFileFlags>, 2: <flags G_KEY_FILE_KEEP_TRANSLATIONS of type GLib.KeyFileFlags>}, '__info__': gi.EnumInfo(KeyFileFlags), 'NONE': <flags 0 of type GLib.KeyFileFlags>, 'KEEP_COMMENTS': <flags G_KEY_FILE_KEEP_COMMENTS of type GLib.KeyFileFlags>, 'KEEP_TRANSLATIONS': <flags G_KEY_FILE_KEEP_TRANSLATIONS of type GLib.KeyFileFlags>})"
    __flags_values__ = {
        0: 0,
        1: 1,
        2: 2,
    }
    __gtype__ = None # (!) real value is '<GType PyGLibKeyFileFlags (163506224)>'
