...
class Mutex(__gi.Struct):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': gi.UnionInfo(Mutex), '__module__': 'gi.repository.GLib', '__gtype__': <GType void (4)>, '__dict__': <attribute '__dict__' of 'Mutex' objects>, '__weakref__': <attribute '__weakref__' of 'Mutex' objects>, '__doc__': None, 'p': <property object at 0x000002830bf17bf0>, 'i': <property object at 0x000002830bf17ce0>, 'clear': gi.FunctionInfo(clear, bound=None), 'init': gi.FunctionInfo(init, bound=None), 'lock': gi.FunctionInfo(lock, bound=None), 'trylock': gi.FunctionInfo(trylock, bound=None), 'unlock': gi.FunctionInfo(unlock, bound=None)})"
