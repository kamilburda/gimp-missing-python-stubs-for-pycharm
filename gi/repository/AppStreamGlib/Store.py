...
class Store(__gi_overrides_GObject.Object):
    ...
    def set_version(self, api_version): # real signature unknown; restored from __doc__
        """ set_version(self, api_version:str) """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001afbef6abf0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Store), '__module__': 'gi.repository.AppStreamGlib', '__gtype__': <GType AsStore (3157399664)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'error_quark': gi.FunctionInfo(error_quark, bound=None), 'add_app': gi.FunctionInfo(add_app, bound=None), 'add_apps': gi.FunctionInfo(add_apps, bound=None), 'add_filter': gi.FunctionInfo(add_filter, bound=None), 'add_metadata_index': gi.FunctionInfo(add_metadata_index, bound=None), 'convert_icons': gi.FunctionInfo(convert_icons, bound=None), 'dup_apps': gi.FunctionInfo(dup_apps, bound=None), 'dup_apps_by_id_merge': gi.FunctionInfo(dup_apps_by_id_merge, bound=None), 'from_bytes': gi.FunctionInfo(from_bytes, bound=None), 'from_file': gi.FunctionInfo(from_file, bound=None), 'from_xml': gi.FunctionInfo(from_xml, bound=None), 'get_add_flags': gi.FunctionInfo(get_add_flags, bound=None), 'get_api_version': gi.FunctionInfo(get_api_version, bound=None), 'get_app_by_id': gi.FunctionInfo(get_app_by_id, bound=None), 'get_app_by_id_ignore_prefix': gi.FunctionInfo(get_app_by_id_ignore_prefix, bound=None), 'get_app_by_id_with_fallbacks': gi.FunctionInfo(get_app_by_id_with_fallbacks, bound=None), 'get_app_by_launchable': gi.FunctionInfo(get_app_by_launchable, bound=None), 'get_app_by_pkgname': gi.FunctionInfo(get_app_by_pkgname, bound=None), 'get_app_by_pkgnames': gi.FunctionInfo(get_app_by_pkgnames, bound=None), 'get_app_by_provide': gi.FunctionInfo(get_app_by_provide, bound=None), 'get_app_by_unique_id': gi.FunctionInfo(get_app_by_unique_id, bound=None), 'get_apps': gi.FunctionInfo(get_apps, bound=None), 'get_apps_by_id': gi.FunctionInfo(get_apps_by_id, bound=None), 'get_apps_by_id_merge': gi.FunctionInfo(get_apps_by_id_merge, bound=None), 'get_apps_by_metadata': gi.FunctionInfo(get_apps_by_metadata, bound=None), 'get_apps_by_provide': gi.FunctionInfo(get_apps_by_provide, bound=None), 'get_builder_id': gi.FunctionInfo(get_builder_id, bound=None), 'get_destdir': gi.FunctionInfo(get_destdir, bound=None), 'get_origin': gi.FunctionInfo(get_origin, bound=None), 'get_search_match': gi.FunctionInfo(get_search_match, bound=None), 'get_size': gi.FunctionInfo(get_size, bound=None), 'get_version': gi.FunctionInfo(get_version, bound=None), 'get_watch_flags': gi.FunctionInfo(get_watch_flags, bound=None), 'load': gi.FunctionInfo(load, bound=None), 'load_async': gi.FunctionInfo(load_async, bound=None), 'load_finish': gi.FunctionInfo(load_finish, bound=None), 'load_path': gi.FunctionInfo(load_path, bound=None), 'load_path_async': gi.FunctionInfo(load_path_async, bound=None), 'load_path_finish': gi.FunctionInfo(load_path_finish, bound=None), 'load_search_cache': gi.FunctionInfo(load_search_cache, bound=None), 'remove_all': gi.FunctionInfo(remove_all, bound=None), 'remove_app': gi.FunctionInfo(remove_app, bound=None), 'remove_app_by_id': gi.FunctionInfo(remove_app_by_id, bound=None), 'remove_apps_with_veto': gi.FunctionInfo(remove_apps_with_veto, bound=None), 'remove_filter': gi.FunctionInfo(remove_filter, bound=None), 'set_add_flags': gi.FunctionInfo(set_add_flags, bound=None), 'set_api_version': gi.FunctionInfo(set_api_version, bound=None), 'set_builder_id': gi.FunctionInfo(set_builder_id, bound=None), 'set_destdir': gi.FunctionInfo(set_destdir, bound=None), 'set_origin': gi.FunctionInfo(set_origin, bound=None), 'set_search_match': gi.FunctionInfo(set_search_match, bound=None), 'set_version': gi.FunctionInfo(set_version, bound=None), 'set_watch_flags': gi.FunctionInfo(set_watch_flags, bound=None), 'to_file': gi.FunctionInfo(to_file, bound=None), 'to_xml': gi.FunctionInfo(to_xml, bound=None), 'validate': gi.FunctionInfo(validate, bound=None), 'do_app_added': gi.VFuncInfo(app_added, bound=None), 'do_app_changed': gi.VFuncInfo(app_changed, bound=None), 'do_app_removed': gi.VFuncInfo(app_removed, bound=None), 'do_changed': gi.VFuncInfo(changed, bound=None), 'parent_instance': <property object at 0x000001afbef1a340>})"
    __gdoc__ = 'Object AsStore\n\nSignals from AsStore:\n  changed ()\n  app-added (AsApp)\n  app-removed (AsApp)\n  app-changed (AsApp)\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType AsStore (3157399664)>'
