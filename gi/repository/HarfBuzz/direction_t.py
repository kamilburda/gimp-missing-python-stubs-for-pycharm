...
class direction_t(__gobject.GEnum):
    ...
    TTB = 6
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.HarfBuzz', '__dict__': <attribute '__dict__' of 'direction_t' objects>, '__doc__': None, '__gtype__': <GType PyHarfBuzzdirection_t (2667611024)>, '__enum_values__': {0: <enum HB_DIRECTION_INVALID of type HarfBuzz.direction_t>, 4: <enum HB_DIRECTION_LTR of type HarfBuzz.direction_t>, 5: <enum HB_DIRECTION_RTL of type HarfBuzz.direction_t>, 6: <enum HB_DIRECTION_TTB of type HarfBuzz.direction_t>, 7: <enum HB_DIRECTION_BTT of type HarfBuzz.direction_t>}, '__info__': gi.EnumInfo(direction_t), 'INVALID': <enum HB_DIRECTION_INVALID of type HarfBuzz.direction_t>, 'LTR': <enum HB_DIRECTION_LTR of type HarfBuzz.direction_t>, 'RTL': <enum HB_DIRECTION_RTL of type HarfBuzz.direction_t>, 'TTB': <enum HB_DIRECTION_TTB of type HarfBuzz.direction_t>, 'BTT': <enum HB_DIRECTION_BTT of type HarfBuzz.direction_t>})"
    __enum_values__ = {
        0: 0,
        4: 4,
        5: 5,
    ...
    __gtype__ = None # (!) real value is '<GType PyHarfBuzzdirection_t (2667611024)>'
