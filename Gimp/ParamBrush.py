...
class ParamBrush(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamBrush), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamBrush (1066927536)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamBrush (1066927536)>'
