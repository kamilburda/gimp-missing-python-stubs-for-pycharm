...
class ParamPattern(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPattern), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamPattern (3644680080)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamPattern (3644680080)>'
