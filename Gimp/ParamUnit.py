...
class ParamUnit(ParamObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamUnit), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamUnit (3644683152)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamUnit (3644683152)>'
