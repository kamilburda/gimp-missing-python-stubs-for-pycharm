...
class TransformDirection(__gobject.GEnum):
    ...
    FORWARD = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gimp', '__dict__': <attribute '__dict__' of 'TransformDirection' objects>, '__doc__': None, '__gtype__': <GType GimpTransformDirection (3595425936)>, '__enum_values__': {0: <enum GIMP_TRANSFORM_FORWARD of type Gimp.TransformDirection>, 1: <enum GIMP_TRANSFORM_BACKWARD of type Gimp.TransformDirection>}, '__info__': gi.EnumInfo(TransformDirection), 'FORWARD': <enum GIMP_TRANSFORM_FORWARD of type Gimp.TransformDirection>, 'BACKWARD': <enum GIMP_TRANSFORM_BACKWARD of type Gimp.TransformDirection>})"
    __enum_values__ = {
        0: 0,
        1: 1,
    }
    __gtype__ = None # (!) real value is '<GType GimpTransformDirection (3595425936)>'
