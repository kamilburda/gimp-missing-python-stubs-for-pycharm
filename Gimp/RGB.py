...
class RGB(__gi.Boxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': StructInfo(RGB), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpRGB (770689168)>, '__dict__': <attribute '__dict__' of 'RGB' objects>, '__weakref__': <attribute '__weakref__' of 'RGB' objects>, '__doc__': None, 'r': <property object at 0x000001e82e328310>, 'g': <property object at 0x000001e82e328400>, 'b': <property object at 0x000001e82e3284f0>, 'a': <property object at 0x000001e82e3285e0>, '_add': gi.FunctionInfo(_add, bound=None), '_distance': gi.FunctionInfo(_distance, bound=None), '_get_pixel': gi.FunctionInfo(_get_pixel, bound=None), '_get_uchar': gi.FunctionInfo(_get_uchar, bound=None), '_multiply': gi.FunctionInfo(_multiply, bound=None), '_parse_css': gi.FunctionInfo(_parse_css, bound=None), '_set': gi.FunctionInfo(_set, bound=None), '_set_pixel': gi.FunctionInfo(_set_pixel, bound=None), '_set_uchar': gi.FunctionInfo(_set_uchar, bound=None), '_subtract': gi.FunctionInfo(_subtract, bound=None), 'add': gi.FunctionInfo(add, bound=None), 'clamp': gi.FunctionInfo(clamp, bound=None), 'composite': gi.FunctionInfo(composite, bound=None), 'distance': gi.FunctionInfo(distance, bound=None), 'gamma': gi.FunctionInfo(gamma, bound=None), 'get_pixel': gi.FunctionInfo(get_pixel, bound=None), 'get_uchar': gi.FunctionInfo(get_uchar, bound=None), 'luminance': gi.FunctionInfo(luminance, bound=None), 'luminance_uchar': gi.FunctionInfo(luminance_uchar, bound=None), 'max': gi.FunctionInfo(max, bound=None), 'min': gi.FunctionInfo(min, bound=None), 'multiply': gi.FunctionInfo(multiply, bound=None), 'parse_css': gi.FunctionInfo(parse_css, bound=None), 'parse_hex': gi.FunctionInfo(parse_hex, bound=None), 'parse_name': gi.FunctionInfo(parse_name, bound=None), 'set': gi.FunctionInfo(set, bound=None), 'set_alpha': gi.FunctionInfo(set_alpha, bound=None), 'set_pixel': gi.FunctionInfo(set_pixel, bound=None), 'set_uchar': gi.FunctionInfo(set_uchar, bound=None), 'subtract': gi.FunctionInfo(subtract, bound=None), 'to_cmyk': gi.FunctionInfo(to_cmyk, bound=None), 'to_hsl': gi.FunctionInfo(to_hsl, bound=None), 'to_hsv': gi.FunctionInfo(to_hsv, bound=None), 'list_names': gi.FunctionInfo(list_names, bound=None)})"
    __gtype__ = None # (!) real value is '<GType GimpRGB (770689168)>'
