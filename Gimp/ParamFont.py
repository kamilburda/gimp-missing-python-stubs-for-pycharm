...
class ParamFont(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFont), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamFont (770748912)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamFont (770748912)>'
