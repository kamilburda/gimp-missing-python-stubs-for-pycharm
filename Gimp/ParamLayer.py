...
class ParamLayer(ParamDrawable):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamLayer (1066932016)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamLayer (1066932016)>'
