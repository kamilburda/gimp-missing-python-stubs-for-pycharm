...
class ParamItem(__gi_repository_GObject.ParamSpecObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamItem), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamItem (815080976)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamItem (815080976)>'
