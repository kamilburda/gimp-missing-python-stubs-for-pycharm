...
class HSV(__gi.Boxed):
    ...
    def set(self, hue, saturation, value): # real signature unknown; restored from __doc__
        """ set(self, hue:float, saturation:float, value:float) """
        pass
    ...
    def _set(self, hue, saturation, value, alpha): # real signature unknown; restored from __doc__
        """ _set(self, hue:float, saturation:float, value:float, alpha:float) """
        pass
