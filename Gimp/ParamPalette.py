...
class ParamPalette(ParamResource):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamPalette), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamPalette (1066926256)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamPalette (1066926256)>'
