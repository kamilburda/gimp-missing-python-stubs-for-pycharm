...
class ColorConfig(__gi_overrides_GObject.Object, ConfigInterface):
    ...
    def get_out_of_gamut_color(self, color): # real signature unknown; restored from __doc__
        """ get_out_of_gamut_color(self, color:Gimp.RGB) """
        pass
