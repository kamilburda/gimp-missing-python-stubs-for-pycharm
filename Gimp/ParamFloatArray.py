...
class ParamFloatArray(ParamArray):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamFloatArray), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamFloatArray (770747632)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamFloatArray (770747632)>'
    __info__ = ObjectInfo(ParamFloatArray)
