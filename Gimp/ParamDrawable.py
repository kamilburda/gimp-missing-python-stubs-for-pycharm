...
class ParamDrawable(ParamItem):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamDrawable), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamDrawable (770748528)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamDrawable (770748528)>'
