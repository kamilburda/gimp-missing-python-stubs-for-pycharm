...
class ParamDrawable(ParamItem):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamDrawable), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamDrawable (3599938992)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamDrawable (3599938992)>'
