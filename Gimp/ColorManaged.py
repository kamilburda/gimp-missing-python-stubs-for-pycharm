...
class ColorManaged(__gobject.GInterface):
    ...
    def get_icc_profile(self): # real signature unknown; restored from __doc__
        """ get_icc_profile(self) -> list, len:int """
        return []
