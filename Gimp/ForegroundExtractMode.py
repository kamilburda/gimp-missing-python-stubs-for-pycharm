...
class ForegroundExtractMode(__gobject.GEnum):
    ...
    MATTING = 0
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gimp', '__dict__': <attribute '__dict__' of 'ForegroundExtractMode' objects>, '__doc__': None, '__gtype__': <GType GimpForegroundExtractMode (770679424)>, '__enum_values__': {0: <enum GIMP_FOREGROUND_EXTRACT_MATTING of type Gimp.ForegroundExtractMode>}, '__info__': gi.EnumInfo(ForegroundExtractMode), 'MATTING': <enum GIMP_FOREGROUND_EXTRACT_MATTING of type Gimp.ForegroundExtractMode>})"
    __enum_values__ = {
        0: 0,
    }
    __gtype__ = None # (!) real value is '<GType GimpForegroundExtractMode (770679424)>'
