...
class HSL(__gi.Boxed):
    ...
    def set(self, h, s, l): # real signature unknown; restored from __doc__
        """ set(self, h:float, s:float, l:float) """
        pass

    def set_alpha(self, a): # real signature unknown; restored from __doc__
        """ set_alpha(self, a:float) """
        pass
