...
class Pattern(Resource):
    ...
    def get_pixels(self): # real signature unknown; restored from __doc__
        """ get_pixels(self) -> bool, width:int, height:int, bpp:int, color_bytes:GLib.Bytes """
        return False
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001e82ef2d4e0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(Pattern), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpPattern (770690400)>, '__doc__': None, '__gsignals__': {}, 'get_by_name': gi.FunctionInfo(get_by_name, bound=None), 'get_info': gi.FunctionInfo(get_info, bound=None), 'get_pixels': gi.FunctionInfo(get_pixels, bound=None)})"
    __gdoc__ = 'Object GimpPattern\n\nProperties from GimpResource:\n  id -> gint: The id\n    The id for internal use\n\nSignals from GObject:\n  notify (GParam)\n\n'
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpPattern (770690400)>'
