...
class ArgumentSync(__gobject.GEnum):
    ...
    PARASITE = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gimp', '__dict__': <attribute '__dict__' of 'ArgumentSync' objects>, '__doc__': None, '__gtype__': <GType PyGimpArgumentSync (3599984000)>, '__enum_values__': {0: <enum GIMP_ARGUMENT_SYNC_NONE of type Gimp.ArgumentSync>, 1: <enum GIMP_ARGUMENT_SYNC_PARASITE of type Gimp.ArgumentSync>}, '__info__': gi.EnumInfo(ArgumentSync), 'NONE': <enum GIMP_ARGUMENT_SYNC_NONE of type Gimp.ArgumentSync>, 'PARASITE': <enum GIMP_ARGUMENT_SYNC_PARASITE of type Gimp.ArgumentSync>})"
    __enum_values__ = {
        0: 0,
        1: 1,
    }
    __gtype__ = None # (!) real value is '<GType PyGimpArgumentSync (3599984000)>'
