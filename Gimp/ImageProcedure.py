...
class ImageProcedure(Procedure):
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000001e82e1c5a50>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageProcedure), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpImageProcedure (770675728)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x000001e82e2f47c0>, 'priv': <property object at 0x000001e82e2f48b0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpImageProcedure (770675728)>'
