...
class ImageProcedure(Procedure):
    ...
    def new(self, plug_in, name, proc_type, run_func): # real signature unknown; restored from __doc__
        """ new(plug_in:Gimp.PlugIn, name:str, proc_type:Gimp.PDBProcType, run_func:Gimp.RunImageFunc) -> Gimp.Procedure """
        pass
    ...
    props = None # (!) real value is '<gi._gi.GProps object at 0x000002073165f0a0>'
    __class__ = None # (!) real value is "<class 'gi.types.GObjectMeta'>"
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ImageProcedure), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpImageProcedure (815082656)>, '__doc__': None, '__gsignals__': {}, 'new': gi.FunctionInfo(new, bound=None), 'parent_instance': <property object at 0x0000020731625ad0>, 'priv': <property object at 0x0000020731625bc0>})"
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpImageProcedure (815082656)>'
