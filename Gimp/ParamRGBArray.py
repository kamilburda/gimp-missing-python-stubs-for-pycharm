...
class ParamRGBArray(__gi_repository_GObject.ParamSpecBoxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamRGBArray), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamRGBArray (814712112)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamRGBArray (814712112)>'
    __info__ = ObjectInfo(ParamRGBArray)
