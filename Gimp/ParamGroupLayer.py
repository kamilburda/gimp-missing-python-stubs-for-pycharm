...
class ParamGroupLayer(ParamLayer):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamGroupLayer), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamGroupLayer (3599921248)>, '__doc__': None, '__gsignals__': {}})"
    __gproperties__ = {
        'blurb': (
    ...
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamGroupLayer (3599921248)>'
