...
class PDBErrorHandler(__gobject.GEnum):
    ...
    PLUGIN = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gimp', '__dict__': <attribute '__dict__' of 'PDBErrorHandler' objects>, '__doc__': None, '__gtype__': <GType GimpPDBErrorHandler (770685360)>, '__enum_values__': {0: <enum GIMP_PDB_ERROR_HANDLER_INTERNAL of type Gimp.PDBErrorHandler>, 1: <enum GIMP_PDB_ERROR_HANDLER_PLUGIN of type Gimp.PDBErrorHandler>}, '__info__': gi.EnumInfo(PDBErrorHandler), 'INTERNAL': <enum GIMP_PDB_ERROR_HANDLER_INTERNAL of type Gimp.PDBErrorHandler>, 'PLUGIN': <enum GIMP_PDB_ERROR_HANDLER_PLUGIN of type Gimp.PDBErrorHandler>})"
    __enum_values__ = {
        0: 0,
        1: 1,
    }
    __gtype__ = None # (!) real value is '<GType GimpPDBErrorHandler (770685360)>'
