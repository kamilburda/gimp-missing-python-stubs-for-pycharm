...
class ConvolveType(__gobject.GEnum):
    ...
    SHARPEN = 1
    __class__ = type
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'gi.repository.Gimp', '__dict__': <attribute '__dict__' of 'ConvolveType' objects>, '__doc__': None, '__gtype__': <GType GimpConvolveType (3595401296)>, '__enum_values__': {0: <enum GIMP_CONVOLVE_BLUR of type Gimp.ConvolveType>, 1: <enum GIMP_CONVOLVE_SHARPEN of type Gimp.ConvolveType>}, '__info__': gi.EnumInfo(ConvolveType), 'BLUR': <enum GIMP_CONVOLVE_BLUR of type Gimp.ConvolveType>, 'SHARPEN': <enum GIMP_CONVOLVE_SHARPEN of type Gimp.ConvolveType>})"
    __enum_values__ = {
        0: 0,
        1: 1,
    }
    __gtype__ = None # (!) real value is '<GType GimpConvolveType (3595401296)>'
