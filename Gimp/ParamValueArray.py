...
class ParamValueArray(__gi_repository_GObject.ParamSpecBoxed):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamValueArray), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamValueArray (814713904)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamValueArray (814713904)>'
