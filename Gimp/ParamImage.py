...
class ParamImage(__gi_repository_GObject.ParamSpecObject):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__info__': ObjectInfo(ParamImage), '__module__': 'gi.repository.Gimp', '__gtype__': <GType GimpParamImage (770684240)>, '__doc__': None, '__gsignals__': {}})"
    __gsignals__ = {}
    __gtype__ = None # (!) real value is '<GType GimpParamImage (770684240)>'
